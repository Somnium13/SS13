...
namespace Somnium.Game {
	class ChemicalReaction_Slimepotion2 : ChemicalReaction {

		protected override void __FieldInit() {
			base.__FieldInit();

			this.name = "Slime Potion 2";
			this.id = "m_potion2";
			this.result_amount = 1;
			this.required_container = typeof(Obj_Item_SlimeExtract_Lightpink);
		...
		public override void on_reaction( Reagents holder = null, double? created_volume = null ) {
			Obj_Item_Slimepotion_Sentience P = null;

			GlobalFuncs.feedback_add_details( "slime_cores_used", "" + this.type );
			P = new Obj_Item_Slimepotion_Sentience();
