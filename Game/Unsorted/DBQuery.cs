...
namespace Somnium.Game {
	class DBQuery : Game_Data {
		...
		// Function from file: dbcore.dm
		public void SetConversion( dynamic column = null, dynamic conversion = null ) {
			...
			if ( !( this.conversions != null ) ) {
				this.conversions = new ByTable( column );
			} else if ( this.conversions.len < Convert.ToDouble( column ) ) {
				this.conversions.len = Convert.ToInt32( column );
			}
			this.conversions[column] = conversion;
			return;
		}
