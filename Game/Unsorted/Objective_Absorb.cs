...
namespace Somnium.Game {
	class Objective_Absorb : Objective {
		...
		public override int check_completion(  ) {
			...
			if ( Lang13.Bool( this.owner ) && this.owner.changeling != null && this.owner.changeling.stored_profiles != null && this.owner.changeling.absorbedcount >= Convert.ToDouble( this.target_amount ) ) {
				return 1;
			} else {
				return 0;
			}
