...
namespace Somnium.Game {
	class Construction_Mecha_GygaxChassis : Construction_Mecha {
		...
		public Construction_Mecha_GygaxChassis ( Game_Data atom = null ) : base( atom ) {
		...
		public override void spawn_result(  ) {
			...
			((dynamic)const_holder).construct = new Construction_Reversible_Mecha_Gygax( const_holder );
			((dynamic)const_holder).icon = "icons/mecha/mech_construction.dmi";
			((dynamic)const_holder).icon_state = "gygax0";
