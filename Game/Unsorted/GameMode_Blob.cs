...
namespace Somnium.Game {
	class GameMode_Blob : GameMode {
		...
		public override bool check_finished(  ) {
			...
			if ( !( GlobalVars.blob_cores.len != 0 ) && !( GlobalVars.overminds.len != 0 ) ) {
		...
		public override bool post_setup( bool? report = null ) {
			Mind blob = null;
			Action_Innate_Blob_Earlyhelp B = null;
			Action_Innate_Blob_Earlycomm C = null;
			dynamic B2 = null;
			int burst_delay = 0;
			...
			foreach (dynamic _a in Lang13.Enumerate( this.infected_crew, typeof(Mind) )) {
				...
				B = new Action_Innate_Blob_Earlyhelp();
				B.Grant( blob.current );
				C = new Action_Innate_Blob_Earlycomm();
