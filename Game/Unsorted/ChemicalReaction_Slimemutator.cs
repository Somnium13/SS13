...
namespace Somnium.Game {
	class ChemicalReaction_Slimemutator : ChemicalReaction {

		protected override void __FieldInit() {
			base.__FieldInit();

			this.name = "Slime Mutator";
			this.id = "m_slimemutator";
		...
		public override void on_reaction( Reagents holder = null, double? created_volume = null ) {
			Obj_Item_Slimepotion_Mutator P = null;

			GlobalFuncs.feedback_add_details( "slime_cores_used", "" + this.type );
			P = new Obj_Item_Slimepotion_Mutator();
