...
namespace Somnium.Game {
	static class GlobalVars {
		...
		public const bool days_early = true;
...
";
		...
		public const int MINIMAP_SIZE = 2048;
		...
		public const bool POWER_IDLE = false;
		public const bool POWER_UP = true;
		...
		public const double SEC_FREQ = 1359;
		...
		public const bool STATE_DEFAULT = true;
		...
		public static ByTable gaslist_cache = null;
		...
		public static readonly ByTable modes = new ByTable(new object [] { "inclusive", "exclusive", "recognizer", "voice sensor" });
		...
		public static readonly ByTable backbaglist = new ByTable(new object [] { "Grey Backpack", "Grey Satchel", "Grey Dufflebag", "Leather Satchel", "Department Backpack", "Department Satchel", "Department Dufflebag" });
		...
		public static readonly ByTable map_templates = new ByTable();
		public static readonly ByTable space_ruins_templates = new ByTable();
		public static readonly ByTable lava_ruins_templates = new ByTable();
		...
		public static ByTable nuke_tiles = new ByTable();
		...
		public static ByTable pinpointer_list = new ByTable();
		...
		public static readonly ByTable wire_colors = new ByTable(new object [] { 
			"aliceblue", 
			"antiquewhite", 
			"aqua", 
			"aquamarine", 
		...
		public static readonly ByTable wire_color_directory = new ByTable();
		...
		public static ByTable overminds = new ByTable();
		...
		public static readonly double year_integer = String13.ParseNumber( GlobalVars.year ) ??0;
		...
		public static readonly ByTable human_recipes = new ByTable(new object [] { new StackRecipe( "bloated human costume", typeof(Obj_Item_Clothing_Suit_Hooded_BloatedHuman), 5, null, null, null, null, true ) });
		...
		public static readonly ByTable metal_recipes = new ByTable(new object [] { 
			...
			new StackRecipe( "air alarm frame", typeof(Obj_Item_Wallframe_Airalarm), 2 ), 
		...
		public static readonly ByTable admin_verbs_default = new ByTable(new object [] { 
			...
			typeof(Client).GetMethod( "deadmin" ), 
		...
		;
		public static readonly ByTable admin_verbs_debug_mapping = new ByTable(new object [] { 
			typeof(Client).GetMethod( "do_not_use_these" ), 
			typeof(Client).GetMethod( "camera_view" ), 
			typeof(Client).GetMethod( "sec_camera_report" ), 
			typeof(Client).GetMethod( "intercom_view" ), 
			typeof(Client).GetMethod( "air_status" ), 
			typeof(Client).GetMethod( "Cell" ), 
			typeof(Client).GetMethod( "atmosscan" ), 
			typeof(Client).GetMethod( "powerdebug" ), 
			typeof(Client).GetMethod( "count_objects_on_z_level" ), 
			typeof(Client).GetMethod( "count_objects_all" ), 
			typeof(Client).GetMethod( "cmd_assume_direct_control" ), 
			typeof(Client).GetMethod( "startSinglo" ), 
			typeof(Client).GetMethod( "fps" ), 
			typeof(Client).GetMethod( "cmd_admin_grantfullaccess" ), 
			typeof(Client).GetMethod( "cmd_admin_areatest" ), 
			typeof(Client).GetMethod( "cmd_admin_rejuvenate" ), 
			typeof(Admins).GetMethod( "show_traitor_panel" ), 
			typeof(Client).GetMethod( "disable_communication" ), 
			typeof(Client).GetMethod( "print_pointers" ), 
			typeof(Client).GetMethod( "cmd_show_at_list" ), 
			typeof(Client).GetMethod( "cmd_show_at_list" ), 
			typeof(Client).GetMethod( "manipulate_organs" )
		 });
		...
		public static readonly ByTable meta_gas_info = GlobalFuncs.meta_gas_list();
		public static readonly ByTable hardcoded_gases = new ByTable(new object [] { "o2", "n2", "co2", "plasma" });
		public static readonly ByTable potentialRandomZlevels = GlobalFuncs.generateMapList( "config/awaymissionconfig.txt" );
		public static readonly DmmSuite_Preloader _preloader = new DmmSuite_Preloader();
		...
		public static readonly Regex lizard_hiss = new Regex( "s+", "g" );
		public static readonly Regex lizard_hiSS = new Regex( "S+", "g" );
		...
		public static readonly Events keycard_events = new Events();
		...
		public static ByTable uplinks = new ByTable();
		...
		public static readonly ByTable label2types = new ByTable()
			.Set( "n2", typeof(Obj_Machinery_PortableAtmospherics_Canister_Nitrogen) )
			.Set( "o2", typeof(Obj_Machinery_PortableAtmospherics_Canister_Oxygen) )
			.Set( "co2", typeof(Obj_Machinery_PortableAtmospherics_Canister_CarbonDioxide) )
			.Set( "plasma", typeof(Obj_Machinery_PortableAtmospherics_Canister_Toxins) )
			.Set( "n2o", typeof(Obj_Machinery_PortableAtmospherics_Canister_NitrousOxide) )
			.Set( "air", typeof(Obj_Machinery_PortableAtmospherics_Canister_Air) )
			.Set( "caution", typeof(Obj_Machinery_PortableAtmospherics_Canister) )
		;
