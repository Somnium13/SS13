...
namespace Somnium.Game {
	class ChemicalReaction_Slimecell : ChemicalReaction {

		protected override void __FieldInit() {
			base.__FieldInit();

			this.name = "Slime Powercell";
			this.id = "m_cell";
		...
		public override void on_reaction( Reagents holder = null, double? created_volume = null ) {
			Obj_Item_Weapon_StockParts_Cell_High_Slime P = null;

			GlobalFuncs.feedback_add_details( "slime_cores_used", "" + this.type );
			P = new Obj_Item_Weapon_StockParts_Cell_High_Slime();
