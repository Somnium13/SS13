...
namespace Somnium.Game {
	class Mob_Living_SimpleAnimal_Pet_Dog_Corgi : Mob_Living_SimpleAnimal_Pet_Dog {
		...
		public void update_corgi_fluff(  ) {
			...
			switch ((Type)( this.inventory_head.type )) {
				...
				case typeof(Obj_Item_Clothing_Head_Ushanka):
					...
					break;
				case typeof(Obj_Item_Clothing_Head_Warden):
				...
				case typeof(Obj_Item_Clothing_Head_Soft):
					...
					break;
				case typeof(Obj_Item_Clothing_Head_Hardhat_Reindeer):
