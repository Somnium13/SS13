	...
	class Obj_Machinery_Camera : Obj_Machinery {
		...
		public override dynamic attackby( dynamic A = null, dynamic user = null, string _params = null, bool? silent = null, bool? replace_spent = null ) {
			...
			if ( A is Obj_Item_Weapon_Screwdriver ) {
				...
				user.WriteMsg( "<span class='notice'>You screw the camera's panel " + ( this.panel_open == true ? "open" : "closed" ) + ".</span>" );
		...
		// Function from file: camera.dm
		public void deactivate( dynamic user = null, bool? displaymessage = null ) {
