...
namespace Somnium.Game {
	class Mob_Living_Silicon_Robot : Mob_Living_Silicon {
		...
		public Obj_Screen_Robot inv1 = null;
		public Obj_Screen_Robot inv2 = null;
		public Obj_Screen_Robot inv3 = null;
		public Obj_Screen lamp_button = null;
		...
		public bool jetpackoverlay = false;
...
Any-Mode: (hotkey doesn't need to be on)
	...
	PGDN = activate held object
		...
		public override bool mob_has_gravity( Ent_Static T = null ) {
			return base.mob_has_gravity( T ) || this.mob_negates_gravity();
		}
		...
		public override bool canUseTopic( dynamic M = null, bool? be_close = null, bool? no_dextery = null ) {
			...
			if ( this.stat != 0 || this.lockcharge == true || this.stunned != 0 || this.weakened != 0 ) {
				return false;
			}
		...
		public override void update_icons(  ) {
			...
			if ( this.stat != 2 && !( this.paralysis != 0 || this.stunned != 0 || this.weakened != 0 ) ) {
			...
			if ( this.jetpackoverlay ) {
				this.overlays.Add( "minerjetpack" );
			}
			this.update_fire();
			return;
		}
		...
		public override dynamic Stat(  ) {
			...
			if ( Interface13.IsStatPanelActive( "Status" ) ) {
				...
				if ( this.module != null ) {
					this.v_internal = Lang13.FindIn( typeof(Obj_Item_Weapon_Tank_Jetpack), this.module.modules );
		...
		public override void update_normal_mode(  ) {
			Interface13.WindowSet( this, null, "mainwindow.macro=borgmacro hotkey_toggle.is-checked=false input.focus=true input.background-color=#D3B5B5" );
			return;
		}

		// Function from file: login.dm
		public override void update_hotkey_mode(  ) {
			Interface13.WindowSet( this, null, "mainwindow.macro=borghotkeymode hotkey_toggle.is-checked=true mapwindow.map.focus=true input.background-color=#F0F0F0" );
			return;
		}
		...
		public override bool update_canmove(  ) {
			...
			if ( this.paralysis != 0 || this.stunned != 0 || this.weakened != 0 || this.buckled != null || this.lockcharge == true ) {
				this.canmove = false;
			} else {
				this.canmove = true;
			}
		...
		public override void handle_hud_icons_health(  ) {
			...
			if ( this.healths != null ) {
				...
				if ( this.stat != 2 ) {
					...
					} else if ( Convert.ToDouble( this.health ) > Convert.ToDouble( this.maxHealth * 0.5 ) ) {
					...
					} else if ( Convert.ToDouble( this.health ) > Convert.ToDouble( -this.maxHealth ) ) {
		...
		public override void update_sight(  ) {
			...
			if ( this.stat == 2 || ( this.sight_mode & 4 ) != 0 ) {
				...
				if ( ( this.sight_mode & 1 ) != 0 && ( this.sight_mode & 2 ) != 0 ) {
					this.sight |= GlobalVars.SEE_TURFS;
					this.sight |= GlobalVars.SEE_MOBS;
					this.see_invisible = 5;
				} else if ( ( this.sight_mode & 1 ) != 0 ) {
					this.sight |= GlobalVars.SEE_TURFS;
					this.see_invisible = 5;
					this.see_in_dark = 1;
				} else if ( ( this.sight_mode & 2 ) != 0 ) {
					this.sight |= GlobalVars.SEE_MOBS;
					this.see_invisible = 45;
				} else if ( this.stat != 2 ) {
					this.sight &= 65531;
		...
		public override void handle_status_effects(  ) {
			...
			if ( this.stuttering != 0 ) {
				this.stuttering = Num13.MaxInt( 0, ((int)( this.stuttering - 1 )) );
			}

			if ( this.druggy != 0 ) {
				this.druggy = Num13.MaxInt( 0, ((int)( this.druggy - 1 )) );
			}
			return;
		}
		...
		public override bool handle_regular_status_updates(  ) {
			...
			if ( base.handle_regular_status_updates() ) {
				...
				if ( Convert.ToDouble( this.getOxyLoss() ) > Convert.ToDouble( this.maxHealth * 0.5 ) ) {
					this.Paralyse( 3 );
				}
		...
		// Function from file: robot.dm
		public void notify_ai( int notifytype = 0, string oldname = null, string newname = null ) {
		...
		public void deconstruct(  ) {
			...
			if ( this.robot_suit != null ) {
				...
				new Obj_Item_Stack_CableCoil( T, Lang13.IntNullable( this.robot_suit.chest.wires ) );
				this.robot_suit.chest.loc = T;
				this.robot_suit.chest.wires = 0;
		...
		public void update_headlamp( bool? turn_off = null, int? cooldown = null ) {
			...
			if ( this.lamp_intensity != 0 && ( turn_off == true || this.stat != 0 ) ) {
		...
		public void control_headlamp(  ) {
			...
			if ( this.stat != 0 || this.lamp_recharging ) {
	...
	<table border='0'>" ).ToString();
		...
		public void update_items(  ) {
			...
			if ( this.client != null ) {
				...
				foreach (dynamic _a in Lang13.Enumerate( this.contents, typeof(Obj) )) {
					...
					if ( I != null && !( I is Obj_Item_Weapon_StockParts_Cell || I is Obj_Item_Device_Radio || I is Obj_Machinery_Camera || I is Obj_Item_Device_Mmi ) ) {
		...
		// Function from file: life.dm
		public void clamp_values(  ) {
			this.SetStunned( Num13.MinInt( ((int)( this.stunned )), 30 ) );
			this.SetParalysis( Num13.MinInt( ((int)( this.paralysis )), 30 ) );
			this.SetWeakened( Num13.MinInt( this.weakened, 20 ) );
			this.sleeping = 0;
		...
		public void activate_module( dynamic O = null ) {
			...
			if ( !Lang13.Bool( this.module_state_1 ) ) {
				...
				if ( this.module_state_1 is Obj_Item_Borg_Sight ) {
					this.sight_mode |= Convert.ToInt32( this.module_state_1.sight_mode );
				}
				...
				if ( this.module_state_2 is Obj_Item_Borg_Sight ) {
					this.sight_mode |= Convert.ToInt32( this.module_state_2.sight_mode );
				}
				...
				if ( this.module_state_3 is Obj_Item_Borg_Sight ) {
					this.sight_mode |= Convert.ToInt32( this.module_state_3.sight_mode );
				}
			} else {
		...
		public override void RangedAttack( dynamic A = null, string _params = null ) {
			((Ent_Static)A).attack_robot( this );
			return;
		}
		...
		public override void ClickOn( dynamic A = null, string _params = null ) {
			...
			if ( A == this.loc || Lang13.Bool( ((dynamic)this.loc).Contains( A ) ) || this.contents.Contains( A ) ) {
				resolved = ((Ent_Static)A).attackby( W, this, _params );
