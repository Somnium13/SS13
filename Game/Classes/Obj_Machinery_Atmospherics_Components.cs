...
namespace Somnium.Game {
	class Obj_Machinery_Atmospherics_Components : Obj_Machinery_Atmospherics {
		...
		public Obj_Machinery_Atmospherics_Components ( dynamic loc = null ) : base( (object)(loc) ) {
			double I = 0;
			GasMixture A = null;
		...
		public override void unsafe_pressure_release( dynamic user = null, double? pressures = null ) {
			...
			if ( Lang13.Bool( T ) ) {
				...
				foreach (dynamic _a in Lang13.IterateRange( 1, this.device_type )) {
					...
					air = this.airs[I];
					lost += ( pressures ??0) * environment.volume / Convert.ToDouble( air.temperature * 8.31 );
					times_lost++;
				}
		...
		// Function from file: components_base.dm
		public dynamic safe_input( string title = null, string text = null, double default_set = 0 ) {
