		...
		public void update(  ) {
			...
			if ( !Lang13.Bool( this.hsbinfo ) ) {
				...
				if ( this.admin ) {
					...
					this.hsbinfo += new Txt( "- <a href='?src=" ).Ref( this ).str( ";hsb=hsbspawn&path=" ).item( typeof(Obj_Machinery_PortableAtmospherics_Canister_SleepingAgent) ).str( "'>Spawn N2O Canister</a><hr>" ).ToString();
				} else {
