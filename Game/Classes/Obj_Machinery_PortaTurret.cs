...
namespace Somnium.Game {
	class Obj_Machinery_PortaTurret : Obj_Machinery {
		...
		public override int? process( dynamic seconds = null ) {
			...
			Mob_Living_SimpleAnimal SA = null;
			...
			if ( this.check_anomalies ) {
				...
				foreach (dynamic _a in Lang13.Enumerate( turretview, typeof(Mob_Living_SimpleAnimal) )) {
					SA = _a;
					

					if ( SA.stat != 0 || Lang13.Bool( SA.faction.Contains( this.faction ) ) || SA.has_unlimited_silicon_privilege ) {
						continue;
					}
					targets.Add( SA );
				}
			...
			foreach (dynamic _c in Lang13.Enumerate( turretview, typeof(Mob_Living_Carbon) )) {
				C = _c;
				

				if ( this.emagged != 0 && C.stat != 2 ) {
					targets.Add( C );
					continue;
				}

				if ( C.stat != 0 || Lang13.Bool( C.handcuffed ) || Lang13.Bool( C.lying ) ) {
					continue;
				}
				...
				if ( C is Mob_Living_Carbon_Human ) {
					...
					if ( !Lang13.Bool( C.faction.Contains( this.faction ) ) ) {
						
						foreach (dynamic _b in Lang13.Enumerate( C.faction )) {
							F = _b;
			...
			foreach (dynamic _d in Lang13.Enumerate( turretview, typeof(Obj_Mecha) )) {
				M = _d;
				

				if ( Lang13.Bool( M.occupant ) ) {
					
					if ( this.ai || this.emagged != 0 || this.assess_perp( M.occupant ) >= 4 ) {
						targets.Add( M );
					}
				}
			}
		...
		public virtual void setup(  ) {
			...
			switch ((Type)( E.type )) {
				...
				case typeof(Obj_Item_Weapon_Gun_Energy_Laser_Practice):
					...
					break;
				case typeof(Obj_Item_Weapon_Gun_Energy_Laser_Retro):
					this.active_state = "Laser";
					break;
				case typeof(Obj_Item_Weapon_Gun_Energy_Laser_Captain):
					this.active_state = "Laser";
					break;
				case typeof(Obj_Item_Weapon_Gun_Energy_Lasercannon):
					this.active_state = "Laser";
					break;
				case typeof(Obj_Item_Weapon_Gun_Energy_Gun_Advtaser):
					this.eprojectile = typeof(Obj_Item_Projectile_Beam);
					this.eshot_sound = "sound/weapons/Laser.ogg";
					break;
				case typeof(Obj_Item_Weapon_Gun_Energy_Gun):
					this.eprojectile = typeof(Obj_Item_Projectile_Beam);
					this.eshot_sound = "sound/weapons/Laser.ogg";
					this.egun = true;
					break;
				case typeof(Obj_Item_Weapon_Gun_Energy_Gun_Nuclear):
					this.eprojectile = typeof(Obj_Item_Projectile_Beam);
					this.eshot_sound = "sound/weapons/Laser.ogg";
					this.egun = true;
					break;
				case typeof(Obj_Item_Weapon_Gun_Energy_Gun_Turret):
					this.eprojectile = typeof(Obj_Item_Projectile_Beam);
					this.eshot_sound = "sound/weapons/Laser.ogg";
					this.egun = true;
					break;
