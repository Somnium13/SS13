...
namespace Somnium.Game {
	class Obj_Item_Device_NuclearChallenge : Obj_Item_Device {
		...
		public override dynamic attack_self( dynamic user = null, dynamic flag = null, bool? emp = null ) {
			...
			U = new Obj_Item_Device_Radio_Uplink( GlobalFuncs.get_turf( user ) );
			U.hidden_uplink.uplink_owner = "" + user.key;
			U.hidden_uplink.uses = 280;
			U.hidden_uplink.mode_override = typeof(GameMode_Nuclear);
			GlobalVars.config.shuttle_refuel_delay = Num13.MinInt( ((int)( GlobalVars.config.shuttle_refuel_delay ??0 )), 15000 );
