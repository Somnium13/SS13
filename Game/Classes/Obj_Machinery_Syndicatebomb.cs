...
namespace Somnium.Game {
	class Obj_Machinery_Syndicatebomb : Obj_Machinery {
		...
		public Wires_Syndicatebomb wires = null;
		...
		public override dynamic attackby( dynamic A = null, dynamic user = null, string _params = null, bool? silent = null, bool? replace_spent = null ) {
			...
			} else if ( this.wires.IsInteractionTool( A ) && this.open_panel ) {
				this.wires.Interact( user );
			} else if ( A is Obj_Item_Weapon_Crowbar ) {
				
				if ( this.open_panel && this.isWireCut( GlobalVars.WIRE_BOOM ) != 0 && this.isWireCut( GlobalVars.WIRE_UNBOLT ) != 0 && this.isWireCut( GlobalVars.WIRE_DELAY ) != 0 && this.isWireCut( GlobalVars.WIRE_PROCEED ) != 0 && this.isWireCut( GlobalVars.WIRE_ACTIVATE ) != 0 ) {
