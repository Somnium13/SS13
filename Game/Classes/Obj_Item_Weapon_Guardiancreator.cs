...
namespace Somnium.Game {
	class Obj_Item_Weapon_Guardiancreator : Obj_Item_Weapon {
		...
		public void spawn_guardian( dynamic user = null, dynamic key = null ) {
			...
			G.WriteMsg( "You are capable of manifesting or recalling to your master with verbs in the Guardian tab. You will also find a verb to communicate with them privately there." );
			...
			colour = Rand13.Pick(new object [] { "orange", "pink", "red", "blue", "green" });
			G.name = "" + picked_name + " " + GlobalFuncs.capitalize( colour );
			G.real_name = "" + picked_name + " " + GlobalFuncs.capitalize( colour );
