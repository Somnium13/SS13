	...
	class Obj_Machinery_Vending : Obj_Machinery {
		...
		public override dynamic Topic( string href = null, ByTable href_list = null, dynamic hsrc = null ) {
			...
			if ( Lang13.Bool( href_list["vend"] ) && this.vend_ready ) {
				...
				this.updateUsrDialog();
				return null;
			} else if ( Lang13.Bool( href_list["togglevoice"] ) && this.panel_open == true ) {
		...
		public override dynamic attack_hand( dynamic a = null, bool? b = null, bool? c = null ) {
			...
			if ( this.panel_open == true ) {
				...
				if ( this.product_slogans != "" ) {
					dat += new Txt( "The speaker switch is " ).item( ( this.shut_up ? "off" : "on" ) ).str( ". <a href='?src=" ).Ref( this ).str( ";togglevoice=" ).item( 1 ).str( "'>Toggle</a>" ).ToString();
				}
			} else {
		...
		public override dynamic attackby( dynamic A = null, dynamic user = null, string _params = null, bool? silent = null, bool? replace_spent = null ) {
			...
			if ( A is Obj_Item_Weapon_Screwdriver && Lang13.Bool( this.anchored ) ) {
				...
				user.WriteMsg( "<span class='notice'>You " + ( this.panel_open == true ? "open" : "close" ) + " the maintenance panel.</span>" );
				this.overlays.Cut();
