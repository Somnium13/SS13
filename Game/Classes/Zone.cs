...
namespace Somnium.Game {
	class Zone : Base_Zone {
		...
		public dynamic copy_contents_to( dynamic A = null, bool? platingRequired = null, bool? nerf_weapons = null ) {
			...
			foreach (dynamic _h in Lang13.Enumerate( refined_src, typeof(Tile_Simulated) )) {
				...
				foreach (dynamic _e in Lang13.Enumerate( T5, typeof(Obj) )) {
					...
					copiedobjs.Add( ((Ent_Static)O2).GetAllContents() + O2 );
				}
				...
				foreach (dynamic _f in Lang13.Enumerate( T5 )) {
					...
					copiedobjs.Add( ((Ent_Static)SM).GetAllContents() + SM );
				}
		...
		// Function from file: areas.dm
		public virtual double usage( int chan = 0 ) {
			double used = 0;
		...
		public virtual void updateicon(  ) {
			...
			if ( ( this.fire == true || this.eject || this.party ) && ( !this.requires_power || this.power_environ ) ) {
				
				if ( this.fire == true && !this.eject && !this.party ) {
					this.icon_state = "blue";
				} else if ( !( this.fire == true ) && this.eject && !this.party ) {
					this.icon_state = "red";
				} else if ( this.party && !( this.fire == true ) && !this.eject ) {
		...
		// Function from file: areas.dm
		public void burglaralert( Obj_Structure_Displaycase trigger = null ) {
		...
		// Function from file: areas.dm
		public void firereset( Obj_Machinery_Firealarm source = null ) {
			dynamic RA = null;
			Obj_Machinery_Door_Firedoor D = null;
		...
		// Function from file: areas.dm
		public void firealert( Obj_Machinery_Firealarm source = null ) {
			ByTable cameras = null;
			dynamic RA = null;
			Obj_Machinery_Door_Firedoor D = null;
			Obj_Machinery_Firealarm F = null;
		...
		// Function from file: areas.dm
		public bool atmosalert( int danger_level = 0, Ent_Static source = null ) {
			ByTable cameras = null;
			dynamic RA = null;
			Obj_Machinery_Camera C = null;
			Mob_Living_Silicon aiPlayer = null;
