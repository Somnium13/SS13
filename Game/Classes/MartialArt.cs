...
namespace Somnium.Game {
	class MartialArt : Game_Data {
		...
		public bool basic_hit( dynamic A = null, Ent_Static D = null ) {
			...
			damage = Rand13.Int( 0, 9 ) + A.dna.species.punchmod;
			...
			affecting = ((dynamic)D).get_organ( GlobalFuncs.ran_zone( A.zone_sel.selecting ) );
			...
			if ( Convert.ToInt32( ((dynamic)D).stat ) != 2 && damage >= 9 ) {
