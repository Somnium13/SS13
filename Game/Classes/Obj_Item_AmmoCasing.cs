...
namespace Somnium.Game {
	class Obj_Item_AmmoCasing : Obj_Item {
		...
		// Function from file: firing.dm
		public void ready_proj( dynamic target = null, dynamic user = null, dynamic quiet = null, string zone_override = null ) {
			...
			if ( Lang13.Bool( zone_override ) ) {
				...
				this.BB.def_zone = user.zone_sel.selecting;
			}
		...
		// Function from file: firing.dm
		public virtual bool fire( dynamic target = null, dynamic user = null, string _params = null, double? distro = null, dynamic quiet = null, string zone_override = null ) {
			zone_override = zone_override ?? "";
