...
namespace Somnium.Game {
	class Obj_Item_Pipe : Obj_Item {
		...
		public override bool Move( dynamic NewLoc = null, int? Dir = null, int step_x = 0, int step_y = 0 ) {
			...
			if ( new ByTable(new object [] { typeof(Obj_Machinery_Atmospherics_Pipe_Simple), typeof(Obj_Machinery_Atmospherics_Pipe_HeatExchanging_Simple) }).Contains( this.pipe_type ) && this.is_bent && GlobalVars.cardinal.Contains( this.dir ) ) {
				this.dir = this.dir | Num13.Rotate( this.dir, 90 );
			} else if ( new ByTable(new object [] { typeof(Obj_Machinery_Atmospherics_Components_Trinary_Filter), typeof(Obj_Machinery_Atmospherics_Components_Trinary_Mixer) }).Contains( this.pipe_type ) && Lang13.Bool( this.flipped ) ) {
				this.dir = Num13.Rotate( this.dir, 135 );
			}
			this.fixdir();
			return false;
		}
