...
namespace Somnium.Game {
	class Wires_Airlock : Wires {
		...
		public override string GetInteractWindow(  ) {
			...
			_default += "<br>\n" + ( Lang13.Bool( ((dynamic)A).locked ) ? "The door bolts have fallen!" : "The door bolts look up." ) + "<br>\n" + ( Lang13.Bool( ((dynamic)A).lights ) ? "The door bolt lights are on." : "The door bolt lights are off!" ) + "<br>\n" + ( Lang13.Bool( ((dynamic)A).hasPower() ) ? "The test light is on." : "The test light is off!" ) + "<br>\n" + ( Lang13.Bool( ((dynamic)A).aiControlDisabled ) == false && !Lang13.Bool( ((dynamic)A).emagged ) ? "The 'AI control allowed' light is on." : "The 'AI control allowed' light is off." ) + "<br>\n" + ( Lang13.Bool( ((dynamic)A).safe ) == false ? "The 'Check Wiring' light is on." : "The 'Check Wiring' light is off." ) + "<br>\n" + ( Lang13.Bool( ((dynamic)A).normalspeed ) == false ? "The 'Check Timing Mechanism' light is on." : "The 'Check Timing Mechanism' light is off." ) + "<br>\n" + ( Lang13.Bool( ((dynamic)A).emergency ) == false ? "The emergency lights are off." : "The emergency lights are on." );
			return _default;
		}
