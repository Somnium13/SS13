...
namespace Somnium.Game {
	class Ent_Static : Base_Static {
		...
		public virtual Ent_Static update_pipe_vision( Ent_Static new_loc = null ) {
			return null;
		}
		...
		public virtual void visible_message( dynamic message = null, dynamic self_message = null, string blind_message = null ) {
			...
			if ( Lang13.Bool( self_message ) ) {
				...
				foreach (dynamic _e in Lang13.Enumerate( mob_hearers )) {
					...
					((Mob)MOB).show_message( self_message, 2 );
				}
			}
			return;
		}
		...
		public virtual bool transfer_ai( dynamic interaction = null, dynamic user = null, dynamic AI = null, dynamic card = null ) {
		...
		// Function from file: atoms.dm
		public virtual bool handle_slip( Mob_Living_Carbon C = null, double s_amount = 0, dynamic w_amount = null, dynamic O = null, dynamic lube = null ) {
			return false;
		}
		...
		// Function from file: atoms.dm
		public virtual bool CheckExit( Ent_Dynamic O = null, Tile target = null ) {
			return true;
		}
		...
		public bool onCentcom(  ) {
			...
			foreach (dynamic _a in Lang13.Enumerate( new ByTable(new object [] { "emergency", "pod1", "pod2", "pod3", "pod4", "ferry" }) )) {
				centcom_shuttle = _a;
				
				M = GlobalVars.SSshuttle.getShuttle( centcom_shuttle );

				if ( Lang13.Bool( M.areaInstance.Contains( T ) ) ) {
					return true;
				}
			}
		...
		public void SpinAnimation( double? speed = null, int? loops = null, bool? clockwise = null, int? segments = null ) {
			speed = speed ?? 10;
			loops = loops ?? -1;
