...
namespace Somnium.Game {
	class Species_Plasmaman : Species {
		...
		protected override void __FieldInit() {
			...
			this.specflags = new ByTable(new object [] { 1024, 128, 16384 });
		...
		// Function from file: species_types.dm
		public override bool before_equip_job( Job J = null, dynamic H = null, bool? visualsOnly = null ) {
			...
			if ( !( ((dynamic)H).w_uniform is Obj_Item_Clothing_Under_Plasmaman ) || !( ((dynamic)H).head is Obj_Item_Clothing_Head_Helmet_Space_Plasmaman ) ) {
				...
				if ( environment != null ) {
					...
					if ( total_moles != 0 ) {
						...
						if ( ( environment.oxygen ??0) / total_moles >= 0.01 ) {
