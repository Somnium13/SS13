...
namespace Somnium.Game {
	class Obj_Machinery_Teleport_Hub : Obj_Machinery_Teleport {
		...
		public bool is_ready(  ) {
			...
			_default = !( this.panel_open == true ) && !( ( this.stat & 3 ) != 0 ) && Lang13.Bool( this.power_station ) && Lang13.Bool( this.power_station.engaged ) && !Lang13.Bool( this.power_station.stat & 3 );
			return _default;
		}
