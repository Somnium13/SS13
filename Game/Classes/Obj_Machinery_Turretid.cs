	...
	class Obj_Machinery_Turretid : Obj_Machinery {
		...
		public override dynamic Topic( string href = null, ByTable href_list = null, dynamic hsrc = null ) {
			...
			if ( this.locked ) {
				...
				if ( !( Task13.User is Mob_Living_Silicon || GlobalFuncs.IsAdminGhost( Task13.User ) ) ) {
		...
		public override dynamic attack_hand( dynamic a = null, bool? b = null, bool? c = null ) {
			...
			if ( this.locked && !( a is Mob_Living_Silicon || GlobalFuncs.IsAdminGhost( a ) ) ) {
		...
		public override dynamic attack_ai( dynamic user = null ) {
			...
			if ( !this.ailock || GlobalFuncs.IsAdminGhost( user ) ) {
