...
namespace Somnium.Game {
	class Construction_Reversible_Mecha_Ripley : Construction_Reversible_Mecha {
		...
		public Construction_Reversible_Mecha_Ripley ( Game_Data atom = null ) : base( atom ) {
		...
		public override void spawn_result(  ) {
			base.spawn_result();
			GlobalFuncs.feedback_inc( "mecha_ripley_created", 1 );
			return;
		}
		...
		public override bool custom_action( int? index = null, dynamic diff = null, dynamic used_atom = null, dynamic user = null ) {
			...
			switch ((int?)( index )) {
				case 14:
					...
					((dynamic)this.holder).icon_state = "ripley1";
					break;
				case 13:
					...
					if ( diff == -1 ) {
						...
						((dynamic)this.holder).icon_state = "ripley2";
					} else {
						...
						((dynamic)this.holder).icon_state = "ripley0";
					}
					break;
				case 12:
					...
					if ( diff == -1 ) {
						...
						((dynamic)this.holder).icon_state = "ripley3";
					} else {
				...
				case 11:
					...
					if ( diff == -1 ) {
						...
						((dynamic)this.holder).icon_state = "ripley4";
					} else {
				...
				case 10:
					...
					if ( diff == -1 ) {
						...
						((dynamic)this.holder).icon_state = "ripley5";
					} else {
				...
				case 9:
					...
					if ( diff == -1 ) {
						...
						((dynamic)this.holder).icon_state = "ripley6";
					} else {
				...
				case 8:
					...
					if ( diff == -1 ) {
						...
						GlobalFuncs.qdel( used_atom );
						((dynamic)this.holder).icon_state = "ripley7";
					} else {
				...
				case 7:
					...
					if ( diff == -1 ) {
						...
						((dynamic)this.holder).icon_state = "ripley8";
					} else {
				...
				case 6:
					...
					if ( diff == -1 ) {
						...
						((dynamic)this.holder).icon_state = "ripley9";
					} else {
				...
				case 5:
					...
					if ( diff == -1 ) {
						...
						((dynamic)this.holder).icon_state = "ripley10";
					} else {
				...
				case 4:
					...
					if ( diff == -1 ) {
						...
						((dynamic)this.holder).icon_state = "ripley11";
					} else {
				...
				case 3:
					...
					if ( diff == -1 ) {
						...
						((dynamic)this.holder).icon_state = "ripley12";
					} else {
				...
				case 2:
					...
					if ( diff == -1 ) {
						...
						((dynamic)this.holder).icon_state = "ripley13";
					} else {
