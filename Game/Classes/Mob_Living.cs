...
namespace Somnium.Game {
	class Mob_Living : Mob {
		...
		public override Ent_Static update_pipe_vision( Ent_Static new_loc = null ) {
		...
		public override void send_speech( dynamic message = null, double? range = null, dynamic source = null, string bubble_type = null, ByTable spans = null ) {
			...
			Task13.Schedule( 0, (Task13.Closure)(() => {
				GlobalFuncs.flick_overlay( new Image( "icons/mob/talk.dmi", this, "h" + bubble_type + GlobalFuncs.say_test( message ), 5 ), speech_bubble_recipients, 30 );
				return;
			}));
			return;
		}
		...
		public override dynamic Login(  ) {
			...
			this.update_pipe_vision( this.loc );
			...
			if ( !cuff_dragged && Lang13.Bool( this.pulling ) && !this.throwing && ( Map13.GetDistance( this, this.pulling ) <= 1 || this.pulling.loc == this.loc ) ) {
				...
				if ( Lang13.Bool( this.pulling ) && this.pulling.loc != null ) {
					...
					if ( !( this.pulling.loc is Tile ) ) {
						...
						GlobalVars.diary.WriteMsg( "pulling disappeared? at " + 513 + " in mob.dm - pulling = " + this.pulling );
		...
		public override void update_action_buttons(  ) {
			...
			if ( this.hud_used.action_buttons_hidden ) {
				...
				if ( !( this.hud_used.hide_actions_toggle.moved == true ) ) {
		...
		public override bool Life(  ) {
			...
			if ( this.handle_regular_status_updates() ) {
		...
		public int shared_living_ui_distance( Game_Data src_object = null ) {
			int dist = 0;

			
			if ( !Map13.FetchInView( this, 4 ).Contains( src_object ) ) {
				return -1;
			}
		...
		public void add_ventcrawl( Ent_Static starting_machine = null ) {
			...
			if ( !( starting_machine is Obj_Machinery_Atmospherics ) ) {
				return;
			}
			...
			foreach (dynamic _b in Lang13.Enumerate( totalMembers, typeof(Obj_Machinery_Atmospherics) )) {
				A = _b;
		...
		// Function from file: living_defense.dm
		public void spreadFire( Ent_Dynamic L = null ) {
		...
		// Function from file: living.dm
		public virtual bool flash_eyes( double? intensity = null, bool? override_blindness_check = null, bool? affect_silicon = null ) {
		...
		public virtual void revive(  ) {
			...
			if ( this is Mob_Living_Carbon ) {
				...
				foreach (dynamic _a in Lang13.Enumerate( C.contents, typeof(Obj_Item_Weapon_Restraints) )) {
					R = _a;
				...
				if ( C.reagents != null ) {
					...
					foreach (dynamic _b in Lang13.Enumerate( C.reagents.reagent_list, typeof(Reagent) )) {
						R2 = _b;
						
						C.reagents.clear_reagents();
					}
					C.reagents.addiction_list = new ByTable();
				}
			}
		...
		// Function from file: living.dm
		public virtual void take_overall_damage( dynamic brute = null, dynamic burn = null ) {
		...
		// Function from file: living.dm
		public virtual void take_organ_damage( dynamic brute = null, dynamic burn = null ) {
			this.adjustBruteLoss( brute );
			this.adjustFireLoss( burn );
			this.updatehealth();
			return;
		...
		// Function from file: living.dm
		public bool setStaminaLoss( dynamic amount = null ) {
		...
		public virtual bool adjustStaminaLoss( dynamic amount = null ) {
			...
			this.staminaloss = Num13.MinInt( Num13.MaxInt( Convert.ToInt32( this.staminaloss + amount ), 0 ), Convert.ToInt32( this.maxHealth * 2 ) );
			return false;
		}
		...
		// Function from file: living.dm
		public bool setCloneLoss( bool amount = false ) {
		...
		// Function from file: living.dm
		public virtual bool adjustOxyLoss( dynamic amount = null ) {
		...
		// Function from file: living.dm
		public virtual bool adjustBruteLoss( dynamic amount = null ) {
		...
		// Function from file: living.dm
		public bool PushAM( Ent_Dynamic AM = null ) {
			int t = 0;
			Ent_Dynamic W = null;
		...
		// Function from file: living.dm
		public virtual dynamic ObjBump( Ent_Dynamic O = null ) {
			return null;
		}

		// Function from file: living.dm
		public bool MobBump( Ent_Dynamic M = null ) {
			dynamic MM = null;
			...
			if ( ( ((dynamic)M).a_intent == "help" || Lang13.Bool( ((dynamic)M).restrained() ) ) && ( this.a_intent == "help" || this.restrained() ) && Lang13.Bool( ((dynamic)M).canmove ) && this.canmove && !Lang13.Bool( ((dynamic)M).buckled ) && !Lang13.Bool( M.buckled_mob ) ) {
		...
		// Function from file: life.dm
		public virtual void handle_hud_icons_health(  ) {
			return;
		}

		// Function from file: life.dm
		public virtual bool handle_hud_icons(  ) {
		...
		// Function from file: life.dm
		public virtual void handle_vision(  ) {
		...
		public void give_action_button( Obj_Item I = null, int? recursive = null ) {
			...
			if ( Lang13.Bool( recursive ) ) {
				...
				foreach (dynamic _a in Lang13.Enumerate( I, typeof(Obj_Item) )) {
					...
					this.give_action_button( I, ( recursive ??0) - 1 );
				}
			}
			return;
		}
		...
		public virtual void handle_disabilities(  ) {
			...
			if ( Lang13.Bool( this.disabilities & 1 ) || this.stat != 0 ) {
				...
				this.eye_blind = Num13.MaxInt( ((int)( this.eye_blind - 1 )), 0 );
			} else if ( this.eye_blurry != 0 ) {
				this.eye_blurry = Num13.MaxInt( ((int)( this.eye_blurry - 1 )), 0 );
			}
		...
		public virtual void handle_status_effects(  ) {
			...
			if ( this.paralysis != 0 ) {
				this.paralysis = Num13.MaxInt( ((int)( this.paralysis - 1 )), 0 );
			}

			if ( this.stunned != 0 ) {
				this.stunned = Num13.MaxInt( ((int)( this.stunned - 1 )), 0 );
			...
			if ( this.weakened != 0 ) {
				this.weakened = Num13.MaxInt( this.weakened - 1, 0 );
		...
		public virtual bool handle_regular_status_updates(  ) {
			...
			if ( this.stat != 2 ) {
				...
				if ( this.paralysis != 0 ) {
					this.stat = 1;
				} else if ( ( this.status_flags & 8192 ) != 0 ) {
					this.stat = 1;
				} else {
					this.stat = 0;
				}
		...
		public virtual bool apply_effect( dynamic effect = null, dynamic effecttype = null, dynamic blocked = null ) {
			...
			if ( _a=="stun" ) {
				...
				this.eye_blurry = Num13.MaxInt( ((int)( this.eye_blurry )), Convert.ToInt32( effect * blocked ) );
			} else if ( _a=="drowsy" ) {
		...
		public override dynamic attackby( dynamic A = null, dynamic user = null, string _params = null, bool? silent = null, bool? replace_spent = null ) {
			...
			if ( this.butcher_results != null && this.stat == 2 ) {
		...
		public void pulled( Ent_Dynamic AM = null ) {
			
			if ( this.pulling == AM ) {
				this.stop_pulling();
			} else if ( AM.Adjacent( this ) ) {
