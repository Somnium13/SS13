...
namespace Somnium.Game {
	class Obj_Item_Weapon_Grenade_ChemGrenade_Facid : Obj_Item_Weapon_Grenade_ChemGrenade {
		...
		public Obj_Item_Weapon_Grenade_ChemGrenade_Facid ( dynamic loc = null ) : base( (object)(loc) ) {
