...
namespace Somnium.Game {
	class Obj_Item_Weapon_ReagentContainers_Food_Drinks_Bottle : Obj_Item_Weapon_ReagentContainers_Food_Drinks {
		...
		public override bool attack( dynamic M = null, dynamic user = null, bool? def_zone = null ) {
			...
			this.force = 15;
			affecting = user.zone_sel.selecting;
			armor_block = 0;
			armor_duration = 0;
			...
			armor_duration /= 10;
			armor_block = Num13.MinInt( 90, ((int)( armor_block )) );
		...
		public void SplashReagents( dynamic M = null ) {
			...
			if ( Lang13.Bool( this.reagents.total_volume ) ) {
				...
				foreach (dynamic _a in Lang13.Enumerate( Map13.FetchViewers( null, M ) )) {
					...
					O.show_message( new Txt( "<span class='danger'>The contents of " ).the( this ).item().str( " splashes all over " ).item( M ).str( "!</span>" ).ToString(), 1 );
				}
