...
namespace Somnium.Game {
	class Obj_Machinery_RequestsConsole : Obj_Machinery {
		...
		public bool departmentType = false;
		...
		public Obj_Machinery_RequestsConsole ( dynamic loc = null ) : base( (object)(loc) ) {
			...
			switch ((bool)( this.departmentType )) {
				case 1:
		...
		public override dynamic Topic( string href = null, ByTable href_list = null, dynamic hsrc = null ) {
			...
			if ( Lang13.Bool( href_list["emergency"] ) ) {
				...
				if ( !Lang13.Bool( this.emergency ) ) {
					...
					switch ((double?)( String13.ParseNumber( href_list["emergency"] ) )) {
						case 1:
			...
			if ( !this.open ) {
				...
				switch ((int)( this.screen )) {
					...
					case 10:
						...
						if ( ( this.announceAuth || GlobalFuncs.IsAdminGhost( a ) ) && Lang13.Bool( this.message ) ) {
