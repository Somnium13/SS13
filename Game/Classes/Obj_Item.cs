...
namespace Somnium.Game {
	class Obj_Item : Obj {
		...
		public override dynamic attack_paw( dynamic a = null, dynamic b = null, dynamic c = null ) {
			...
			if ( !((Mob)a).put_in_active_hand( this ) && picked_up ) {
				this.dropped( a );
			}
			return null;
		}
		...
		public Image build_worn_icon( dynamic state = null, int? default_layer = null, string default_icon_file = null, bool? isinhands = null, dynamic femaleuniform = null ) {
			state = state ?? "";
			...
			if ( !( isinhands == true ) && Lang13.Bool( this.alternate_worn_icon ) ) {
			...
			standing = GlobalFuncs.center_image( standing, ( isinhands == true ? this.inhand_x_dimension : this.worn_x_dimension ), ( isinhands == true ? this.inhand_y_dimension : this.worn_y_dimension ) );
		...
		// Function from file: update_icons.dm
		public virtual ByTable worn_overlays( bool? isinhands = null ) {
			isinhands = isinhands ?? GlobalVars.FALSE;
		...
		public void eyestab( dynamic M = null, dynamic user = null ) {
			...
			M.eye_stat += Rand13.Int( 2, 4 );

			if ( M.eye_stat >= 10 ) {
				M.eye_blurry += M.eye_blurry * 0.1 + 15;
				...
				if ( Rand13.PercentChance( M.eye_stat - 10 + 1 ) && !Lang13.Bool( M.disabilities & 1 ) ) {
