...
namespace Somnium.Game {
	class Obj_Item_Weapon_Gun_Projectile_Automatic_L6Saw : Obj_Item_Weapon_Gun_Projectile_Automatic {
		...
		protected override void __FieldInit() {
			...
			this.mag_type = typeof(Obj_Item_AmmoBox_Magazine_M762);
		...
		public override bool? update_icon( dynamic new_state = null, dynamic new_icon = null, int? new_px = null, int? new_py = null ) {
			this.icon_state = "l6" + ( this.cover_open ? "open" : "closed" ) + ( Lang13.Bool( this.magazine ) ? ((dynamic)( GlobalFuncs.Ceiling( this.get_ammo( false ) / 12.5 ) * 25 )) : ((dynamic)( "-empty" )) );
			return null;
		}
