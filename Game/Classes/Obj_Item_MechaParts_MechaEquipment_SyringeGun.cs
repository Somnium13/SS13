...
namespace Somnium.Game {
	class Obj_Item_MechaParts_MechaEquipment_SyringeGun : Obj_Item_MechaParts_MechaEquipment {
		...
		public Obj_Item_MechaParts_MechaEquipment_SyringeGun ( dynamic loc = null ) : base( (object)(loc) ) {
