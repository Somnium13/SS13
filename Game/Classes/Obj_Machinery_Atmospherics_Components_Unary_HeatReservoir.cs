...
namespace Somnium.Game {
	class Obj_Machinery_Atmospherics_Components_Unary_HeatReservoir : Obj_Machinery_Atmospherics_Components_Unary {
		...
		public Obj_Machinery_Atmospherics_Components_Unary_HeatReservoir ( dynamic loc = null ) : base( (object)(loc) ) {
			
		}

		// Function from file: heat_source.dm
