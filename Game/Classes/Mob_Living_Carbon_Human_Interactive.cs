...
namespace Somnium.Game {
	class Mob_Living_Carbon_Human_Interactive : Mob_Living_Carbon_Human {
		...
		public Mob_Living_Carbon_Human_Interactive ( dynamic loc = null ) : base( (object)(loc) ) {
			...
			this.zone_sel = new Obj_Screen_ZoneSel();
			this.zone_sel.selecting = "chest";
		...
		public override bool Life(  ) {
			...
			if ( !( this.doing != 0 ) && !this.isnotfunc() && !Lang13.Bool( this.TARGET ) ) {
				...
				if ( this.nearby.len > 4 ) {
					...
					this.TARGET = Rand13.PickFromTable( GlobalFuncs.get_area_turfs( this.job2area( this.myjob ) ) );
				}
				this.tryWalk( this.TARGET );
			}
		...
		public void combat( dynamic obj = null ) {
			...
			if ( this.canmove ) {
				...
				if ( Rand13.PercentChance( this.attitude ) && ( this.graytide || ( this.TRAITS & 32 ) != 0 ) || this.retal ) {
					this.a_intent = "harm";
					this.zone_sel.selecting = Rand13.Pick(new object [] { "chest", "r_leg", "l_leg", "r_arm", "l_arm", "head" });
					this.doing |= 8;
		...
		// Function from file: interactive.dm
		public bool isnotfunc( bool? checkDead = null ) {
			...
			if ( Convert.ToDouble( this.health ) <= 0 && checkDead == true ) {
				return true;
			}
		...
		// Function from file: interactive.dm
		public bool? takeDelegate( Mob_Living_Carbon_Human_Interactive from = null, bool? doReset = null ) {
