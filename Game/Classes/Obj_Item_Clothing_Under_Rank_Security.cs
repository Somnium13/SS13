...
namespace Somnium.Game {
	class Obj_Item_Clothing_Under_Rank_Security : Obj_Item_Clothing_Under_Rank {

		protected override void __FieldInit() {
			base.__FieldInit();

			this.item_state = "r_suit";
			this.item_color = "security";
		...
		public Obj_Item_Clothing_Under_Rank_Security ( dynamic loc = null ) : base( (object)(loc) ) {
