...
namespace Somnium.Game {
	class Reagent_Blob : Reagent {
		...
		public void reagent_vortex( dynamic M = null, bool setting_type = false, double? reac_volume = null ) {
			dynamic pull = null;
			int range_power = 0;
			Ent_Dynamic X = null;
		...
		// Function from file: blob_reagents.dm
		public virtual void expand_reaction( Obj_Effect_Blob_Normal B = null, dynamic T = null ) {
			return;
		}
