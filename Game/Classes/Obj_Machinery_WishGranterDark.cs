	...
	class Obj_Machinery_WishGranterDark : Obj_Machinery {
		...
		public override dynamic attack_hand( dynamic a = null, bool? b = null, bool? c = null ) {
			...
			if ( this.chargesa <= 0 ) {
				...
				dynamic _b = wish; // Was a switch-case, sorry for the mess.
				if ( _b=="Power" ) {
					...
					foreach (dynamic _a in Lang13.Enumerate( GlobalVars.mob_list, typeof(Mob_Living_SimpleAnimal_Hostile_Faithless) )) {
						F = _a;
