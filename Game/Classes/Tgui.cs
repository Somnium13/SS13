...
namespace Somnium.Game {
	class Tgui : Game_Data {
		...
		public Tgui ( dynamic user = null, Obj src_object = null, string ui_key = null, string _interface = null, string title = null, int? width = null, int? height = null, Tgui master_ui = null, UiState state = null ) {
			width = width ?? 0;
			height = height ?? 0;
		...
		public override int? process( dynamic seconds = null ) {
			...
			if ( this.status != 0 && ( Lang13.Bool( seconds ) || this.auto_update == true ) ) {
				this.update();
			} else {
		...
		public override dynamic Topic( string href = null, ByTable href_list = null, dynamic hsrc = null ) {
			...
			update = this.src_object.ui_act( action, href_list );

			if ( this.src_object != null && update ) {
		...
		public void update_status( bool? push = null ) {
			...
			status = host.ui_status( this.user, this.state );
		...
		public dynamic get_json( ByTable data = null ) {
			...
			json = GlobalVars.JSON.stringify( json_data );
			json = GlobalFuncs.replacetextEx( json, "ÿ", "" );
			return json;
		}
		...
		// Function from file: tgui.dm
		public void set_auto_update( bool? state = null ) {
			state = state ?? true;
		...
		public void open(  ) {
			...
			if ( !( this.initial_data != null ) ) {
				this.set_initial_data( this.src_object.get_ui_data( this.user ) );
			}
			window_size = "";
