...
namespace Somnium.Game {
	class Obj_Item_Clothing_Head_Helmet : Obj_Item_Clothing_Head {
		...
		public override dynamic attack_self( dynamic user = null, dynamic flag = null, bool? emp = null ) {
			...
			if ( Task13.User.canmove && !( Task13.User.stat != 0 ) && !Task13.User.restrained() && this.can_toggle ) {
				...
				if ( Game13.time > this.cooldown + this.toggle_cooldown ) {
					...
					Task13.User.WriteMsg( new Txt().item( ( this.up != 0 ? this.alt_toggle_message : this.toggle_message ) ).str( " " ).the( this ).item().ToString() );
					Task13.User.update_inv_head();
