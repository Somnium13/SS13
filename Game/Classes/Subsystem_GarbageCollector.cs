...
namespace Somnium.Game {
	class Subsystem_GarbageCollector : Subsystem {
		...
		// Function from file: garbage.dm
		public void HardQueue( dynamic A = null, bool? harddel = null ) {
			harddel = harddel ?? false;
		...
		// Function from file: garbage.dm
		public void Queue( dynamic A = null, bool? harddel = null ) {
			harddel = harddel ?? false;
			...
			this.queue[new Txt().Ref( A ).ToString()] = Game13.time;
			return;
		}
