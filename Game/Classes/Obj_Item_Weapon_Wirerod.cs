...
namespace Somnium.Game {
	class Obj_Item_Weapon_Wirerod : Obj_Item_Weapon {
		...
		public override dynamic attackby( dynamic A = null, dynamic user = null, string _params = null, bool? silent = null, bool? replace_spent = null ) {
			...
			if ( A is Obj_Item_Weapon_Shard ) {
			...
			} else if ( A is Obj_Item_Weapon_Wirecutters && !Lang13.Bool( A.flags & 2 ) ) {
				...
				user.WriteMsg( "<span class='notice'>You fasten the wirecutters to the top of the rod with the cable, prongs outward.</span>" );
				GlobalFuncs.qdel( A );
				GlobalFuncs.qdel( this );
			}
			return null;
