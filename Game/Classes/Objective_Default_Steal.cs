...
namespace Somnium.Game {
	class Objective_Default_Steal : Objective_Default {
		...
		public Objective_Default_Steal ( string text = null ) : base( text ) {
		...
		public dynamic select_target(  ) {
			...
			if ( new_target == "custom" ) {
				...
				custom_name = Lang13.Initial( custom_target, "name" );
		...
		public override dynamic find_target(  ) {
			return this.set_target( GlobalFuncs.safepick( this.find_possible_targets() ) );
		}

		// Function from file: objective.dm
		public override ByTable find_possible_targets(  ) {
			...
			if ( GlobalFuncs.check_rights( 2 ) ) {
				approved_targets.Add( this.select_target() );
			} else {
