...
namespace Somnium.Game {
	class TableRecipe_Meatpizza : TableRecipe {
		...
		protected override void __FieldInit() {
			...
			this.reqs = new ByTable()
				...
				.Set( typeof(Obj_Item_Weapon_ReagentContainers_Food_Snacks_Meat_Cutlet), 4 )
			...
			;
			this.result = typeof(Obj_Item_Weapon_ReagentContainers_Food_Snacks_Pizza_Meat);
			this.category = "Food";
		}
