		...
		public override dynamic Destroy(  ) {
			...
			if ( this.chassis != null ) {
				...
				if ( this is Obj_Item_MechaParts_MechaEquipment_Weapon ) {
					this.chassis.occupant.WriteMsg( new Sound( "sound/mecha/weapdestr.ogg", null, null, null, 50 ) );
				} else {
					this.chassis.occupant.WriteMsg( new Sound( "sound/mecha/critdestr.ogg", null, null, null, 50 ) );
				}
				this.chassis = null;
			}
			return base.Destroy();
