...
namespace Somnium.Game {
	class Objective_EscapeObj_Escape_EscapeWithIdentity : Objective_EscapeObj_Escape {
		...
		public Objective_EscapeObj_Escape_EscapeWithIdentity ( string text = null ) : base( text ) {
