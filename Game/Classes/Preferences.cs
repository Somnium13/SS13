	...
	class Preferences : Game_Data {
		...
		public void update_character( int current_version = 0 ) {
			...
			if ( current_version < 9 ) {
				...
				if ( !GlobalVars.species_list.Contains( this.pref_species ) ) {
					this.pref_species = new Species_Human();
				}
			}
			return;
		...
		public void ShowChoices( Mob user = null ) {
			...
			switch ((double?)( this.current_tab )) {
				case 0:
					...
					dat += "<b>Backpack:</b><BR><a href ='?_src_=prefs;preference=bag;task=input'>" + GlobalVars.backbaglist[this.backbag] + "</a><BR></td>";
				...
				case 1:
					...
					if ( user.client != null ) {
						...
						if ( Lang13.Bool( this.unlock_content ) || GlobalFuncs.check_rights_for( user.client, 2 ) ) {
							dat += "<b>OOC:</b> <span style='border: 1px solid #161616; background-color: " + ( Lang13.Bool( this.ooccolor ) ? this.ooccolor : GlobalVars.normal_ooc_colour ) + ";'>&nbsp;&nbsp;&nbsp;</span> <a href='?_src_=prefs;preference=ooccolor;task=input'>Change</a><br>";
						}
