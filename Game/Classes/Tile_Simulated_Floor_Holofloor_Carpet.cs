...
namespace Somnium.Game {
	class Tile_Simulated_Floor_Holofloor_Carpet : Tile_Simulated_Floor_Holofloor {
		...
		public Tile_Simulated_Floor_Holofloor_Carpet ( dynamic loc = null ) : base( (object)(loc) ) {
