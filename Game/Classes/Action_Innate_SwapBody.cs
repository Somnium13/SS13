...
namespace Somnium.Game {
	class Action_Innate_SwapBody : Action_Innate {
		...
		public Action_Innate_SwapBody ( dynamic Target = null ) : base( (object)(Target) ) {
		...
		public override void Activate(  ) {
			...
			if ( !Lang13.Bool( this.body ) || !( this.body is Mob_Living_Carbon_Human ) || !Lang13.Bool( this.body.dna ) || !Lang13.Bool( this.body.dna.species ) || this.body.dna.species.id != "slime" || Convert.ToInt32( this.body.stat ) == 2 || GlobalFuncs.qdeleted( this.body ) ) {
