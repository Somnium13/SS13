...
namespace Somnium.Game {
	class Obj_DockingPort_Mobile_Emergency : Obj_DockingPort_Mobile {
		...
		public override void check(  ) {
			...
			Obj_DockingPort_Mobile_Pod M = null;
			Zone_Shuttle_Escape E2 = null;
			Obj_DockingPort_Mobile_Pod M2 = null;
			...
			switch ((int)( this.mode )) {
				...
				case 3:
					...
					if ( time_left <= 0 && !GlobalVars.SSshuttle.emergencyNoEscape ) {
						...
						foreach (dynamic _c in Lang13.Enumerate( GlobalVars.SSshuttle.mobile, typeof(Obj_DockingPort_Mobile_Pod) )) {
							M = _c;
				...
				case 5:
					...
					if ( time_left <= 0 ) {
						...
						foreach (dynamic _e in Lang13.Enumerate( GlobalVars.SSshuttle.mobile, typeof(Obj_DockingPort_Mobile_Pod) )) {
							M2 = _e;
							

							if ( M2.launch_status == 1 ) {
								M2.dock( GlobalVars.SSshuttle.getDock( "" + M2.id + "_away" ) );
							}
						}
