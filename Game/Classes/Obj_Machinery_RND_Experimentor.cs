	...
	class Obj_Machinery_RND_Experimentor : Obj_Machinery_RND {
				...
				if ( dotype != 8 ) {
					...
					if ( Lang13.Bool( process ) && Lang13.Bool( process.origin_tech ) ) {
						...
						foreach (dynamic _a in Lang13.Enumerate( temp_tech )) {
							...
							((Research)this.linked_console.files).UpdateTech( T, Convert.ToInt32( temp_tech[T] ) );
						}
		...
		public override dynamic attack_hand( dynamic a = null, bool? b = null, bool? c = null ) {
			...
			if ( Lang13.Bool( this.loaded_item ) ) {
				...
				if ( this.recentlyExperimented ) {
					dat += "<b>The " + this + " is still resetting!</b>";
				} else {
			...
			dat += new Txt( "<br><a href='byond://?src=" ).Ref( this ).str( ";function=close'>Close</A><br></center>" ).ToString();
		...
		public override dynamic attackby( dynamic A = null, dynamic user = null, string _params = null, bool? silent = null, bool? replace_spent = null ) {
			...
			if ( !( this.checkCircumstances( A ) == true ) ) {
		...
		// Function from file: experimentor.dm
		public void ejectItem( bool? delete = null ) {
			...
			if ( Lang13.Bool( this.loaded_item ) ) {
				...
				if ( this.cloneMode == true && this.cloneCount > 0 ) {
		...
		// Function from file: experimentor.dm
		public bool? checkCircumstances( dynamic O = null ) {
			dynamic T = null;
