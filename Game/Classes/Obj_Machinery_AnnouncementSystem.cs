...
namespace Somnium.Game {
	class Obj_Machinery_AnnouncementSystem : Obj_Machinery {
		...
		public override dynamic Topic( string href = null, ByTable href_list = null, dynamic hsrc = null ) {
			...
			if ( !this.can_be_used_by( Task13.User ) || Lang13.Bool( Task13.User.lying ) || Task13.User.stat != 0 || Task13.User.stunned != 0 ) {
				return null;
			}
		...
		public override bool? update_icon( dynamic new_state = null, dynamic new_icon = null, int? new_px = null, int? new_py = null ) {
			...
			if ( this.is_operational() ) {
				this.icon_state = ( this.panel_open == true ? "AAS_On_Open" : "AAS_On" );
			} else {
				this.icon_state = ( this.panel_open == true ? "AAS_Off_Open" : "AAS_Off" );
			}
			this.overlays.Cut();
