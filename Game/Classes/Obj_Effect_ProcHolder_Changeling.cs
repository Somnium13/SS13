...
namespace Somnium.Game {
	class Obj_Effect_ProcHolder_Changeling : Obj_Effect_ProcHolder {
		...
		// Function from file: changeling_power.dm
		public virtual bool can_sting( Mob user = null, dynamic target = null ) {
			Changeling c = null;
			...
			if ( ( c.absorbedcount ??0) < ( this.req_dna ??0) ) {
		...
		// Function from file: changeling_power.dm
		public virtual bool sting_feedback( Mob user = null, dynamic target = null ) {
			return false;
		}

		// Function from file: changeling_power.dm
		public virtual dynamic sting_action( Mob user = null, dynamic target = null ) {
			return 0;
		}

		// Function from file: changeling_power.dm
		public virtual void try_to_sting( Mob user = null, dynamic target = null ) {
			Changeling c = null;
