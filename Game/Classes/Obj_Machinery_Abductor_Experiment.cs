	...
	class Obj_Machinery_Abductor_Experiment : Obj_Machinery_Abductor {
		...
		public string Experiment( dynamic occupant = null, string type = null ) {
			...
			if ( H.mind != null && H.ckey != null ) {
				...
				switch ((double?)( String13.ParseNumber( type ) )) {
					case 1:
		...
		public override bool MouseDrop_T( Ent_Static O = null, dynamic user = null, bool? needs_opened = null, bool? show_message = null, bool? move_them = null ) {
			...
			if ( Lang13.Bool( user.stat ) || Lang13.Bool( user.lying ) || !this.Adjacent( user ) || !O.Adjacent( user ) || !( O is Mob_Living_Carbon_Human ) ) {
				return false;
			}

			if ( this.IsAbductor( O ) ) {
				return false;
			}
