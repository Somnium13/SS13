...
namespace Somnium.Game {
	class Mutation_Human_Clumsy : Mutation_Human {
		...
		protected override void __FieldInit() {
			...
			this.quality = 3;
			this.text_gain_indication = "<span class='danger'>You feel lightheaded.</span>";
		}
