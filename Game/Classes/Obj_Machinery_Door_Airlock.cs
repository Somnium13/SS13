...
namespace Somnium.Game {
	class Obj_Machinery_Door_Airlock : Obj_Machinery_Door {
		...
		public override bool emag_act( dynamic user = null ) {
			...
			if ( !this.operating && this.density && this.hasPower() && !( this.emagged != 0 ) ) {
				this.operating = true;
		...
		public override dynamic attackby( dynamic A = null, dynamic user = null, string _params = null, bool? silent = null, bool? replace_spent = null ) {
			...
			if ( !( Task13.User is Mob_Living_Silicon || GlobalFuncs.IsAdminGhost( user ) ) ) {
		...
		public override dynamic Topic( string href = null, ByTable href_list = null, dynamic hsrc = null ) {
			...
			if ( ( Task13.User.stat != 0 || Task13.User.restrained() ) && !GlobalFuncs.IsAdminGhost( Task13.User ) ) {
				return null;
			}
			...
			if ( Task13.User is Mob_Living_Silicon && this.canAIControl() || GlobalFuncs.IsAdminGhost( Task13.User ) ) {
					...
					switch ((double?)( code )) {
						...
						case 9:
							...
							if ( this.isWireCut( GlobalVars.AIRLOCK_WIRE_SPEED ) != 0 ) {
								...
								Task13.User.WriteMsg( "Door timing circurity already accellerated." );
							}
							break;
						case 7:
					...
					switch ((double?)( code2 )) {
						...
						case 9:
							...
							if ( this.isWireCut( GlobalVars.AIRLOCK_WIRE_SPEED ) != 0 ) {
								...
								Task13.User.WriteMsg( "Door timing circurity currently operating normally." );
							}
							break;
						case 7:
		...
		public override dynamic attack_hand( dynamic a = null, bool? b = null, bool? c = null ) {
			...
			if ( !( a is Mob_Living_Silicon || GlobalFuncs.IsAdminGhost( a ) ) ) {
		...
		public override dynamic Destroy(  ) {
			...
			if ( Lang13.Bool( this.frequency ) && GlobalVars.SSradio != null ) {
		...
		public void f_autoclose(  ) {
			...
			if ( !GlobalFuncs.qdeleted( this ) && !this.density && !this.operating && !this.locked && !this.welded && this.autoclose ) {
				this.close();
			}
			return;
		}
			...
			if ( !this.aiHacking ) {
				...
				Task13.Schedule( 20, (Task13.Closure)(() => {
					...
					if ( this.canAIControl() ) {
						...
						user.WriteMsg( "We've lost our connection! Unable to hack airlock." );
						this.aiHacking = false;
						return;
					}
