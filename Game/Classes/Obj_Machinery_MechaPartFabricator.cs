	...
	class Obj_Machinery_MechaPartFabricator : Obj_Machinery {
		...
		public override dynamic attackby( dynamic A = null, dynamic user = null, string _params = null, bool? silent = null, bool? replace_spent = null ) {
			...
			if ( A is Obj_Item_Stack ) {
				...
				switch ((Type)( A.type )) {
					case typeof(Obj_Item_Stack_Sheet_Mineral_Gold):
						material2 = "$gold";
						break;
					case typeof(Obj_Item_Stack_Sheet_Mineral_Silver):
						material2 = "$silver";
						break;
					case typeof(Obj_Item_Stack_Sheet_Mineral_Diamond):
						material2 = "$diamond";
						break;
					case typeof(Obj_Item_Stack_Sheet_Mineral_Plasma):
						material2 = "$plasma";
						break;
					case typeof(Obj_Item_Stack_Sheet_Metal):
						material2 = "$metal";
						break;
					case typeof(Obj_Item_Stack_Sheet_Glass):
						material2 = "$glass";
						break;
					case typeof(Obj_Item_Stack_Sheet_Mineral_Bananium):
						material2 = "$bananium";
						break;
					case typeof(Obj_Item_Stack_Sheet_Mineral_Uranium):
						material2 = "$uranium";
						break;
					default:
		...
		public override dynamic Topic( string href = null, ByTable href_list = null, dynamic hsrc = null ) {
			...
			if ( Lang13.Bool( href_list["queue_move"] ) && Lang13.Bool( href_list["index"] ) ) {
				...
				if ( Lang13.Bool( Lang13.IsNumber( index ) ) && Lang13.Bool( Lang13.IsNumber( new_index ) ) ) {
					...
					if ( GlobalFuncs.IsInRange( new_index, true, this.queue.len ) ) {
			...
			if ( Lang13.Bool( href_list["part_desc"] ) ) {
				...
				foreach (dynamic _c in Lang13.Enumerate( this.files.known_designs, typeof(Design) )) {
					D3 = _c;
		...
		public void f_sync(  ) {
			...
			foreach (dynamic _c in Lang13.Enumerate( Map13.FetchInViewExcludeThis( this, 5 ), typeof(Obj_Machinery_Computer_Rdconsole) )) {
				...
				foreach (dynamic _a in Lang13.Enumerate( RDC.files.known_tech, typeof(Tech) )) {
					T = _a;
					
					this.files.AddTech2Known( T );
				}

				foreach (dynamic _b in Lang13.Enumerate( RDC.files.known_designs, typeof(Design) )) {
					D = _b;
