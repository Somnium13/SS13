			...
			if ( Lang13.Bool( this.target ) ) {
				...
				if ( Lang13.Bool( this.path.len ) == false ) {
					...
					if ( !( this.target is Tile ) ) {
						...
						this.path = GlobalFuncs.get_path_to( this.loc, TL, this, typeof(Tile).GetMethod( "Distance_cardinal" ), false, 30, null, null, this.access_card, null, false );
					} else {
						this.path = GlobalFuncs.get_path_to( this.loc, this.target, this, typeof(Tile).GetMethod( "Distance_cardinal" ), false, 30, null, null, this.access_card, null, false );
					}
