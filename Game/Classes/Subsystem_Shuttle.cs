...
namespace Somnium.Game {
	class Subsystem_Shuttle : Subsystem {
		...
		// Function from file: shuttles.dm
		public SupplyOrder generateSupplyOrder( dynamic packId = null, dynamic _orderedby = null, dynamic _orderedbyRank = null, string _comment = null ) {
			dynamic P = null;
			SupplyOrder O = null;

			
			if ( !Lang13.Bool( packId ) ) {
				return null;
			}
			P = this.supply_packs["" + packId];

			if ( !Lang13.Bool( P ) ) {
				return null;
			}
			O = new SupplyOrder();
			O.ordernum = this.ordernum++;
			O.v_object = P;
			O.orderedby = _orderedby;
			O.orderedbyRank = _orderedbyRank;
			O.comment = _comment;
			this.requestlist.Add( O );
			return O;
		}
		...
		public void initial_move(  ) {
			...
			foreach (dynamic _b in Lang13.Enumerate( this.mobile, typeof(Obj_DockingPort_Mobile) )) {
				...
				this.moveShuttle( M.id, "" + M.roundstart_move, false );
			}
			return;
		}

		// Function from file: shuttles.dm
		public int moveShuttle( string shuttleId = null, string dockId = null, bool? timed = null ) {
			Obj_DockingPort_Mobile M = null;
		...
		// Function from file: shuttles.dm
		public int toggleShuttle( string shuttleId = null, string dockHome = null, string dockAway = null, bool? timed = null ) {
			Obj_DockingPort_Mobile M = null;
		...
		public Obj_DockingPort_Stationary getDock( string id = null ) {
			...
			GlobalFuncs.warning( "" + ( "couldn't find dock with id: " + id ) + " in " + "code/controllers/subsystem/shuttles.dm" + " at line " + 82 + " src: " + this + " usr: " + Task13.User + "." );
			return null;
		}

		// Function from file: shuttles.dm
		public Obj_DockingPort_Mobile getShuttle( dynamic id = null ) {
			Obj_DockingPort_Mobile M = null;
			...
			GlobalFuncs.warning( "" + ( "couldn't find shuttle with id: " + id ) + " in " + "code/controllers/subsystem/shuttles.dm" + " at line " + 76 + " src: " + this + " usr: " + Task13.User + "." );
			return null;
		}
