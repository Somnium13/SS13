...
namespace Somnium.Game {
	class NKeyword_NSKeyword_KwWhile : NKeyword_NSKeyword {

		public NKeyword_NSKeyword_KwWhile ( bool? inline = null ) : base( inline ) {
		...
		public override int Parse( NParser parser = null ) {
			...
			Node_Statement_WhileLoop stmt = null;

			_default = GlobalVars.KW_PASS ?1:0;
			stmt = new Node_Statement_WhileLoop();
			parser.NextToken();
