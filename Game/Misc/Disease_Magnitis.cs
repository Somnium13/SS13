...
namespace Somnium.Game {
	class Disease_Magnitis : Disease {
		...
		public Disease_Magnitis ( bool? process = null, Disease_Advance D = null ) : base( process, D ) {
			...
			switch ((int?)( this.stage )) {
				case 2:
					...
					if ( Rand13.PercentChance( 2 ) ) {
						GlobalFuncs.to_chat( this.affected_mob, "<span class='warning'>You feel a slight shock course through your body.</span>" );
					}
				...
				case 3:
					...
					if ( Rand13.PercentChance( 2 ) ) {
						GlobalFuncs.to_chat( this.affected_mob, "<span class='warning'>You feel a strong shock course through your body.</span>" );
					}

					if ( Rand13.PercentChance( 2 ) ) {
						GlobalFuncs.to_chat( this.affected_mob, "<span class='warning'>You feel like clowning around.</span>" );
					}
					...
					if ( Rand13.PercentChance( 4 ) ) {
						...
						foreach (dynamic _c in Lang13.Enumerate( Map13.FetchInRangeExcludeThis( this.affected_mob, 4 ), typeof(Obj) )) {
							...
							if ( !Lang13.Bool( M2.anchored ) && M2.is_conductor() ) {
								i = null;
								iter = Rand13.Int( 1, 2 );
								i = 0;
				...
				case 4:
					...
					if ( Rand13.PercentChance( 2 ) ) {
						GlobalFuncs.to_chat( this.affected_mob, "<span class='warning'>You feel a powerful shock course through your body.</span>" );
					}

					if ( Rand13.PercentChance( 2 ) ) {
						GlobalFuncs.to_chat( this.affected_mob, "<span class='warning'>You query upon the nature of miracles.</span>" );
					}
					...
					if ( Rand13.PercentChance( 8 ) ) {
						...
						foreach (dynamic _e in Lang13.Enumerate( Map13.FetchInRangeExcludeThis( this.affected_mob, 6 ), typeof(Obj) )) {
							...
							if ( !Lang13.Bool( M3.anchored ) && M3.is_conductor() ) {
								i3 = null;
