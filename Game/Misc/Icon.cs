...
namespace Somnium.Game {
	class Icon : Game_Data {
		...
		public Icon ( dynamic icon = null, dynamic icon_state = null, dynamic dir = null, int? frame = null, bool? moving = null ) {
			this.icon = Icon13.create( icon, icon_state, Convert.ToInt32( dir ), frame ??0, moving == true );
			return;
		}
		...
		public void Insert( Icon new_icon = null, string icon_state = null, double? dir = null, int? frame = null, bool? moving = null, int? delay = null ) {
		...
		public void SetIntensity( double r = 0, int? g = null, int? b = null ) {
			g = g ?? -1;
			b = b ?? -1;

			Icon13.oper_set_intensity( this.icon, ((int)( r )), g ??0, b ??0 );
		}
		...
		public void Turn( double angle = 0, dynamic antialias = null ) {
