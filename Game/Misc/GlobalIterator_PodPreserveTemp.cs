...
namespace Somnium.Game {
	class GlobalIterator_PodPreserveTemp : GlobalIterator {
		...
		public GlobalIterator_PodPreserveTemp ( ByTable arguments = null, bool? autostart = null ) : base( arguments, autostart ) {
