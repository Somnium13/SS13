...
namespace Somnium.Game {
	class Automation_Avg : Automation {

		protected override void __FieldInit() {
			base.__FieldInit();

			this.name = "avg statement";
			this.returntype = true;
			this.valid_child_returntypes = new ByTable(new object [] { 1 });
		}

		public Automation_Avg ( Obj_Machinery_Computer_GeneralAirControl_AtmosAutomation aa = null ) : base( aa ) {
		...
		public override string GetText(  ) {
			...
			_default = new Txt( "AVG (<a href=\"?src=" ).Ref( this ).str( ";add=1\">Add</a>)" ).ToString();
