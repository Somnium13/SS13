...
namespace Somnium.Game {
	class Design_AirManagement : Design {
		...
		protected override void __FieldInit() {
			...
			this.name = "Circuit Design (Atmospheric General Monitor)";
			this.desc = "Allows for the construction of circuit boards used to build an Atmospheric General Monitor.";
