...
namespace Somnium.Game {
	class MapGenerator : Game_Data {
		...
		// Function from file: mapGenerator.dm
		public bool checkRegion( Tile Start = null, Tile End = null ) {
			bool _default = false;
			...
			if ( Start.x > Game13.map_size_x || End.x > Game13.map_size_x ) {
				_default = false;
			}

			if ( Start.y > Game13.map_size_y || End.y > Game13.map_size_y ) {
				_default = false;
			}

			if ( Start.z > Game13.map_size_z || End.z > Game13.map_size_z ) {
				_default = false;
			}
			return _default;
		}
		...
		// Function from file: mapGenerator.dm
		public dynamic defineCircularRegion( Tile Start = null, Tile End = null, bool? replace = null ) {
		...
		// Function from file: mapGenerator.dm
		public dynamic defineRegion( Tile Start = null, Tile End = null, bool? replace = null ) {
			replace = replace ?? false;
