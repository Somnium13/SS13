...
namespace Somnium.Game {
	class Job_CargoTech : Job {
		...
		protected override void __FieldInit() {
			...
			this.access = new ByTable(new object [] { 12, 50, 31, 34, 51, 48, 54, 67 });
			this.minimal_access = new ByTable(new object [] { 12, 31, 34, 50, 67 });
			this.pdatype = typeof(Obj_Item_Device_Pda_Cargo);
		...
		public override bool equip( dynamic H = null ) {
			...
			((Mob_Living_Carbon_Human)H).equip_or_collect( new Obj_Item_Clothing_Under_Rank_Cargotech( H ), 14 );
