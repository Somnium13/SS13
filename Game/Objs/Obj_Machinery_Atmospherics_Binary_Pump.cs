...
namespace Somnium.Game {
	class Obj_Machinery_Atmospherics_Binary_Pump : Obj_Machinery_Atmospherics_Binary {
		...
		protected override void __FieldInit() {
			...
			this.icon = "icons/obj/atmospherics/pump.dmi";
			this.icon_state = "intact_off";
		}

		public Obj_Machinery_Atmospherics_Binary_Pump ( dynamic loc = null ) : base( (object)(loc) ) {
		...
		public override bool receive_signal( Game_Data signal = null, bool? receive_method = null, dynamic receive_param = null ) {
			...
			this.update_icon();
			this.investigation_log( "atmos", "was turned " + ( Lang13.Bool( this.on ) ? "on" : "off" ) + " by signal." );
			return false;
		}
		...
		public override dynamic process(  ) {
			...
			if ( ( this.stat & 3 ) != 0 || !Lang13.Bool( this.on ) ) {
				return _default;
			}
			output_starting_pressure = this.air2.return_pressure();

			if ( ( this.target_pressure ??0) - Convert.ToDouble( output_starting_pressure ) < 0.01 ) {
				return _default;
			}

			if ( Convert.ToDouble( this.air1.f_total_moles() ) > 0 && ( this.air1.temperature ??0) > 0 ) {
				pressure_delta = ( this.target_pressure ??0) - Convert.ToDouble( output_starting_pressure );
