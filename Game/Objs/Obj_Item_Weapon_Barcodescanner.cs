...
namespace Somnium.Game {
	class Obj_Item_Weapon_Barcodescanner : Obj_Item_Weapon {
		...
		public override dynamic attack_self( dynamic user = null, dynamic flag = null, bool? emp = null ) {
			...
			GlobalFuncs.to_chat( user, "" + this + " Status Display:" );
			...
			GlobalFuncs.to_chat( user, " - Mode " + this.mode + " : " + modedesc );

			if ( Lang13.Bool( this.computer ) ) {
				GlobalFuncs.to_chat( user, "<font color=green>Computer has been associated with this unit.</font>" );
			} else {
				GlobalFuncs.to_chat( user, "<font color=red>No associated computer found. Only local scans will function properly.</font>" );
			}
			GlobalFuncs.to_chat( user, "\n" );
			return null;
		}
