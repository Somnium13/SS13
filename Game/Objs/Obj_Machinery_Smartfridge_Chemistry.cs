...
namespace Somnium.Game {
	class Obj_Machinery_Smartfridge_Chemistry : Obj_Machinery_Smartfridge {
		...
		protected override void __FieldInit() {
			...
			this.accepted_types = new ByTable(new object [] { typeof(Obj_Item_Weapon_Storage_PillBottle), typeof(Obj_Item_Weapon_ReagentContainers) });
		}
		...
		public Obj_Machinery_Smartfridge_Chemistry ( dynamic loc = null ) : base( (object)(loc) ) {
			...
			this.component_parts = new ByTable(new object [] { 
				new Obj_Item_Weapon_Circuitboard_Smartfridge_Chemistry(), 
