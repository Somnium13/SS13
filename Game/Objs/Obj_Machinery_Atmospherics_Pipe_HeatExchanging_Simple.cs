...
namespace Somnium.Game {
	class Obj_Machinery_Atmospherics_Pipe_HeatExchanging_Simple : Obj_Machinery_Atmospherics_Pipe_HeatExchanging {
		...
		protected override void __FieldInit() {
			...
			this.initialize_directions_he = 3;
			this.icon_state = "intact";
		}

		public Obj_Machinery_Atmospherics_Pipe_HeatExchanging_Simple ( dynamic loc = null, int? process = null ) : base( (object)(loc), process ) {
		...
		public override void SetInitDirections(  ) {
			...
			if ( GlobalVars.diagonals.Contains( this.dir ) ) {
				this.initialize_directions_he = this.dir;
			}
			...
			switch ((int)( this.dir )) {
				...
				case 4:
				case 8:
					this.initialize_directions_he = 12;
					break;
			}
			return;
		}
