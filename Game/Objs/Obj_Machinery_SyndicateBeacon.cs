	...
	class Obj_Machinery_SyndicateBeacon : Obj_Machinery {
		...
		public void selfdestruct(  ) {
			...
			Task13.Schedule( 0, (Task13.Closure)(() => {
				GlobalFuncs.explosion( this.loc, 1, Rand13.Int( 1, 3 ), Rand13.Int( 3, 8 ), 10 );
				return;
			}));
			return;
		}
		...
		public override dynamic Topic( string href = null, ByTable href_list = null, dynamic hclient = null, HtmlInterface currui = null ) {
			...
			if ( Lang13.Bool( href_list["betraitor"] ) ) {
				...
				if ( M is Mob_Living_Carbon_Human ) {
					...
					GlobalFuncs.to_chat( M, "<B>You have joined the ranks of the Syndicate and become a traitor to the station!</B>" );
					GlobalFuncs.message_admins( "" + N + "/(" + N.ckey + ") has accepted a traitor objective from a syndicate beacon." );
					obj_count = 1;

					foreach (dynamic _c in Lang13.Enumerate( M.mind.objectives, typeof(Objective) )) {
						OBJ = _c;
						
						GlobalFuncs.to_chat( M, "<B>Objective #" + obj_count + "</B>: " + OBJ.explanation_text );
						obj_count++;
					}
				}
			}
