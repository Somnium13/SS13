...
namespace Somnium.Game {
	class Obj_Item_Weapon_ReagentContainers_Glass_Bottle_EpiglottisVirion : Obj_Item_Weapon_ReagentContainers_Glass_Bottle {
		...
		public Obj_Item_Weapon_ReagentContainers_Glass_Bottle_EpiglottisVirion ( dynamic loc = null, dynamic altvol = null ) : base( (object)(loc), (object)(altvol) ) {
			Disease_Advance_VoiceChange F = null;
			ByTable data = null;

			// Warning: Super call was HERE! If anything above HERE is needed by the super call, it might break!;
			F = new Disease_Advance_VoiceChange( false );
