...
namespace Somnium.Game {
	class Obj_Machinery_Atmospherics_Unary_HeatReservoir : Obj_Machinery_Atmospherics_Unary {
		...
		public Obj_Machinery_Atmospherics_Unary_HeatReservoir ( dynamic loc = null ) : base( (object)(loc) ) {
