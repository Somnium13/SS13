...
namespace Somnium.Game {
	class Obj_Item_Clothing_Head_Helmet_Space_Vox_Civ_Engineer : Obj_Item_Clothing_Head_Helmet_Space_Vox_Civ {
		...
		public Obj_Item_Clothing_Head_Helmet_Space_Vox_Civ_Engineer ( dynamic loc = null ) : base( (object)(loc) ) {
