	...
	class Obj_Mecha_Working_Ripley : Obj_Mecha_Working {
		...
		public override bool update_icon( dynamic new_state = null, dynamic new_icon = null, int? new_px = null, int? new_py = null ) {
			...
			if ( Lang13.Bool( this.hides ) ) {
				...
				if ( ( this.hides ??0) < 3 ) {
					this.overlays.Add( new Image( "mecha.dmi", null, ( this.occupant != null ? "ripley-g" : "ripley-g-open" ) ) );
				} else {
					this.overlays.Add( new Image( "mecha.dmi", null, ( this.occupant != null ? "ripley-g-full" : "ripley-g-full-open" ) ) );
				}
			}
			return false;
		}
