...
namespace Somnium.Game {
	class Obj_Item_Weapon_Grenade_ChemGrenade_Antiweed : Obj_Item_Weapon_Grenade_ChemGrenade {
		...
		public Obj_Item_Weapon_Grenade_ChemGrenade_Antiweed ( dynamic loc = null ) : base( (object)(loc) ) {
			...
			((Reagents)B1.reagents).add_reagent( "plantbgone", 25 );
			((Reagents)B1.reagents).add_reagent( "potassium", 25 );
			((Reagents)B2.reagents).add_reagent( "phosphorus", 25 );
			((Reagents)B2.reagents).add_reagent( "sugar", 25 );
