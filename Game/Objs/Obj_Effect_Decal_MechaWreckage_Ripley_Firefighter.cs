...
namespace Somnium.Game {
	class Obj_Effect_Decal_MechaWreckage_Ripley_Firefighter : Obj_Effect_Decal_MechaWreckage_Ripley {

		protected override void __FieldInit() {
			base.__FieldInit();

			this.icon_state = "firefighter-broken";
		}

		// Function from file: mecha_wreckage.dm
		public Obj_Effect_Decal_MechaWreckage_Ripley_Firefighter ( dynamic loc = null ) : base( (object)(loc) ) {
			ByTable parts = null;
			int? i = null;
			dynamic part = null;
			...
			parts = new ByTable(new object [] { 
				...
				typeof(Obj_Item_Clothing_Suit_Fire)
			 });
			i = null;
			i = 0;
