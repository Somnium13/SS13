...
namespace Somnium.Game {
	class Obj_Structure_TransitTubePod : Obj_Structure {
		...
		public Obj_Structure_TransitTubePod ( dynamic loc = null ) : base( (object)(loc) ) {
			...
			this.air_contents.gases["o2"][1] = 43.67319107055664;
			this.air_contents.gases["n2"][1] = 82.14720153808594;
		...
		public override void container_resist( Mob user = null ) {
			...
			if ( !this.moving ) {
				...
				user2.WriteMsg( "<span class='notice'>You start trying to escape from the pod...</span>" );

				if ( GlobalFuncs.do_after( user2, 600, null, this ) ) {
					user2.WriteMsg( "<span class='notice'>You manage to open the pod.</span>" );
					this.empty();
				}
			}
			return;
