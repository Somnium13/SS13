...
namespace Somnium.Game {
	class Obj_Machinery_Atmospherics_Unary_HeatReservoir_Heater : Obj_Machinery_Atmospherics_Unary_HeatReservoir {

		public dynamic temp_offset = 0;
		public ByTable rotate_verbs = new ByTable(new object [] { 
											typeof(Obj_Machinery_Atmospherics_Unary_HeatReservoir_Heater).GetMethod( "rotate" ), 
											typeof(Obj_Machinery_Atmospherics_Unary_HeatReservoir_Heater).GetMethod( "rotate_ccw" )
										 });
		...
		public Obj_Machinery_Atmospherics_Unary_HeatReservoir_Heater ( dynamic loc = null ) : base( (object)(loc) ) {
			// Warning: Super call was HERE! If anything above HERE is needed by the super call, it might break!;
			this.component_parts = new ByTable(new object [] { 
				new Obj_Item_Weapon_Circuitboard_Heater(), 
		...
		public override dynamic Topic( string href = null, ByTable href_list = null, dynamic hclient = null, HtmlInterface currui = null ) {
			...
			if ( Lang13.Bool( base.Topic( href, href_list, (object)(hclient) ) ) ) {
				...
				if ( Lang13.Bool( href_list["temp"] ) ) {
					...
					if ( ( amount ??0) > 0 ) {
						this.current_temperature = Num13.MinInt( Convert.ToInt32( this.temp_offset + 573.1500244140625 ), ((int)( ( this.current_temperature ??0) + ( amount ??0) )) );
					} else {
						this.current_temperature = Num13.MaxInt( ((int)( 293.41 )), ((int)( ( this.current_temperature ??0) + ( amount ??0) )) );
					}
				}
			}
			this.updateUsrDialog();
