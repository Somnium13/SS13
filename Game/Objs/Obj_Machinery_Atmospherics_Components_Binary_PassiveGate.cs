...
namespace Somnium.Game {
	class Obj_Machinery_Atmospherics_Components_Binary_PassiveGate : Obj_Machinery_Atmospherics_Components_Binary {
		...
		protected override void __FieldInit() {
			...
			this.icon_state = "passgate_map";
		}

		public Obj_Machinery_Atmospherics_Components_Binary_PassiveGate ( dynamic loc = null, int? process = null ) : base( (object)(loc), process ) {
		...
		public override void update_icon_nopipes( bool? animation = null ) {
			...
			if ( !Lang13.Bool( this.on ) ) {
				this.icon_state = "passgate_off";
				this.overlays.Cut();
				return;
			}
			this.overlays.Add( this.getpipeimage( "icons/obj/atmospherics/components/binary_devices.dmi", "passgate_on" ) );
			return;
		}
