	...
	class Obj_Item_Weapon_Gun : Obj_Item_Weapon {
		...
		public override bool afterattack( dynamic target = null, dynamic user = null, bool? proximity_flag = null, string click_parameters = null ) {
			...
			if ( proximity_flag == true ) {
				...
				if ( target == user && user.zone_selected != "mouth" ) {
					return false;
				}
			}
			...
			if ( Lang13.Bool( this.clumsy_check ) ) {
				
				if ( user is Mob_Living ) {
					
					if ( Lang13.Bool( user.disabilities & 256 ) && Rand13.PercentChance( 40 ) ) {
		...
		// Function from file: gun.dm
		public void zoom( dynamic user = null, int? forced_zoom = null ) {
			int ___x = 0;
			int ___y = 0;
			...
			switch ((int?)( forced_zoom )) {
				...
				case 1:
					...
					break;
				default:
					this.zoomed = !Lang13.Bool( this.zoomed ) ?1:0;
					break;
			}

			if ( Lang13.Bool( this.zoomed ) ) {
				___x = 0;
				___y = 0;
		...
		public virtual void handle_suicide( dynamic user = null, dynamic target = null, string _params = null ) {
			...
			if ( !GlobalFuncs.do_mob( user, target, 120 ) || user.zone_selected != "mouth" ) {
		...
		public bool can_trigger_gun( dynamic user = null ) {
			...
			if ( !this.handle_pins( user ) || !((Mob_Living)user).can_use_guns( this ) ) {
				return false;
			}
			return true;
		}
