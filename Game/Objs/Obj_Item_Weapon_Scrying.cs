...
namespace Somnium.Game {
	class Obj_Item_Weapon_Scrying : Obj_Item_Weapon {
		...
		public override dynamic attack_self( dynamic user = null, dynamic flag = null, bool? emp = null ) {
			GlobalFuncs.to_chat( user, "<span class='notice'>You can see...everything!</span>" );
			this.visible_message( "<span class='danger'>" + Task13.User + " stares into " + this + ", their eyes glazing over.</span>" );
			((Mob)user).ghostize( true );
			user.mind.isScrying = true;
			return null;
		}
