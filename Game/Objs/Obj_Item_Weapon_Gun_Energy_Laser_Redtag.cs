...
namespace Somnium.Game {
	class Obj_Item_Weapon_Gun_Energy_Laser_Redtag : Obj_Item_Weapon_Gun_Energy_Laser {
		...
		protected override void __FieldInit() {
			...
			this.projectile_type = "/obj/item/projectile/beam/lastertag/red";
		...
		public Obj_Item_Weapon_Gun_Energy_Laser_Redtag ( dynamic loc = null ) : base( (object)(loc) ) {
