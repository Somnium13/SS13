...
namespace Somnium.Game {
	class Obj_Machinery_Computer_Cloning : Obj_Machinery_Computer {
		...
		public dynamic scantemp_ckey = null;
		...
		public override dynamic Topic( string href = null, ByTable href_list = null, dynamic hsrc = null ) {
			...
			if ( Lang13.Bool( href_list["task"] ) ) {
				...
				dynamic _c = href_list["disk"]; // Was a switch-case, sorry for the mess.
				if ( _c=="load" ) {
					...
					foreach (dynamic _b in Lang13.Enumerate( this.diskette.fields )) {
						key = _b;
						
						this.active_record.fields[key] = this.diskette.fields[key];
					}
					...
					if ( !Lang13.Bool( this.diskette ) || this.diskette.read_only || !( this.active_record != null ) || !( this.active_record.fields != null ) ) {
