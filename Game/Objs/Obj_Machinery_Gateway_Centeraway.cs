		...
		public override dynamic attackby( dynamic a = null, dynamic b = null, dynamic c = null ) {
			...
			if ( a is Obj_Item_Device_Multitool ) {
				...
				if ( this.calibrated ) {
					...
					GlobalFuncs.to_chat( b, "<span class='notice'><b>Recalibration successful!</b>: </span>This gate's systems have been fine tuned.  Travel to this gate will now be on target." );
		...
		public override bool Bumped( Ent_Static AM = null, dynamic yes = null ) {
			...
			if ( AM is Mob_Living_Carbon ) {
				...
				foreach (dynamic _a in Lang13.Enumerate( AM, typeof(Obj_Item_Weapon_Implant_Exile) )) {
					...
					if ( E.imp_in == AM ) {
						GlobalFuncs.to_chat( AM, "ÿ\"The station gate has detected your exile implant and is blocking your entry." );
						return false;
					}
				}
			}
