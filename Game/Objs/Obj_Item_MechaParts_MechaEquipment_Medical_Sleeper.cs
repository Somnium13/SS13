...
namespace Somnium.Game {
	class Obj_Item_MechaParts_MechaEquipment_Medical_Sleeper : Obj_Item_MechaParts_MechaEquipment_Medical {
		...
		public Obj_Item_MechaParts_MechaEquipment_Medical_Sleeper ( dynamic loc = null ) : base( (object)(loc) ) {
