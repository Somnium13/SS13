		...
		public override dynamic Topic( string href = null, ByTable href_list = null, dynamic hsrc = null ) {
			...
			if ( this.pai != null ) {
				...
				if ( Lang13.Bool( href_list["wires"] ) ) {
					wire = String13.ParseNumber( href_list["wires"] );

					if ( Lang13.Bool( this.radio ) ) {
						((Wires)this.radio.wires).cut( wire );
					}
				}
		...
		public override dynamic attack_self( dynamic user = null, dynamic flag = null, bool? emp = null ) {
			...
			if ( this.pai != null ) {
				...
				if ( Lang13.Bool( this.radio ) ) {
					...
					dat += new Txt( "Transmit: <A href='byond://?src=" ).Ref( this ).str( ";wires=" ).item( "transmit" ).str( "'>" ).item( ( ((Wires)this.radio.wires).is_cut( "transmit" ) ? "Disabled" : "Enabled" ) ).str( "</A><br>" ).ToString();
					dat += new Txt( "Receive: <A href='byond://?src=" ).Ref( this ).str( ";wires=" ).item( "recieve" ).str( "'>" ).item( ( ((Wires)this.radio.wires).is_cut( "recieve" ) ? "Disabled" : "Enabled" ) ).str( "</A><br>" ).ToString();
				} else {
					dat += "<b>Radio Uplink</b><br>";
