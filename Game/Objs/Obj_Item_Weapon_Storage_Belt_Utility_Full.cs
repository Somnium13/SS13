...
namespace Somnium.Game {
	class Obj_Item_Weapon_Storage_Belt_Utility_Full : Obj_Item_Weapon_Storage_Belt_Utility {

		// Function from file: belt.dm
		public Obj_Item_Weapon_Storage_Belt_Utility_Full ( dynamic loc = null ) : base( (object)(loc) ) {
