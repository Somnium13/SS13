...
namespace Somnium.Game {
	class Obj_Item_Weapon_Twohanded_Required_Gibtonite : Obj_Item_Weapon_Twohanded_Required {
		...
		public override dynamic attackby( dynamic A = null, dynamic user = null, string _params = null, bool? silent = null, bool? replace_spent = null ) {
			...
			if ( !Lang13.Bool( this.wires ) && A is Obj_Item_Device_Assembly_Igniter ) {
			...
			if ( Lang13.Bool( this.wires ) && !this.primed ) {
				
				if ( Lang13.Bool( GlobalFuncs.is_wire_tool( A ) ) ) {
