...
namespace Somnium.Game {
	class Obj_Item_Weapon_Grenade_ChemGrenade_Metalfoam : Obj_Item_Weapon_Grenade_ChemGrenade {
		...
		public Obj_Item_Weapon_Grenade_ChemGrenade_Metalfoam ( dynamic loc = null ) : base( (object)(loc) ) {
			...
			((Reagents)B1.reagents).add_reagent( "aluminum", 30 );
			((Reagents)B2.reagents).add_reagent( "foaming_agent", 10 );
			((Reagents)B2.reagents).add_reagent( "pacid", 10 );
