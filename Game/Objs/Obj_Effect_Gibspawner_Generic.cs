...
namespace Somnium.Game {
	class Obj_Effect_Gibspawner_Generic : Obj_Effect_Gibspawner {
		...
		public Obj_Effect_Gibspawner_Generic ( dynamic location = null, ByTable viruses = null, Dna MobDNA = null, string fleshcolor = null, string bloodcolor = null ) : base( (object)(location), viruses, MobDNA, fleshcolor, bloodcolor ) {
