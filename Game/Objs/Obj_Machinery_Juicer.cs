	...
	class Obj_Machinery_Juicer : Obj_Machinery {
		...
		public void juice(  ) {
			...
			foreach (dynamic _a in Lang13.Enumerate( this.contents, typeof(Obj_Item_Weapon_ReagentContainers_Food_Snacks) )) {
				...
				((Reagents)this.beaker.reagents).add_reagent( r_id, this.get_juice_amount( O ) );
				GlobalFuncs.qdel( O );
				O = null;
		...
		public override dynamic interact( dynamic user = null, bool? flag1 = null ) {
			...
			if ( !Lang13.Bool( this.beaker ) ) {
				...
				beaker_contents = new Txt().The( this ).item().str( "  has attached a beaker and beaker is full!" ).ToString();
			}
		...
		public override dynamic attackby( dynamic a = null, dynamic b = null, dynamic c = null ) {
			...
			if ( !GlobalFuncs.is_type_in_list( a, GlobalVars.allowed_items ) ) {
				GlobalFuncs.to_chat( b, "It looks as not containing any juice." );
				return 1;
			}
