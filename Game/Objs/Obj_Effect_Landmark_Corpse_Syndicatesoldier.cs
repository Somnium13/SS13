...
namespace Somnium.Game {
	class Obj_Effect_Landmark_Corpse_Syndicatesoldier : Obj_Effect_Landmark_Corpse {
		...
		public Obj_Effect_Landmark_Corpse_Syndicatesoldier ( dynamic loc = null ) : base( (object)(loc) ) {
