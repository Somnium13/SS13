...
namespace Somnium.Game {
	class Obj_Machinery_Atmospherics_Pipe_Manifold : Obj_Machinery_Atmospherics_Pipe {
		...
		public dynamic manifold_centre = null;

		protected override void __FieldInit() {
			base.__FieldInit();

			this.color = "#B4B4B4";
			this.baseicon = "manifold";
			this.volume = 105;
		...
		public Obj_Machinery_Atmospherics_Pipe_Manifold ( dynamic loc = null ) : base( (object)(loc) ) {
			...
			this.centre_overlay = GlobalVars.manifold_centre;
		...
		public override bool initialize( bool? suppress_icon_check = null ) {
			...
			double? connect_directions = null;
			Ent_Static T = null;

			connect_directions = ~this.dir & 15;
			this.findAllConnections( connect_directions );
			T = this.loc;
		...
		public override ByTable pipeline_expansion(  ) {
			return new ByTable(new object [] { this.node1, this.node2, this.node3 });
		}
