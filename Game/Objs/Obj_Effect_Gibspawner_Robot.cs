	...
	class Obj_Effect_Gibspawner_Robot : Obj_Effect_Gibspawner {
		...
		protected override void __FieldInit() {
			...
			this.gibtypes = new ByTable(new object [] { 
				typeof(Obj_Effect_Decal_Cleanable_Blood_Gibs_Robot_Up), 
				typeof(Obj_Effect_Decal_Cleanable_Blood_Gibs_Robot_Down), 
				typeof(Obj_Effect_Decal_Cleanable_Blood_Gibs_Robot), 
				typeof(Obj_Effect_Decal_Cleanable_Blood_Gibs_Robot), 
				typeof(Obj_Effect_Decal_Cleanable_Blood_Gibs_Robot), 
				typeof(Obj_Effect_Decal_Cleanable_Blood_Gibs_Robot_Limb)
			 });
			this.gibamounts = new ByTable(new object [] { 1, 1, 1, 1, 1, 1 });
		}

		// Function from file: gibspawner.dm
		public Obj_Effect_Gibspawner_Robot ( dynamic location = null, ByTable viruses = null, Dna MobDNA = null, string fleshcolor = null, string bloodcolor = null ) : base( (object)(location), viruses, MobDNA, fleshcolor, bloodcolor ) {
