...
namespace Somnium.Game {
	class Obj_Structure_Reflector : Obj_Structure {
		...
		public Type framebuildstacktype = typeof(Obj_Item_Stack_Sheet_Metal);
		public int framebuildstackamount = 5;
		public Type buildstacktype = typeof(Obj_Item_Stack_Sheet_Metal);
		public int buildstackamount = 0;
		...
		// Function from file: reflector.dm
		public virtual bool get_reflection( int srcdir = 0, dynamic pdir = null ) {
			return false;
		}
		...
		public override dynamic attackby( dynamic A = null, dynamic user = null, string _params = null, bool? silent = null, bool? replace_spent = null ) {
			...
			if ( A is Obj_Item_Weapon_Wrench ) {
				...
				if ( GlobalFuncs.do_after( user, 80 / A.toolspeed, null, this ) ) {
					...
					Lang13.Call( this.framebuildstacktype, this.loc, this.framebuildstackamount );
		...
		public override dynamic bullet_act( dynamic P = null, dynamic def_zone = null ) {
			...
			new_dir = this.get_reflection( this.dir, P.dir ) ?1:0;
