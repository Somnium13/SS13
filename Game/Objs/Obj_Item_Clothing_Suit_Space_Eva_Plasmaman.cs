...
namespace Somnium.Game {
	class Obj_Item_Clothing_Suit_Space_Eva_Plasmaman : Obj_Item_Clothing_Suit_Space_Eva {
		...
		public Obj_Item_Clothing_Suit_Space_Eva_Plasmaman ( dynamic loc = null ) : base( (object)(loc) ) {
