...
namespace Somnium.Game {
	class Mob_Living_SimpleAnimal_Bot_Secbot : Mob_Living_SimpleAnimal_Bot {
		...
		protected override void __FieldInit() {
			...
			this.pass_flags = 16;
			this.radio_key = typeof(Obj_Item_Device_Encryptionkey_Secbot);
		...
		public override bool hitby( Ent_Dynamic AM = null, bool? skipcatch = null, bool? hitpush = null, bool? blocked = null ) {
			...
			if ( AM is Obj_Item ) {
				...
				if ( Convert.ToDouble( ((dynamic)I).throwforce ) < Convert.ToDouble( this.health ) && Lang13.Bool( ((dynamic)I).thrownby ) && ((dynamic)I).thrownby is Mob_Living_Carbon_Human ) {
					H = ((dynamic)I).thrownby;
					this.retaliate( H );
				}
			}
