...
namespace Somnium.Game {
	class Mob_Living_SimpleAnimal_Parrot : Mob_Living_SimpleAnimal {
		...
		public int speech_shuffle_rate = 20;
		...
		public override void handle_automated_speech( bool? _override = null ) {
			base.handle_automated_speech( _override );

			if ( this.speech_buffer.len != 0 && Rand13.PercentChance( this.speech_shuffle_rate ) ) {
		...
		public override dynamic attackby( dynamic A = null, dynamic user = null, string _params = null, bool? silent = null, bool? replace_spent = null ) {
			...
			if ( !( this.stat != 0 ) && !( this.client != null ) && !( A is Obj_Item_Stack_Medical ) && !( A is Obj_Item_Weapon_ReagentContainers_Food_Snacks_Cracker ) ) {
				...
				this.speak_chance *= 1.61;
				this.speech_shuffle_rate += 10;
		...
		public override dynamic attack_hand( dynamic a = null, bool? b = null, bool? c = null ) {
			...
			if ( !( this.stat != 0 ) && a.a_intent == "help" ) {
				this.handle_automated_speech( true );
			}
			return null;
		}
		...
		public override double examine( dynamic user = null ) {
			...
			if ( this.stat != 0 ) {
				user.WriteMsg( Rand13.Pick(new object [] { "This parrot is no more", "This is a late parrot", "This is an ex-parrot" }) );
			}
			return 0;
		}
