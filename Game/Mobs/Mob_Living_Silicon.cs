...
namespace Somnium.Game {
	class Mob_Living_Silicon : Mob_Living {
		...
		// Function from file: silicon.dm
		public override void AdjustWeakened( int amount = 0, bool? ignore_canweaken = null ) {
		...
		// Function from file: silicon.dm
		public override void SetWeakened( int amount = 0 ) {
		...
		// Function from file: silicon.dm
		public override void Weaken( dynamic amount = null, bool? ignore_canweaken = null ) {
			ignore_canweaken = ignore_canweaken ?? false;
		...
		// Function from file: silicon.dm
		public override void AdjustStunned( int amount = 0 ) {
		...
		// Function from file: silicon.dm
		public override void SetStunned( double amount = 0 ) {
		...
		public override bool flash_eyes( double? intensity = null, bool? override_blindness_check = null, bool? affect_silicon = null, bool? visual = null, Type type = null ) {
			...
			visual = visual ?? false;
			type = type ?? typeof(Obj_Screen_Fullscreen_Flash_Noise);
			...
			if ( base.attack_alien( (object)(user) ) ) {
				...
				if ( Rand13.PercentChance( 90 ) ) {
					...
					if ( Rand13.PercentChance( 8 ) ) {
						this.flash_eyes( null, null, true );
					}
					GlobalFuncs.add_logs( user, this, "attacked" );
					this.adjustBruteLoss( damage );
					this.updatehealth();
