...
namespace Somnium.Game {
	class Mob_Living_SimpleAnimal_Hostile_Guardian_Ranged : Mob_Living_SimpleAnimal_Hostile_Guardian {
		...
		protected override void __FieldInit() {
			...
			this.damage_coeff = new ByTable().Set( "brute", 081 ).Set( "fire", 081 ).Set( "tox", 081 ).Set( "clone", 081 ).Set( "stamina", 0 ).Set( "oxy", 081 );
		...
		public override void ToggleLight(  ) {
			...
			if ( this.see_invisible == 5 ) {
				this.WriteMsg( "<span class='notice'>You deactivate your night vision.</span>" );
				this.see_invisible = 25;
			} else {
				this.WriteMsg( "<span class='notice'>You activate your night vision.</span>" );
				this.see_invisible = 5;
			}
			return;
		}
