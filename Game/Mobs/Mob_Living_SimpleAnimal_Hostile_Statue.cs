...
namespace Somnium.Game {
	class Mob_Living_SimpleAnimal_Hostile_Statue : Mob_Living_SimpleAnimal_Hostile {
		...
		public override bool restrained(  ) {
			...
			if ( this.can_be_seen( this.loc ) != null ) {
				return true;
			}
			return _default;
		}
		...
		// Function from file: statue.dm
		public override void face_atom( Ent_Static A = null ) {
			
			if ( !( this.can_be_seen( GlobalFuncs.get_turf( this.loc ) ) != null ) ) {
				base.face_atom( A );
			}
			return;
		}
		...
		public override bool Move( dynamic NewLoc = null, int? Dir = null, int step_x = 0, int step_y = 0 ) {
			...
			if ( this.can_be_seen( NewLoc ) != null ) {
