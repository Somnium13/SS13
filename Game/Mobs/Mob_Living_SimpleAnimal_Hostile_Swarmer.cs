...
namespace Somnium.Game {
	class Mob_Living_SimpleAnimal_Hostile_Swarmer : Mob_Living_SimpleAnimal_Hostile {
		...
		public void DisIntegrate( Ent_Static target = null ) {
			GlobalFuncs.PoolOrNew( typeof(Obj_Effect_Overlay_Temp_Swarmer_Disintegration), GlobalFuncs.get_turf( target ) );
			this.do_attack_animation( target );
		...
		public void Integrate( Obj_Item target = null ) {
			...
			if ( Lang13.Bool( target.materials["$metal"] ) || Lang13.Bool( target.materials["$glass"] ) ) {
				...
				this.do_attack_animation( target );
				this.changeNext_move( 8 );
				I = GlobalFuncs.PoolOrNew( typeof(Obj_Effect_Overlay_Temp_Swarmer_Integrate), GlobalFuncs.get_turf( target ) );
		...
		public override void create_mob_hud(  ) {
			...
			if ( this.client != null && !( this.hud_used != null ) ) {
				this.hud_used = new Hud_Swarmer( this );
			}
			return;
		}
