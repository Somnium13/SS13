...
namespace Game13 {
	static class GlobalVars {
		...
		public const dynamic _preloader = null;
		public const dynamic _void = null;
		public const int AALARM_WIRE_IDSCAN = 1;
		public const int abandon_allowed = 1;
		...
		public const ByTable active_turfs_startlist = new ByTable();
		public const void adjectives = GlobalFuncs.file2list( "config/names/adjectives.txt" );
		public const ByTable admin_datums = new ByTable();
		public const ByTable admin_log = new ByTable();
		public const string admin_notice = "";
		public static ByTable admin_ranks = new ByTable();
		public const dynamic admin_sound = null;
		public const ByTable admin_verbs_admin = new ByTable(new object [] {typeof( Client ).GetMethod( "/client/proc/player_panel_new" ),typeof( Client ).GetMethod( "/client/proc/invisimin" ),typeof( Admins ).GetMethod( "/datum/admins/proc/show_player_panel" ),typeof( Client ).GetMethod( "/client/proc/game_panel" ),typeof( Client ).GetMethod( "/client/proc/check_ai_laws" ),typeof( Admins ).GetMethod( "/datum/admins/proc/toggleooc" ),typeof( Admins ).GetMethod( "/datum/admins/proc/toggleoocdead" ),typeof( Admins ).GetMethod( "/datum/admins/proc/toggleenter" ),typeof( Admins ).GetMethod( "/datum/admins/proc/toggleguests" ),typeof( Admins ).GetMethod( "/datum/admins/proc/announce" ),typeof( Admins ).GetMethod( "/datum/admins/proc/set_admin_notice" ),typeof( Client ).GetMethod( "/client/proc/admin_ghost" ),typeof( Client ).GetMethod( "/client/proc/toggle_view_range" ),typeof( Admins ).GetMethod( "/datum/admins/proc/view_txt_log" ),typeof( Admins ).GetMethod( "/datum/admins/proc/view_atk_log" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_subtle_message" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_delete" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_check_contents" ),typeof( Client ).GetMethod( "/client/proc/check_antagonists" ),typeof( Admins ).GetMethod( "/datum/admins/proc/access_news_network" ),typeof( Client ).GetMethod( "/client/proc/giveruntimelog" ),typeof( Client ).GetMethod( "/client/proc/getruntimelog" ),typeof( Client ).GetMethod( "/client/proc/getserverlog" ),typeof( Client ).GetMethod( "/client/proc/jumptocoord" ),typeof( Client ).GetMethod( "/client/proc/Getmob" ),typeof( Client ).GetMethod( "/client/proc/Getkey" ),typeof( Client ).GetMethod( "/client/proc/jumptoarea" ),typeof( Client ).GetMethod( "/client/proc/jumptokey" ),typeof( Client ).GetMethod( "/client/proc/jumptomob" ),typeof( Client ).GetMethod( "/client/proc/jumptoturf" ),typeof( Client ).GetMethod( "/client/proc/admin_call_shuttle" ),typeof( Client ).GetMethod( "/client/proc/admin_cancel_shuttle" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_direct_narrate" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_world_narrate" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_local_narrate" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_create_centcom_report" ),typeof( Client ).GetMethod( "/client/proc/toggle_antag_hud" )});
		public const ByTable admin_verbs_ban = new ByTable(new object [] {typeof( Client ).GetMethod( "/client/proc/unban_panel" ),typeof( Client ).GetMethod( "/client/proc/jobbans" ),typeof( Client ).GetMethod( "/client/proc/unjobban_panel" ),typeof( Client ).GetMethod( "/client/proc/DB_ban_panel" ),typeof( Client ).GetMethod( "/client/proc/stickybanpanel" )});
		public const ByTable admin_verbs_debug = new ByTable(new object [] {typeof( Client ).GetMethod( "/client/proc/restart_controller" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_list_open_jobs" ),typeof( Client ).GetMethod( "/client/proc/Debug2" ),typeof( Client ).GetMethod( "/client/proc/cmd_debug_make_powernets" ),typeof( Client ).GetMethod( "/client/proc/debug_controller" ),typeof( Client ).GetMethod( "/client/proc/cmd_debug_mob_lists" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_delete" ),typeof( Client ).GetMethod( "/client/proc/cmd_debug_del_all" ),typeof( Client ).GetMethod( "/client/proc/restart_controller" ),typeof( Client ).GetMethod( "/client/proc/enable_debug_verbs" ),typeof( Client ).GetMethod( "/client/proc/callproc" ),typeof( Client ).GetMethod( "/client/proc/callproc_datum" ),typeof( Client ).GetMethod( "/client/proc/SDQL2_query" ),typeof( Client ).GetMethod( "/client/proc/test_movable_UI" ),typeof( Client ).GetMethod( "/client/proc/test_snap_UI" ),typeof( Client ).GetMethod( "/client/proc/debugNatureMapGenerator" ),typeof( Client ).GetMethod( "/client/proc/check_bomb_impacts" ),typeof( GlobalFuncs ).GetMethod( "/proc/machine_upgrade" ),typeof( Client ).GetMethod( "/client/proc/populate_world" ),typeof( Client ).GetMethod( "/client/proc/cmd_display_del_log" ),typeof( Client ).GetMethod( "/client/proc/reset_latejoin_spawns" ),typeof( Client ).GetMethod( "/client/proc/create_outfits" ),typeof( Client ).GetMethod( "/client/proc/debug_huds" )});
		public const ByTable admin_verbs_default = new ByTable(new object [] {typeof( Client ).GetMethod( "/client/proc/toggleadminhelpsound" ),typeof( Client ).GetMethod( "/client/proc/toggleannouncelogin" ),typeof( Client ).GetMethod( "/client/proc/deadmin_self" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_say" ),typeof( Client ).GetMethod( "/client/proc/hide_verbs" ),typeof( Client ).GetMethod( "/client/proc/hide_most_verbs" ),typeof( Client ).GetMethod( "/client/proc/debug_variables" ),typeof( Client ).GetMethod( "/client/proc/admin_memo" ),typeof( Client ).GetMethod( "/client/proc/deadchat" ),typeof( Client ).GetMethod( "/client/proc/dsay" ),typeof( Client ).GetMethod( "/client/proc/toggleprayers" ),typeof( Client ).GetMethod( "/client/verb/toggleprayersounds" ),typeof( Client ).GetMethod( "/client/proc/toggle_hear_radio" ),typeof( Client ).GetMethod( "/client/proc/investigate_show" ),typeof( Client ).GetMethod( "/client/proc/secrets" ),typeof( Client ).GetMethod( "/client/proc/reload_admins" ),typeof( Client ).GetMethod( "/client/proc/reestablish_db_connection" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_pm_context" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_pm_panel" ),typeof( Client ).GetMethod( "/client/proc/stop_sounds" )});
		public const ByTable admin_verbs_fun = new ByTable(new object [] {typeof( Client ).GetMethod( "/client/proc/cmd_admin_dress" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_gib_self" ),typeof( Client ).GetMethod( "/client/proc/drop_bomb" ),typeof( Client ).GetMethod( "/client/proc/cinematic" ),typeof( Client ).GetMethod( "/client/proc/one_click_antag" ),typeof( Client ).GetMethod( "/client/proc/send_space_ninja" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_add_freeform_ai_law" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_add_random_ai_law" ),typeof( Client ).GetMethod( "/client/proc/object_say" ),typeof( Client ).GetMethod( "/client/proc/toggle_random_events" ),typeof( Client ).GetMethod( "/client/proc/set_ooc" ),typeof( Client ).GetMethod( "/client/proc/reset_ooc" ),typeof( Client ).GetMethod( "/client/proc/forceEvent" ),typeof( Client ).GetMethod( "/client/proc/bluespace_artillery" ),typeof( Client ).GetMethod( "/client/proc/admin_change_sec_level" ),typeof( Client ).GetMethod( "/client/proc/toggle_nuke" )});
		public const ByTable admin_verbs_hideable = new ByTable(new object [] {typeof( Client ).GetMethod( "/client/proc/set_ooc" ),typeof( Client ).GetMethod( "/client/proc/reset_ooc" ),typeof( Client ).GetMethod( "/client/proc/deadmin_self" ),typeof( Client ).GetMethod( "/client/proc/deadchat" ),typeof( Client ).GetMethod( "/client/proc/toggleprayers" ),typeof( Client ).GetMethod( "/client/proc/toggle_hear_radio" ),typeof( Admins ).GetMethod( "/datum/admins/proc/show_traitor_panel" ),typeof( Admins ).GetMethod( "/datum/admins/proc/toggleenter" ),typeof( Admins ).GetMethod( "/datum/admins/proc/toggleguests" ),typeof( Admins ).GetMethod( "/datum/admins/proc/announce" ),typeof( Admins ).GetMethod( "/datum/admins/proc/set_admin_notice" ),typeof( Client ).GetMethod( "/client/proc/admin_ghost" ),typeof( Client ).GetMethod( "/client/proc/toggle_view_range" ),typeof( Admins ).GetMethod( "/datum/admins/proc/view_txt_log" ),typeof( Admins ).GetMethod( "/datum/admins/proc/view_atk_log" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_subtle_message" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_check_contents" ),typeof( Admins ).GetMethod( "/datum/admins/proc/access_news_network" ),typeof( Client ).GetMethod( "/client/proc/admin_call_shuttle" ),typeof( Client ).GetMethod( "/client/proc/admin_cancel_shuttle" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_direct_narrate" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_world_narrate" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_local_narrate" ),typeof( Client ).GetMethod( "/client/proc/play_local_sound" ),typeof( Client ).GetMethod( "/client/proc/play_sound" ),typeof( Client ).GetMethod( "/client/proc/set_round_end_sound" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_dress" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_gib_self" ),typeof( Client ).GetMethod( "/client/proc/drop_bomb" ),typeof( Client ).GetMethod( "/client/proc/cinematic" ),typeof( Client ).GetMethod( "/client/proc/send_space_ninja" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_add_freeform_ai_law" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_add_random_ai_law" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_create_centcom_report" ),typeof( Client ).GetMethod( "/client/proc/object_say" ),typeof( Client ).GetMethod( "/client/proc/toggle_random_events" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_add_random_ai_law" ),typeof( Admins ).GetMethod( "/datum/admins/proc/startnow" ),typeof( Admins ).GetMethod( "/datum/admins/proc/restart" ),typeof( Admins ).GetMethod( "/datum/admins/proc/delay" ),typeof( Admins ).GetMethod( "/datum/admins/proc/toggleaban" ),typeof( Client ).GetMethod( "/client/proc/toggle_log_hrefs" ),typeof( Client ).GetMethod( "/client/proc/everyone_random" ),typeof( Admins ).GetMethod( "/datum/admins/proc/toggleAI" ),typeof( Client ).GetMethod( "/client/proc/restart_controller" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_list_open_jobs" ),typeof( Client ).GetMethod( "/client/proc/callproc" ),typeof( Client ).GetMethod( "/client/proc/callproc_datum" ),typeof( Client ).GetMethod( "/client/proc/Debug2" ),typeof( Client ).GetMethod( "/client/proc/reload_admins" ),typeof( Client ).GetMethod( "/client/proc/cmd_debug_make_powernets" ),typeof( Client ).GetMethod( "/client/proc/debug_controller" ),typeof( Client ).GetMethod( "/client/proc/startSinglo" ),typeof( Client ).GetMethod( "/client/proc/cmd_debug_mob_lists" ),typeof( Client ).GetMethod( "/client/proc/cmd_debug_del_all" ),typeof( Client ).GetMethod( "/client/proc/enable_debug_verbs" ),typeof( GlobalFuncs ).GetMethod( "/proc/possess" ),typeof( GlobalFuncs ).GetMethod( "/proc/release" ),typeof( Client ).GetMethod( "/client/proc/reload_admins" ),typeof( Client ).GetMethod( "/client/proc/panicbunker" ),typeof( Client ).GetMethod( "/client/proc/admin_change_sec_level" ),typeof( Client ).GetMethod( "/client/proc/toggle_nuke" ),typeof( Client ).GetMethod( "/client/proc/cmd_display_del_log" ),typeof( Client ).GetMethod( "/client/proc/toggle_antag_hud" ),typeof( Client ).GetMethod( "/client/proc/debug_huds" )});
		public const ByTable admin_verbs_permissions = new ByTable(new object [] {typeof( Client ).GetMethod( "/client/proc/edit_admin_permissions" ),typeof( Client ).GetMethod( "/client/proc/create_poll" )});
		public const ByTable admin_verbs_possess = new ByTable(new object [] {typeof( GlobalFuncs ).GetMethod( "/proc/possess" ),typeof( GlobalFuncs ).GetMethod( "/proc/release" )});
		public const ByTable admin_verbs_rejuv = new ByTable(new object [] {typeof( Client ).GetMethod( "/client/proc/respawn_character" )});
		public const ByTable admin_verbs_server = new ByTable(new object [] {typeof( Admins ).GetMethod( "/datum/admins/proc/startnow" ),typeof( Admins ).GetMethod( "/datum/admins/proc/restart" ),typeof( Admins ).GetMethod( "/datum/admins/proc/end_round" ),typeof( Admins ).GetMethod( "/datum/admins/proc/delay" ),typeof( Admins ).GetMethod( "/datum/admins/proc/toggleaban" ),typeof( Client ).GetMethod( "/client/proc/toggle_log_hrefs" ),typeof( Client ).GetMethod( "/client/proc/everyone_random" ),typeof( Admins ).GetMethod( "/datum/admins/proc/toggleAI" ),typeof( Client ).GetMethod( "/client/proc/cmd_admin_delete" ),typeof( Client ).GetMethod( "/client/proc/cmd_debug_del_all" ),typeof( Client ).GetMethod( "/client/proc/toggle_random_events" ),typeof( Client ).GetMethod( "/client/proc/panicbunker" )});
		public const ByTable admin_verbs_sounds = new ByTable(new object [] {typeof( Client ).GetMethod( "/client/proc/play_local_sound" ),typeof( Client ).GetMethod( "/client/proc/play_sound" ),typeof( Client ).GetMethod( "/client/proc/set_round_end_sound" )});
		public const ByTable admin_verbs_spawn = new ByTable(new object [] {typeof( Admins ).GetMethod( "/datum/admins/proc/spawn_atom" ),typeof( Client ).GetMethod( "/client/proc/respawn_character" )});
		public const ByTable adminlog = new ByTable();
		public const ByTable admins = new ByTable();
		...
		public const ByTable ai_list = new ByTable();
		public const void ai_names = GlobalFuncs.file2list( "config/names/ai.txt" );
		...
		public const ByTable airlocks = new ByTable();
		...
		public const ByTable allCasters = new ByTable();
		public const ByTable allConsoles = new ByTable();
		...
		public const ByTable announcement_systems = new ByTable();
		public const int announcing_vox = 0;
		public const int APC_WIRE_AI_CONTROL = 8;
		public const int APC_WIRE_MAIN_POWER1 = 2;
		public const int APC_WIRE_MAIN_POWER2 = 4;
		public const ByTable apcs_list = new ByTable();
		...
		public const ByTable bad_mutations = new ByTable();
		...
		public const dynamic blackbox = null;
		...
		public const ByTable blob_cores = new ByTable();
		public const ByTable blob_nodes = new ByTable();
		public const ByTable blobs = new ByTable();
		public const ByTable blobstart = new ByTable();
		...
		public const dynamic bomb_set = null;
		public const ByTable bombers = new ByTable();
		...
		public const ByTable BUMP_TELEPORTERS = new ByTable();
		public const ByTable cable_coil_recipes = new ByTable(new object [] {new StackRecipe( "cable restraints", Ent_Item_Weapon_Restraints_Handcuffs_Cable, 15 )});
		public const ByTable cable_list = new ByTable();
		...
		public const ByTable chemical_mob_spawn_meancritters = new ByTable();
		public const ByTable chemical_mob_spawn_nicecritters = new ByTable();
		public const dynamic chemical_reactions_list = null;
		public const dynamic chemical_reagents_list = null;
		public const int chicken_count = 0;
		...
		public const ByTable clients = new ByTable();
		public const int CLOSE_DURATION = 6;
		public const int CLOSED = 2;
		public const void clown_names = GlobalFuncs.file2list( "config/names/clown.txt" );
		public const ByTable clown_recipes = new ByTable(new object [] {new StackRecipe( "bananium tile", Ent_Item_Stack_Tile_Mineral_Bananium, 1, 4, 20 ),StackRecipe.lcall( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, Ent_Structure_Statue_Bananium_Clown ).set( 1, "Clown Statue" ) )});
		...
		public const void commando_names = GlobalFuncs.file2list( "config/names/death_commando.txt" );
		public const ByTable common_tools = new ByTable(new object [] {Ent_Item_Stack_CableCoil,Ent_Item_Weapon_Wrench,Ent_Item_Weapon_Weldingtool,Ent_Item_Weapon_Screwdriver,Ent_Item_Weapon_Wirecutters,Ent_Item_Device_Multitool,Ent_Item_Weapon_Crowbar});
		public const int comms_allowed = 0;
		public const string comms_key = "default_pwd";
		...
		public const ByTable corgi_recipes = new ByTable(new object [] {StackRecipe.lcall( new ByTable().set( "on_floor", 1 ).set( 3, 3 ).set( 2, Ent_Item_Clothing_Suit_Hooded_IanCostume ).set( 1, "corgi costume" ) )});
		public const dynamic create_mob_html = null;
		public const ByTable create_object_forms = new ByTable(new object [] {Entity,Ent_Structure,Ent_Machinery,Ent_Effect,Ent_Item,Ent_Item_Clothing,Ent_Item_Stack,Ent_Item_Device,Ent_Item_Weapon,Ent_Item_Weapon_ReagentContainers,Ent_Item_Weapon_Gun});
		public const dynamic create_object_html = null;
		public const dynamic create_turf_html = null;
		public const UNKNOWN crematoriums = new ByTable();
		...
		public const ByTable dead_mob_list = new ByTable();
		public const ByTable deadmins = new ByTable();
		public const ByTable deathsquadspawn = new ByTable();
		public const int Debug = 0;
		public const int Debug2 = 0;
		public const Chatroom default_ntrc_chatroom = new Chatroom();
		public const ByTable defaults = new ByTable(new object [] {"No","Yes"});
		public const ByTable deliverybeacons = new ByTable();
		public const ByTable deliverybeacontags = new ByTable();
		...
		public const ByTable department_security_spawns = new ByTable();
		...
		public const ByTable directory = new ByTable();
		public const int DISCONNECTED = 0;
		public const dynamic diseases = Misc13.typesof( Disease ) - Disease;
		...
		public const int dooc_allowed = 1;
		public const ByTable doppler_arrays = new ByTable();
		...
		public const ByTable emergencyresponseteamspawn = new ByTable();
		...
		public const int enter_allowed = 1;
		...
		public const dynamic Failsafe = null;
		public const int FALSE = 0;
		public const string FEMALE = "female";
		public const ByTable female_clothing_icons = new ByTable();
		public const int fileaccess_timer = 0;
		public const dynamic fire_overlay = Image.lcall( new ByTable().set( "icon_state", "fire" ).set( "icon", new ByRsc(292) ) );
		public const void first_names_female = GlobalFuncs.file2list( "config/names/first_female.txt" );
		public const void first_names_male = GlobalFuncs.file2list( "config/names/first_male.txt" );
		public const int FLOAT_LAYER = -1;
		public const int floorIsLava = 0;
		public const int FLY_LAYER = 5;
		public const ByTable forbidden_varedit_object_types = new ByTable(new object [] {Admins,Ent_Machinery_BlackboxRecorder,FeedbackVariable,AdminRank});
		...
		public static UNKNOWN g_fancy_list_of_types = null;
		public const ByTable gang_colors_pool = new ByTable(new object [] {"red","orange","yellow","green","blue","purple"});
		public const ByTable gang_name_pool = new ByTable(new object [] {"Clandestine","Prima","Zero-G","Max","Blasto","Waffle","North","Omni","Newton","Cyber","Donk","Gene","Gib","Tunnel","Diablo","Psyke","Osiron","Sirius","Sleeping Carp"});
		public static dynamic gaussian_next = null;
		public const ByTable ghost_darkness_images = new ByTable();
		...
		public const ByTable hivemind_bank = new ByTable();
		public const ByTable holdingfacility = new ByTable();
		public const int HOLOPAD_MODE = 4;
		public const ByTable horns_list = new ByTable();
		public const dynamic host = null;
		...
		public const int hsboxspawn = 1;
		public const UNKNOWN html_interfaces = new ByTable();
		...
		public const int intercom_range_display_status = 0;
		public const ByTable jobban_keylist = new ByTable( 0 );
		public const dynamic join_motd = null;
		public const ByTable joined_player_list = new ByTable();
		...
		public const ByTable landmarks_list = new ByTable();
		public const void last_names = GlobalFuncs.file2list( "config/names/last.txt" );
		public const ByTable lastsignalers = new ByTable();
		public const ByTable latejoin = new ByTable();
		...
		public const dynamic list_symptoms = Misc13.typesof( Symptom ) - Symptom;
		public const ByTable living_mob_list = new ByTable();
		public const void lizard_names_female = GlobalFuncs.file2list( "config/names/lizard_female.txt" );
		public const void lizard_names_male = GlobalFuncs.file2list( "config/names/lizard_male.txt" );
		public const ByTable machines = new ByTable();
		...
		public const Controller_GameController master_controller = new Controller_GameController();
		public const string master_mode = "traitor";
		public const int MAX_ACTIVE_TIME = 400;
		public const int MAX_CHICKENS = 50;
		public const int MAX_EX_DEVESTATION_RANGE = 3;
		public const int MAX_EX_FLAME_RANGE = 14;
		public const int MAX_EX_FLASH_RANGE = 14;
		public const int MAX_EX_HEAVY_RANGE = 7;
		public const int MAX_EX_LIGHT_RANGE = 14;
		...
		public const ByTable mechas_list = new ByTable();
		...
		public const int message_delay = 0;
		public const ByTable message_servers = new ByTable();
		...
		public const ByTable meteors_catastrophic = new ByTable().set( Ent_Effect_Meteor_Tunguska, 1 ).set( Ent_Effect_Meteor_Irradiated, 10 ).set( Ent_Effect_Meteor_Flaming, 10 ).set( Ent_Effect_Meteor_Big, 75 ).set( Ent_Effect_Meteor_Medium, 5 );
		public const ByTable meteors_normal = new ByTable().set( Ent_Effect_Meteor_Irradiated, 3 ).set( Ent_Effect_Meteor_Flaming, 1 ).set( Ent_Effect_Meteor_Big, 3 ).set( Ent_Effect_Meteor_Medium, 8 ).set( Ent_Effect_Meteor_Dust, 3 );
		public const ByTable meteors_threatening = new ByTable().set( Ent_Effect_Meteor_Irradiated, 3 ).set( Ent_Effect_Meteor_Flaming, 3 ).set( Ent_Effect_Meteor_Big, 8 ).set( Ent_Effect_Meteor_Medium, 4 );
		public const ByTable meteorsB = new ByTable().set( Ent_Effect_Meteor_Meaty_Xeno, 1 ).set( Ent_Effect_Meteor_Meaty, 5 );
		public const ByTable meteorsC = new ByTable(new object [] {Ent_Effect_Meteor_Dust});
		public const ByTable meteorsSPOOKY = new ByTable(new object [] {Ent_Effect_Meteor_Pumpkin});
		public const void mime_names = GlobalFuncs.file2list( "config/names/mime.txt" );
		public const int MIN_ACTIVE_TIME = 200;
		public const int MIN_IMPREGNATION_TIME = 100;
		public const int MOB_LAYER = 4;
		public const ByTable mob_list = new ByTable();
		public const int MOB_PERSPECTIVE = 0;
		public const Moduletypes mods = new Moduletypes();
		public const ByTable modules = new ByTable().set( "/obj/machinery/power/apc", "card_reader,power_control,id_auth,cell_power,cell_charge" );
		public const ByTable monkey_recipes = new ByTable(new object [] {StackRecipe.lcall( new ByTable().set( "on_floor", 1 ).set( 3, 1 ).set( 2, Ent_Item_Clothing_Mask_Gas_Monkeymask ).set( 1, "monkey mask" ) ),StackRecipe.lcall( new ByTable().set( "on_floor", 1 ).set( 3, 2 ).set( 2, Ent_Item_Clothing_Suit_Monkeysuit ).set( 1, "monkey suit" ) )});
		public const ByTable monkeystart = new ByTable();
		public const int mulebot_count = 0;
		public const ByTable multiverse = new ByTable();
		public const ByTable mutations_list = new ByTable();
		public const ByTable navbeacons = new ByTable();
		public const ByTable newplayer_start = new ByTable();
		public const Newscaster_FeedNetwork news_network = new Newscaster_FeedNetwork();
		public const int next_mob_id = 0;
		public const int nextid = 1;
		public const dynamic nextmap = null;
		public const void ninja_names = GlobalFuncs.file2list( "config/names/ninjaname.txt" );
		public const void ninja_titles = GlobalFuncs.file2list( "config/names/ninjatitle.txt" );
		...
		public const dynamic non_revealed_runes = Misc13.typesof( Ent_Effect_Rune ) - Ent_Effect_Rune_Malformed - Ent_Effect_Rune;
		public const ByTable nonhuman_positions = new ByTable(new object [] {"AI","Cyborg","pAI"});
		public const string normal_ooc_colour = "#002eb8";
		public const int NORTH = 1;
		public const int NORTHEAST = 5;
		public const int NORTHWEST = 9;
		public const ByTable not_good_mutations = new ByTable();
		public const ByTable nuke_list = new ByTable();
		public const int num_power_levels = 6;
		public const int OBJ_LAYER = 3;
		public static UNKNOWN ooc_allowed = 1;
		...
		public const ByTable PDAs = new ByTable();
		...
		public const int pipenetwarnings = 10;
		...
		public const dynamic plasmaman_on_fire = Image.lcall( new ByTable().set( "icon_state", "plasmaman" ).set( "icon", new ByRsc(234) ) );
		public const ByTable plasteel_recipes = new ByTable(new object [] {StackRecipe.lcall( new ByTable().set( "one_per_turf", 1 ).set( "time", 50 ).set( 3, 4 ).set( 2, Ent_Structure_AIcore ).set( 1, "AI core" ) )});
		public const ByTable player_list = new ByTable();
		public const string PLURAL = "plural";
		public const ByTable pointers = new ByTable();
		public const ByTable portals = new ByTable();
		public const int posibrain_notif_cooldown = 0;
		public const ByTable possible_changeling_IDs = new ByTable(new object [] {"Alpha","Beta","Gamma","Delta","Epsilon","Zeta","Eta","Theta","Iota","Kappa","Lambda","Mu","Nu","Xi","Omicron","Pi","Rho","Sigma","Tau","Upsilon","Phi","Chi","Psi","Omega"});
		public const ByTable possible_items = new ByTable();
		public const ByTable possible_items_special = new ByTable();
		public const ByTable possible_uplinker_IDs = new ByTable(new object [] {"Alfa","Bravo","Charlie","Delta","Echo","Foxtrot","Zero","Niner"});
		...
		public const ByTable powernets = new ByTable();
		public const ByTable preferences_datums = new ByTable();
		public const ByTable prisonsecuritywarp = new ByTable();
		public const ByTable prisonwarp = new ByTable();
		public const ByTable prisonwarped = new ByTable();
		public const dynamic procqueue = null;
		public const dynamic protected_config = null;
		public const ByTable protected_objects = new ByTable(new object [] {Ent_Structure_Table,Ent_Structure_Cable,Ent_Structure_Window});
		public const ByTable rad_collectors = new ByTable();
		public const string RADIO_AIRLOCK = "6";
		public const string RADIO_ATMOSIA = "4";
		public const string RADIO_CHAT = "3";
		public const dynamic radio_controller = null;
		...
		public const ByTable rcd_list = new ByTable();
		public const ByTable recentmessages = new ByTable();
		public const int record_id_num = 1001;
		public const ByTable req_console_assistance = new ByTable();
		public const ByTable req_console_information = new ByTable();
		public const ByTable req_console_supplies = new ByTable();
		public const Getrev revdata = new Getrev();
		public const dynamic rockTurfEdgeCache = null;
		...
		public const int round_start_time = 0;
		...
		public const int say_disabled = 0;
		public const dynamic sc_safecode1 = "" + Rand.Int( 0, 9 );
		public const dynamic sc_safecode2 = "" + Rand.Int( 0, 9 );
		public const dynamic sc_safecode3 = "" + Rand.Int( 0, 9 );
		public const dynamic sc_safecode4 = "" + Rand.Int( 0, 9 );
		public const dynamic sc_safecode5 = "" + Rand.Int( 0, 9 );
		...
		public const ByTable sec_departments = new ByTable(new object [] {"engineering","supply","medical","science"});
		public const int SEC_FREQ = 1359;
		public const ByTable secequipment = new ByTable();
		public const string secret_force_mode = "secret";
		public const int security_level = 0;
		...
		public const ByTable shuttle_caller_list = new ByTable();
		...
		public const dynamic smesImageCache = null;
		...
		public const dynamic spells = Misc13.typesof( Ent_Effect_ProcHolder_Spell );
		public const ByTable spines_list = new ByTable();
		public const string sqladdress = "localhost";
		public const string sqlfdbkdb = "test";
		public const string sqlfdbklogin = "root";
		public const string sqlfdbkpass = "";
		public const string sqlfdbktableprefix = "erro_";
		public const string sqlport = "3306";
		...
		public const dynamic SSair = null;
		public const dynamic SSbot = null;
		public const dynamic SSbp = null;
		public const dynamic SSdisease = null;
		public const dynamic SSevent = null;
		public const dynamic SSgarbage = null;
		public const dynamic SSjob = null;
		public const dynamic SSlighting = null;
		public const dynamic SSmachine = null;
		public const dynamic SSmob = null;
		public const dynamic SSnano = null;
		public const dynamic SSobj = null;
		public const dynamic SSpai = null;
		public const dynamic SSshuttle = null;
		public const dynamic SSsun = null;
		public const dynamic SStimer = null;
		public const dynamic SSvote = null;
		public const ByTable start_landmarks_list = new ByTable();
		public const dynamic start_state = null;
		...
		public const int status_overlays = 0;
		public const dynamic status_overlays_charging = null;
		public const dynamic status_overlays_environ = null;
		public const dynamic status_overlays_equipment = null;
		public const dynamic status_overlays_lighting = null;
		public const dynamic status_overlays_lock = null;
		public const ByTable stealthminID = new ByTable();
		public const dynamic sting_paths = null;
		public static UNKNOWN string_cache = null;
		...
		public const dynamic syndicate_code_phrase = null;
		public const dynamic syndicate_code_response = null;
		...
		public const ByTable tdome1 = new ByTable();
		public const ByTable tdome2 = new ByTable();
		public const ByTable tdomeadmin = new ByTable();
		public const ByTable tdomeobserve = new ByTable();
		public const ByTable telecomms_list = new ByTable();
		...
		public const dynamic the_gateway = null;
		...
		public const dynamic ticker = null;
		public const int time_last_changed_position = 0;
		public const int timezoneOffset = 0;
		public const int tinted_weldhelh = 1;
		public const int tk_maxrange = 15;
		public const int TOUCH = 1;
		public const ByTable tracked_implants = new ByTable();
		...
		public const ByTable ventcrawl_machinery = new ByTable(new object [] {Ent_Machinery_Atmospherics_Components_Unary_VentPump,Ent_Machinery_Atmospherics_Components_Unary_VentScrubber});
		public const void verbs = GlobalFuncs.file2list( "config/names/verbs.txt" );
		...
		public const ByTable WALLITEMS_EXTERNAL = new ByTable(new object [] {Ent_Machinery_Camera,Ent_Machinery_CameraAssembly,Ent_Machinery_LightConstruct,Ent_Machinery_Light});
		public const ByTable WALLITEMS_INVERSE = new ByTable(new object [] {Ent_Machinery_LightConstruct,Ent_Machinery_Light});
		public const dynamic weedImageCache = null;
		...
		public const void wizard_first = GlobalFuncs.file2list( "config/names/wizardfirst.txt" );
		public const void wizard_second = GlobalFuncs.file2list( "config/names/wizardsecond.txt" );
		public const ByTable wizardstart = new ByTable();
		...
		public const ByTable world_uplinks = new ByTable();
		public const ByTable xeno_recipes = new ByTable(new object [] {StackRecipe.lcall( new ByTable().set( "on_floor", 1 ).set( 3, 1 ).set( 2, Ent_Item_Clothing_Head_Xenos ).set( 1, "alien helmet" ) ),StackRecipe.lcall( new ByTable().set( "on_floor", 1 ).set( 3, 2 ).set( 2, Ent_Item_Clothing_Suit_Xenos ).set( 1, "alien suit" ) )});
		public const ByTable xeno_spawn = new ByTable();
		public const dynamic year = Misc13.conv_time2text( "YYYY", Game.realtime );
		public const dynamic year_integer = Misc13.conv_text2num( GlobalVars.year );
