...
namespace SomGame {
	static class GlobalVars {
		...
		public static readonly NanoState_AdminState admin_state = new NanoState_AdminState();
		...
		public static readonly bool AREA_STATION = false;
		...
		public static readonly ByTable box_rotations = new ByTable()
			.set( "" + GlobalVars.WEST, new ByTable().set( "" + GlobalVars.NORTH, GlobalVars.WEST ).set( "" + GlobalVars.WEST, GlobalVars.WEST ).set( "" + GlobalVars.EAST, GlobalVars.WEST ).set( "" + GlobalVars.SOUTH, GlobalVars.WEST ) )
			.set( "" + GlobalVars.SOUTH, new ByTable().set( "" + GlobalVars.NORTH, GlobalVars.SOUTH ).set( "" + GlobalVars.WEST, GlobalVars.SOUTH ).set( "" + GlobalVars.EAST, GlobalVars.SOUTH ).set( "" + GlobalVars.SOUTH, GlobalVars.SOUTH ) )
			.set( "" + GlobalVars.EAST, new ByTable().set( "" + GlobalVars.NORTH, GlobalVars.EAST ).set( "" + GlobalVars.WEST, GlobalVars.EAST ).set( "" + GlobalVars.EAST, GlobalVars.EAST ).set( "" + GlobalVars.SOUTH, GlobalVars.EAST ) )
			.set( "" + GlobalVars.NORTH, new ByTable().set( "" + GlobalVars.NORTH, GlobalVars.NORTH ).set( "" + GlobalVars.WEST, GlobalVars.NORTH ).set( "" + GlobalVars.EAST, GlobalVars.NORTH ).set( "" + GlobalVars.SOUTH, GlobalVars.NORTH ) )
			
		;
		public static ByTable BUMP_TELEPORTERS = new ByTable();
		public static readonly ByTable cable_coil_recipes = new ByTable(new object [] { new StackRecipe( "cable restraints", typeof(Ent_Item_Weapon_Restraints_Handcuffs_Cable), 15 != 0 ) });
		...
		public static bool chicken_count = false;
		public static readonly int CHUNK_SIZE = 16;
		public static readonly dynamic church_name = null;
		...
		public static readonly ByTable clown_recipes = new ByTable(new object [] { new StackRecipe( "bananium tile", typeof(Ent_Item_Stack_Tile_Mineral_Bananium), true, 4 != 0, 20 != 0 ), new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Statue_Bananium_Clown) ).set( 1, "Clown Statue" ).applyCtor( typeof(StackRecipe) ) });
		...
		public static readonly NanoState_ConsciousState conscious_state = new NanoState_ConsciousState();
		public static readonly NanoState_ContainedState contained_state = new NanoState_ContainedState();
		...
		public static readonly bool days_early = false;
		...
		public static readonly NanoState_DeepInventoryState deep_inventory_state = new NanoState_DeepInventoryState();
		public static readonly NanoState_Default default_state = new NanoState_Default();
		...
		public static readonly ByTable double_rotations = new ByTable()
			.set( "" + GlobalVars.WEST, new ByTable().set( "" + GlobalVars.WEST, GlobalVars.NORTH ).set( "" + GlobalVars.SOUTH, GlobalVars.EAST ).set( "" + GlobalVars.EAST, GlobalVars.SOUTH ).set( "" + GlobalVars.NORTH, GlobalVars.WEST ) )
			.set( "" + GlobalVars.SOUTH, new ByTable().set( "" + GlobalVars.EAST, GlobalVars.NORTH ).set( "" + GlobalVars.SOUTH, GlobalVars.WEST ).set( "" + GlobalVars.WEST, GlobalVars.SOUTH ).set( "" + GlobalVars.NORTH, GlobalVars.EAST ) )
			.set( "" + GlobalVars.EAST, new ByTable().set( "" + GlobalVars.EAST, GlobalVars.NORTH ).set( "" + GlobalVars.SOUTH, GlobalVars.WEST ).set( "" + GlobalVars.WEST, GlobalVars.SOUTH ).set( "" + GlobalVars.NORTH, GlobalVars.EAST ) )
			.set( "" + GlobalVars.NORTH, new ByTable().set( "" + GlobalVars.WEST, GlobalVars.NORTH ).set( "" + GlobalVars.SOUTH, GlobalVars.EAST ).set( "" + GlobalVars.EAST, GlobalVars.SOUTH ).set( "" + GlobalVars.NORTH, GlobalVars.WEST ) )
		...
		public static readonly bool ENGSEC = false;
		...
		public static readonly dynamic fire_overlay = new ByTable().set( "icon_state", "fire" ).set( "icon", "sound/effects/ghost.ogg" ).applyCtor( typeof(Image) );
		...
		public static readonly bool FREQ_LISTENING = false;
		...
		public static readonly NanoState_HandsState hands_state = new NanoState_HandsState();
		...
		public static bool mulebot_count = false;
		...
		public static readonly bool NORTH = false;
		...
		public static readonly NanoState_NotcontainedState notcontained_state = new NanoState_NotcontainedState();
		...
		public static readonly NanoState_Physical physical_state = new NanoState_Physical();
		...
		public static readonly ByTable plasma_recipes = new ByTable(new object [] { new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 10 ).set( 2, typeof(Ent_Structure_MineralDoor_Transparent_Plasma) ).set( 1, "plasma door" ).applyCtor( typeof(StackRecipe) ), new StackRecipe( "plasma tile", typeof(Ent_Item_Stack_Tile_Mineral_Plasma), true, 4 != 0, 20 != 0 ), new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Statue_Plasma_Scientist) ).set( 1, "Scientist Statue" ).applyCtor( typeof(StackRecipe) ) });
		public static readonly dynamic plasmaman_on_fire = new ByTable().set( "icon_state", "plasmaman" ).set( "icon", "icons/stamp_icons/large_stamp-cmo.png" ).applyCtor( typeof(Image) );
		...
		public static readonly dynamic potentialLavaRuins = new ByTable().set( "filename", "config/lavaRuinConfig.txt" ).apply( typeof(GlobalFuncs).GetMethod( "circleview ") );
		public static readonly dynamic potentialRandomZlevels = new ByTable().set( "filename", "config/awaymissionconfig.txt" ).apply( typeof(GlobalFuncs).GetMethod( "circleview ") );
		public static readonly dynamic potentialSpaceRuins = new ByTable().set( "filename", "config/spaceRuinConfig.txt" ).apply( typeof(GlobalFuncs).GetMethod( "circleview ") );
		public static readonly int POWER_DOWN = 2;
		public static readonly bool POWER_IDLE = false;
		public static readonly bool POWER_UP = false;
		...
		public static readonly dynamic religion_name = null;
		...
		public static readonly ByTable rotations = new ByTable()
			.set( "" + GlobalVars.WEST, new ByTable().set( "" + GlobalVars.EAST, GlobalVars.SOUTH ).set( "" + GlobalVars.NORTH, GlobalVars.WEST ) )
			.set( "" + GlobalVars.SOUTH, new ByTable().set( "" + GlobalVars.WEST, GlobalVars.SOUTH ).set( "" + GlobalVars.NORTH, GlobalVars.EAST ) )
			.set( "" + GlobalVars.EAST, new ByTable().set( "" + GlobalVars.WEST, GlobalVars.NORTH ).set( "" + GlobalVars.SOUTH, GlobalVars.EAST ) )
		...
		public static readonly ByTable scarySounds = new ByTable(new object [] { "sound/magic/Mutate.ogg", "sound/effects/genetics.ogg", "icons/obj/improvised.dmi", "sound/effects/bodyfall3.ogg", "sound/effects/bodyfall4.ogg", "sound/weapons/punch1.ogg", "sound/weapons/punch2.ogg", "html/burn-exclamation.png", "html/spell-check.png", "sound/machines/buzz-sigh.ogg", "icons/mob/uniform.dmi", "icons/mob/hands.dmi", "html/88x31.png", "html/create_object.html", "html/changelog.js", "sound/effects/rustle3.ogg", "sound/effects/rustle4.ogg" });
		...
		public static readonly NanoState_SelfState self_state = new NanoState_SelfState();
		...
		public static readonly ByTable snow_recipes = new ByTable(new object [] { new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Tile_Simulated_Wall_Mineral_Snow) ).set( 1, "Snow Wall" ).applyCtor( typeof(StackRecipe) ), new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Statue_Snow_Snowman) ).set( 1, "Snowman" ).applyCtor( typeof(StackRecipe) ), new StackRecipe( "Snowball", typeof(Ent_Item_Toy_Snowball), true ) });
		...
		public static string syndicate_code_phrase = "";
		public static string syndicate_code_response = "";
		...
		public static readonly ByTable vox_sounds = new ByTable().set( "zulu", "html/changelog.html" ).set( "zone", "sound/vox_fem/zulu.ogg" ).set( "zero", "sound/vox_fem/zone.ogg" ).set( "z", "sound/vox_fem/zero.ogg" ).set( "yourself", "sound/vox_fem/z.ogg" ).set( "your", "sound/vox_fem/yourself.ogg" ).set( "you", "sound/vox_fem/your.ogg" ).set( "yes", "sound/vox_fem/you.ogg" ).set( "yellow", "sound/vox_fem/yes.ogg" ).set( "year", "sound/vox_fem/yellow.ogg" ).set( "yards", "sound/vox_fem/year.ogg" ).set( "yankee", "sound/vox_fem/yards.ogg" ).set( "y", "sound/vox_fem/yankee.ogg" ).set( "xenomorphs", "sound/vox_fem/y.ogg" ).set( "xenomorph", "sound/vox_fem/xenomorphs.ogg" ).set( "xenobiology", "sound/vox_fem/xenomorph.ogg" ).set( "xeno", "sound/vox_fem/xenobiology.ogg" ).set( "x", "sound/vox_fem/xeno.ogg" ).set( "woody", "sound/vox_fem/x.ogg" ).set( "wood", "sound/vox_fem/woody.ogg" ).set( "without", "sound/vox_fem/wood.ogg" ).set( "with", "sound/vox_fem/without.ogg" ).set( "will", "sound/vox_fem/with.ogg" ).set( "wilco", "sound/vox_fem/will.ogg" ).set( "white", "sound/vox_fem/wilco.ogg" ).set( "whiskey", "sound/vox_fem/white.ogg" ).set( "west", "sound/vox_fem/whiskey.ogg" ).set( "welcome", "sound/vox_fem/west.ogg" ).set( "weapon", "sound/vox_fem/welcome.ogg" ).set( "we", "sound/vox_fem/weapon.ogg" ).set( "water", "sound/vox_fem/we.ogg" ).set( "waste", "sound/vox_fem/water.ogg" ).set( "warning", "sound/vox_fem/waste.ogg" ).set( "warn", "sound/vox_fem/warning.ogg" ).set( "warm", "sound/vox_fem/warn.ogg" ).set( "wanted", "sound/vox_fem/warm.ogg" ).set( "want", "sound/vox_fem/wanted.ogg" ).set( "wanker", "sound/vox_fem/want.ogg" ).set( "wall", "sound/vox_fem/wanker.ogg" ).set( "walk", "sound/vox_fem/wall.ogg" ).set( "w", "sound/vox_fem/walk.ogg" ).set( "voxtest", "sound/vox_fem/w.ogg" ).set( "vox_login", "sound/vox_fem/voxtest.ogg" ).set( "vox", "sound/vox_fem/vox_login.ogg" ).set( "voltage", "sound/vox_fem/vox.ogg" ).set( "virology", "sound/vox_fem/voltage.ogg" ).set( "violation", "sound/vox_fem/virology.ogg" ).set( "violated", "sound/vox_fem/violation.ogg" ).set( "victor", "sound/vox_fem/violated.ogg" ).set( "ventilation", "sound/vox_fem/victor.ogg" ).set( "vent", "sound/vox_fem/ventilation.ogg" ).set( "vapor", "sound/vox_fem/vent.ogg" ).set( "valid", "sound/vox_fem/vapor.ogg" ).set( "vacate", "sound/vox_fem/valid.ogg" ).set( "v", "sound/vox_fem/vacate.ogg" ).set( "user", "sound/vox_fem/v.ogg" ).set( "used", "sound/vox_fem/user.ogg" ).set( "use", "sound/vox_fem/used.ogg" ).set( "usa", "sound/vox_fem/use.ogg" ).set( "us", "sound/vox_fem/usa.ogg" ).set( "uranium", "sound/vox_fem/us.ogg" ).set( "upper", "sound/vox_fem/uranium.ogg" ).set( "upload", "sound/vox_fem/upper.ogg" ).set( "updating", "sound/vox_fem/upload.ogg" ).set( "updated", "sound/vox_fem/updating.ogg" ).set( "update", "sound/vox_fem/updated.ogg" ).set( "up", "sound/vox_fem/update.ogg" ).set( "until", "sound/vox_fem/up.ogg" ).set( "unlocked", "sound/vox_fem/until.ogg" ).set( "uniform", "sound/vox_fem/unlocked.ogg" ).set( "under", "sound/vox_fem/uniform.ogg" ).set( "unauthorized", "sound/vox_fem/under.ogg" ).set( "u", "sound/vox_fem/unauthorized.ogg" ).set( "two", "sound/vox_fem/u.ogg" ).set( "twenty", "sound/vox_fem/two.ogg" ).set( "twelve", "sound/vox_fem/twenty.ogg" ).set( "turret", "sound/vox_fem/twelve.ogg" ).set( "turn", "sound/vox_fem/turret.ogg" ).set( "tunnel", "sound/vox_fem/turn.ogg" ).set( "truck", "sound/vox_fem/tunnel.ogg" ).set( "transportation", "sound/vox_fem/truck.ogg" ).set( "traitor", "sound/vox_fem/transportation.ogg" ).set( "train", "sound/vox_fem/traitor.ogg" ).set( "track", "sound/vox_fem/train.ogg" ).set( "toxins", "sound/vox_fem/track.ogg" ).set( "towards", "sound/vox_fem/toxins.ogg" ).set( "touch", "sound/vox_fem/towards.ogg" ).set( "topside", "sound/vox_fem/touch.ogg" ).set( "top", "sound/vox_fem/topside.ogg" ).set( "to", "sound/vox_fem/top.ogg" ).set( "time", "sound/vox_fem/to.ogg" ).set( "tide", "sound/vox_fem/time.ogg" ).set( "through", "sound/vox_fem/tide.ogg" ).set( "three", "sound/vox_fem/through.ogg" ).set( "threat", "sound/vox_fem/three.ogg" ).set( "thousand", "sound/vox_fem/threat.ogg" ).set( "those", "sound/vox_fem/thousand.ogg" ).set( "this", "sound/vox_fem/those.ogg" ).set( "thirty", "sound/vox_fem/this.ogg" ).set( "thirteen", "sound/vox_fem/thirty.ogg" ).set( "third", "sound/vox_fem/thirteen.ogg" ).set( "there", "sound/vox_fem/third.ogg" ).set( "then", "sound/vox_fem/there.ogg" ).set( "the", "sound/vox_fem/then.ogg" ).set( "that", "sound/vox_fem/the.ogg" ).set( "test", "sound/vox_fem/that.ogg" ).set( "termination", "sound/vox_fem/test.ogg" ).set( "terminated", "sound/vox_fem/termination.ogg" ).set( "terminal", "sound/vox_fem/terminated.ogg" ).set( "ten", "sound/vox_fem/terminal.ogg" ).set( "temporal", "sound/vox_fem/ten.ogg" ).set( "temperature", "sound/vox_fem/temporal.ogg" ).set( "team", "sound/vox_fem/temperature.ogg" ).set( "target", "sound/vox_fem/team.ogg" ).set( "tank", "sound/vox_fem/target.ogg" ).set( "tango", "sound/vox_fem/tank.ogg" ).set( "talk", "sound/vox_fem/tango.ogg" ).set( "take", "sound/vox_fem/talk.ogg" ).set( "tactical", "sound/vox_fem/take.ogg" ).set( "t", "sound/vox_fem/tactical.ogg" ).set( "systems", "sound/vox_fem/t.ogg" ).set( "system", "sound/vox_fem/systems.ogg" ).set( "syndicate", "sound/vox_fem/system.ogg" ).set( "switch", "sound/vox_fem/syndicate.ogg" ).set( "surrounded", "sound/vox_fem/switch.ogg" ).set( "surround", "sound/vox_fem/surrounded.ogg" ).set( "surrender", "sound/vox_fem/surround.ogg" ).set( "surface", "sound/vox_fem/surrender.ogg" ).set( "supply", "sound/vox_fem/surface.ogg" ).set( "supercooled", "sound/vox_fem/supply.ogg" ).set( "superconducting", "sound/vox_fem/supercooled.ogg" ).set( "suit", "sound/vox_fem/superconducting.ogg" ).set( "suffer", "sound/vox_fem/suit.ogg" ).set( "sudden", "sound/vox_fem/suffer.ogg" ).set( "subsurface", "sound/vox_fem/sudden.ogg" ).set( "sub", "sound/vox_fem/subsurface.ogg" ).set( "stuck", "sound/vox_fem/sub.ogg" ).set( "storage", "sound/vox_fem/stuck.ogg" ).set( "sterilization", "sound/vox_fem/storage.ogg" ).set( "sterile", "sound/vox_fem/sterilization.ogg" ).set( "status", "sound/vox_fem/sterile.ogg" ).set( "station", "sound/vox_fem/status.ogg" ).set( "starboard", "sound/vox_fem/station.ogg" ).set( "stairway", "sound/vox_fem/starboard.ogg" ).set( "ss13", "sound/vox_fem/stairway.ogg" ).set( "square", "sound/vox_fem/ss13.ogg" ).set( "squad", "sound/vox_fem/square.ogg" ).set( "south", "sound/vox_fem/squad.ogg" ).set( "sorry", "sound/vox_fem/south.ogg" ).set( "son", "sound/vox_fem/sorry.ogg" ).set( "something", "sound/vox_fem/son.ogg" ).set( "someone", "sound/vox_fem/something.ogg" ).set( "some", "sound/vox_fem/someone.ogg" ).set( "soldier", "sound/vox_fem/some.ogg" ).set( "solars", "sound/vox_fem/soldier.ogg" ).set( "solar", "sound/vox_fem/solars.ogg" ).set( "slow", "sound/vox_fem/solar.ogg" ).set( "slime", "sound/vox_fem/slow.ogg" ).set( "sixty", "sound/vox_fem/slime.ogg" ).set( "sixteen", "sound/vox_fem/sixty.ogg" ).set( "six", "sound/vox_fem/sixteen.ogg" ).set( "singularity", "sound/vox_fem/six.ogg" ).set( "silo", "sound/vox_fem/singularity.ogg" ).set( "sight", "sound/vox_fem/silo.ogg" ).set( "sierra", "sound/vox_fem/sight.ogg" ).set( "side", "sound/vox_fem/sierra.ogg" ).set( "shuttle", "sound/vox_fem/side.ogg" ).set( "shut", "sound/vox_fem/shuttle.ogg" ).set( "shower", "sound/vox_fem/shut.ogg" ).set( "shoot", "sound/vox_fem/shower.ogg" ).set( "shock", "sound/vox_fem/shoot.ogg" ).set( "shitting", "sound/vox_fem/shock.ogg" ).set( "shits", "sound/vox_fem/shitting.ogg" ).set( "shitlord", "sound/vox_fem/shits.ogg" ).set( "shit", "sound/vox_fem/shitlord.ogg" ).set( "shirt", "sound/vox_fem/shit.ogg" ).set( "shipment", "sound/vox_fem/shirt.ogg" ).set( "shield", "sound/vox_fem/shipment.ogg" ).set( "sewer", "sound/vox_fem/shield.ogg" ).set( "sewage", "sound/vox_fem/sewer.ogg" ).set( "severe", "sound/vox_fem/sewage.ogg" ).set( "seventy", "sound/vox_fem/severe.ogg" ).set( "seventeen", "sound/vox_fem/seventy.ogg" ).set( "seven", "sound/vox_fem/seventeen.ogg" ).set( "service", "sound/vox_fem/seven.ogg" ).set( "sensors", "sound/vox_fem/service.ogg" ).set( "selected", "sound/vox_fem/sensors.ogg" ).set( "select", "sound/vox_fem/selected.ogg" ).set( "security", "sound/vox_fem/select.ogg" ).set( "secured", "sound/vox_fem/security.ogg" ).set( "secure", "sound/vox_fem/secured.ogg" ).set( "sector", "sound/vox_fem/secure.ogg" ).set( "seconds", "sound/vox_fem/sector.ogg" ).set( "secondary", "sound/vox_fem/seconds.ogg" ).set( "second", "sound/vox_fem/secondary.ogg" ).set( "search", "sound/vox_fem/second.ogg" ).set( "screen", "sound/vox_fem/search.ogg" ).set( "scream", "sound/vox_fem/screen.ogg" ).set( "science", "sound/vox_fem/scream.ogg" ).set( "save", "sound/vox_fem/science.ogg" ).set( "satellite", "sound/vox_fem/save.ogg" ).set( "sargeant", "sound/vox_fem/satellite.ogg" ).set( "sarah", "sound/vox_fem/sargeant.ogg" ).set( "safety", "sound/vox_fem/sarah.ogg" ).set( "safe", "sound/vox_fem/safety.ogg" ).set( "s", "sound/vox_fem/safe.ogg" ).set( "run", "sound/vox_fem/s.ogg" ).set( "round", "sound/vox_fem/run.ogg" ).set( "room", "sound/vox_fem/round.ogg" ).set( "romeo", "sound/vox_fem/room.ogg" ).set( "roger", "sound/vox_fem/romeo.ogg" ).set( "rocket", "sound/vox_fem/roger.ogg" ).set( "right", "sound/vox_fem/rocket.ogg" ).set( "rest", "sound/vox_fem/right.ogg" ).set( "resistance", "sound/vox_fem/rest.ogg" ).set( "resevoir", "sound/vox_fem/resistance.ogg" ).set( "research", "sound/vox_fem/resevoir.ogg" ).set( "required", "sound/vox_fem/research.ogg" ).set( "reports", "sound/vox_fem/required.ogg" ).set( "report", "sound/vox_fem/reports.ogg" ).set( "repair", "sound/vox_fem/report.ogg" ).set( "renegade", "sound/vox_fem/repair.ogg" ).set( "removal", "sound/vox_fem/renegade.ogg" ).set( "remaining", "sound/vox_fem/removal.ogg" ).set( "released", "sound/vox_fem/remaining.ogg" ).set( "relay", "sound/vox_fem/released.ogg" ).set( "red", "sound/vox_fem/relay.ogg" ).set( "reactor", "sound/vox_fem/red.ogg" ).set( "reached", "sound/vox_fem/reactor.ogg" ).set( "reach", "sound/vox_fem/reached.ogg" ).set( "rapid", "sound/vox_fem/reach.ogg" ).set( "raiders", "sound/vox_fem/rapid.ogg" ).set( "raider", "sound/vox_fem/raiders.ogg" ).set( "rads", "sound/vox_fem/raider.ogg" ).set( "radioactive", "sound/vox_fem/rads.ogg" ).set( "radiation", "sound/vox_fem/radioactive.ogg" ).set( "r", "sound/vox_fem/radiation.ogg" ).set( "quit", "sound/vox_fem/r.ogg" ).set( "quick", "sound/vox_fem/quit.ogg" ).set( "questioning", "sound/vox_fem/quick.ogg" ).set( "question", "sound/vox_fem/questioning.ogg" ).set( "queen", "sound/vox_fem/question.ogg" ).set( "quebec", "sound/vox_fem/queen.ogg" ).set( "quantum", "sound/vox_fem/quebec.ogg" ).set( "q", "sound/vox_fem/quantum.ogg" ).set( "push", "sound/vox_fem/q.ogg" ).set( "protective", "sound/vox_fem/push.ogg" ).set( "prosecute", "sound/vox_fem/protective.ogg" ).set( "propulsion", "sound/vox_fem/prosecute.ogg" ).set( "proper", "sound/vox_fem/propulsion.ogg" ).set( "progress", "sound/vox_fem/proper.ogg" ).set( "processing", "sound/vox_fem/progress.ogg" ).set( "proceed", "sound/vox_fem/processing.ogg" ).set( "primary", "sound/vox_fem/proceed.ogg" ).set( "press", "sound/vox_fem/primary.ogg" ).set( "presence", "sound/vox_fem/press.ogg" ).set( "power", "sound/vox_fem/presence.ogg" ).set( "portal", "sound/vox_fem/power.ogg" ).set( "port", "sound/vox_fem/portal.ogg" ).set( "point", "sound/vox_fem/port.ogg" ).set( "please", "sound/vox_fem/point.ogg" ).set( "platform", "sound/vox_fem/please.ogg" ).set( "plasma", "sound/vox_fem/platform.ogg" ).set( "plant", "sound/vox_fem/plasma.ogg" ).set( "pipe", "sound/vox_fem/plant.ogg" ).set( "personnel", "sound/vox_fem/pipe.ogg" ).set( "permitted", "sound/vox_fem/personnel.ogg" ).set( "perimeter", "sound/vox_fem/permitted.ogg" ).set( "percent", "sound/vox_fem/perimeter.ogg" ).set( "panel", "sound/vox_fem/percent.ogg" ).set( "pal", "sound/vox_fem/panel.ogg" ).set( "pain", "sound/vox_fem/pal.ogg" ).set( "pacify", "sound/vox_fem/pain.ogg" ).set( "p", "sound/vox_fem/pacify.ogg" ).set( "override", "sound/vox_fem/p.ogg" ).set( "overload", "sound/vox_fem/override.ogg" ).set( "over", "sound/vox_fem/overload.ogg" ).set( "outside", "sound/vox_fem/over.ogg" ).set( "out", "sound/vox_fem/outside.ogg" ).set( "oscar", "sound/vox_fem/out.ogg" ).set( "organic", "sound/vox_fem/oscar.ogg" ).set( "order", "sound/vox_fem/organic.ogg" ).set( "option", "sound/vox_fem/order.ogg" ).set( "operative", "sound/vox_fem/option.ogg" ).set( "operations", "sound/vox_fem/operative.ogg" ).set( "operating", "sound/vox_fem/operations.ogg" ).set( "open", "sound/vox_fem/operating.ogg" ).set( "one", "sound/vox_fem/open.ogg" ).set( "on", "sound/vox_fem/one.ogg" ).set( "ok", "sound/vox_fem/on.ogg" ).set( "officer", "sound/vox_fem/ok.ogg" ).set( "of", "sound/vox_fem/officer.ogg" ).set( "obtain", "sound/vox_fem/of.ogg" ).set( "observation", "sound/vox_fem/obtain.ogg" ).set( "objective", "sound/vox_fem/observation.ogg" ).set( "o", "sound/vox_fem/objective.ogg" ).set( "number", "sound/vox_fem/o.ogg" ).set( "now", "sound/vox_fem/number.ogg" ).set( "november", "sound/vox_fem/now.ogg" ).set( "not", "sound/vox_fem/november.ogg" ).set( "north", "sound/vox_fem/not.ogg" ).set( "nominal", "sound/vox_fem/north.ogg" ).set( "no", "sound/vox_fem/nominal.ogg" ).set( "ninety", "sound/vox_fem/no.ogg" ).set( "nineteen", "sound/vox_fem/ninety.ogg" ).set( "nine", "sound/vox_fem/nineteen.ogg" ).set( "nice", "sound/vox_fem/nine.ogg" ).set( "nearest", "sound/vox_fem/nice.ogg" ).set( "nanotrasen", "sound/vox_fem/nearest.ogg" ).set( "n", "sound/vox_fem/nanotrasen.ogg" ).set( "my", "sound/vox_fem/n.ogg" ).set( "must", "sound/vox_fem/my.ogg" ).set( "move", "sound/vox_fem/must.ogg" ).set( "motorpool", "sound/vox_fem/move.ogg" ).set( "motor", "sound/vox_fem/motorpool.ogg" ).set( "money", "sound/vox_fem/motor.ogg" ).set( "mode", "sound/vox_fem/money.ogg" ).set( "mister", "sound/vox_fem/mode.ogg" ).set( "minutes", "sound/vox_fem/mister.ogg" ).set( "minimum", "sound/vox_fem/minutes.ogg" ).set( "minefield", "sound/vox_fem/minimum.ogg" ).set( "million", "sound/vox_fem/minefield.ogg" ).set( "milli", "sound/vox_fem/million.ogg" ).set( "military", "sound/vox_fem/milli.ogg" ).set( "miles", "sound/vox_fem/military.ogg" ).set( "mike", "sound/vox_fem/miles.ogg" ).set( "middle", "sound/vox_fem/mike.ogg" ).set( "micro", "sound/vox_fem/middle.ogg" ).set( "meter", "sound/vox_fem/micro.ogg" ).set( "message", "sound/vox_fem/meter.ogg" ).set( "mesa", "sound/vox_fem/message.ogg" ).set( "mercy", "sound/vox_fem/mesa.ogg" ).set( "men", "sound/vox_fem/mercy.ogg" ).set( "medical", "sound/vox_fem/men.ogg" ).set( "medbay", "sound/vox_fem/medical.ogg" ).set( "me", "sound/vox_fem/medbay.ogg" ).set( "may", "sound/vox_fem/me.ogg" ).set( "maximum", "sound/vox_fem/may.ogg" ).set( "materials", "sound/vox_fem/maximum.ogg" ).set( "mass", "sound/vox_fem/materials.ogg" ).set( "man", "sound/vox_fem/mass.ogg" ).set( "malfunction", "sound/vox_fem/man.ogg" ).set( "maintenance", "sound/vox_fem/malfunction.ogg" ).set( "main", "sound/vox_fem/maintenance.ogg" ).set( "magnetic", "sound/vox_fem/main.ogg" ).set( "m", "sound/vox_fem/magnetic.ogg" ).set( "lowest", "sound/vox_fem/m.ogg" ).set( "lower", "sound/vox_fem/lowest.ogg" ).set( "loose", "sound/vox_fem/lower.ogg" ).set( "lockout", "sound/vox_fem/loose.ogg" ).set( "locker", "sound/vox_fem/lockout.ogg" ).set( "locked", "sound/vox_fem/locker.ogg" ).set( "lock", "sound/vox_fem/locked.ogg" ).set( "location", "sound/vox_fem/lock.ogg" ).set( "located", "sound/vox_fem/location.ogg" ).set( "locate", "sound/vox_fem/located.ogg" ).set( "loading", "sound/vox_fem/locate.ogg" ).set( "liquid", "sound/vox_fem/loading.ogg" ).set( "lima", "sound/vox_fem/liquid.ogg" ).set( "light", "sound/vox_fem/lima.ogg" ).set( "life", "sound/vox_fem/light.ogg" ).set( "lieutenant", "sound/vox_fem/life.ogg" ).set( "lie", "sound/vox_fem/lieutenant.ogg" ).set( "lever", "sound/vox_fem/lie.ogg" ).set( "level", "sound/vox_fem/lever.ogg" ).set( "legal", "sound/vox_fem/level.ogg" ).set( "left", "sound/vox_fem/legal.ogg" ).set( "leave", "sound/vox_fem/left.ogg" ).set( "leak", "sound/vox_fem/leave.ogg" ).set( "laws", "sound/vox_fem/leak.ogg" ).set( "law", "sound/vox_fem/laws.ogg" ).set( "launch", "sound/vox_fem/law.ogg" ).set( "last", "sound/vox_fem/launch.ogg" ).set( "laser", "sound/vox_fem/last.ogg" ).set( "lambda", "sound/vox_fem/laser.ogg" ).set( "lab", "sound/vox_fem/lambda.ogg" ).set( "l", "sound/vox_fem/lab.ogg" ).set( "kit", "sound/vox_fem/l.ogg" ).set( "kilo", "sound/vox_fem/kit.ogg" ).set( "kill", "sound/vox_fem/kilo.ogg" ).set( "key", "sound/vox_fem/kill.ogg" ).set( "k", "sound/vox_fem/key.ogg" ).set( "juliet", "sound/vox_fem/k.ogg" ).set( "johnson", "sound/vox_fem/juliet.ogg" ).set( "j", "sound/vox_fem/johnson.ogg" ).set( "it", "sound/vox_fem/j.ogg" ).set( "is", "sound/vox_fem/it.ogg" ).set( "invasion", "sound/vox_fem/is.ogg" ).set( "invalid", "sound/vox_fem/invasion.ogg" ).set( "intruder", "sound/vox_fem/invalid.ogg" ).set( "interchange", "sound/vox_fem/intruder.ogg" ).set( "inspector", "sound/vox_fem/interchange.ogg" ).set( "inspection", "sound/vox_fem/inspector.ogg" ).set( "inside", "sound/vox_fem/inspection.ogg" ).set( "inoperative", "sound/vox_fem/inside.ogg" ).set( "ing", "sound/vox_fem/inoperative.ogg" ).set( "india", "sound/vox_fem/ing.ogg" ).set( "inches", "sound/vox_fem/india.ogg" ).set( "in", "sound/vox_fem/inches.ogg" ).set( "immediately", "sound/vox_fem/in.ogg" ).set( "immediate", "sound/vox_fem/immediately.ogg" ).set( "illegal", "sound/vox_fem/immediate.ogg" ).set( "idiot", "sound/vox_fem/illegal.ogg" ).set( "i", "sound/vox_fem/idiot.ogg" ).set( "hydroponics", "sound/vox_fem/i.ogg" ).set( "hydro", "sound/vox_fem/hydroponics.ogg" ).set( "hunger", "sound/vox_fem/hydro.ogg" ).set( "hundred", "sound/vox_fem/hunger.ogg" ).set( "human", "sound/vox_fem/hundred.ogg" ).set( "hours", "sound/vox_fem/human.ogg" ).set( "hour", "sound/vox_fem/hours.ogg" ).set( "hotel", "sound/vox_fem/hour.ogg" ).set( "hot", "sound/vox_fem/hotel.ogg" ).set( "hostile", "sound/vox_fem/hot.ogg" ).set( "hole", "sound/vox_fem/hostile.ogg" ).set( "hit", "sound/vox_fem/hole.ogg" ).set( "highest", "sound/vox_fem/hit.ogg" ).set( "high", "sound/vox_fem/highest.ogg" ).set( "hide", "sound/vox_fem/high.ogg" ).set( "here", "sound/vox_fem/hide.ogg" ).set( "help", "sound/vox_fem/here.ogg" ).set( "hello", "sound/vox_fem/help.ogg" ).set( "helium", "sound/vox_fem/hello.ogg" ).set( "helicopter", "sound/vox_fem/helium.ogg" ).set( "heat", "sound/vox_fem/helicopter.ogg" ).set( "health", "sound/vox_fem/heat.ogg" ).set( "head", "sound/vox_fem/health.ogg" ).set( "hazard", "sound/vox_fem/head.ogg" ).set( "have", "sound/vox_fem/hazard.ogg" ).set( "has", "sound/vox_fem/have.ogg" ).set( "harm", "sound/vox_fem/has.ogg" ).set( "hangar", "sound/vox_fem/harm.ogg" ).set( "handling", "sound/vox_fem/hangar.ogg" ).set( "hackers", "sound/vox_fem/handling.ogg" ).set( "hacker", "sound/vox_fem/hackers.ogg" ).set( "h", "sound/vox_fem/hacker.ogg" ).set( "guthrie", "sound/vox_fem/h.ogg" ).set( "gun", "sound/vox_fem/guthrie.ogg" ).set( "gulf", "sound/vox_fem/gun.ogg" ).set( "guard", "sound/vox_fem/gulf.ogg" ).set( "grenade", "sound/vox_fem/guard.ogg" ).set( "green", "sound/vox_fem/grenade.ogg" ).set( "great", "sound/vox_fem/green.ogg" ).set( "gray", "sound/vox_fem/great.ogg" ).set( "granted", "sound/vox_fem/gray.ogg" ).set( "government", "sound/vox_fem/granted.ogg" ).set( "got", "sound/vox_fem/government.ogg" ).set( "gordon", "sound/vox_fem/got.ogg" ).set( "goodbye", "sound/vox_fem/gordon.ogg" ).set( "good", "sound/vox_fem/goodbye.ogg" ).set( "going", "sound/vox_fem/good.ogg" ).set( "go", "sound/vox_fem/going.ogg" ).set( "glory", "sound/vox_fem/go.ogg" ).set( "get", "sound/vox_fem/glory.ogg" ).set( "gas", "sound/vox_fem/get.ogg" ).set( "g", "sound/vox_fem/gas.ogg" ).set( "fuel", "sound/vox_fem/g.ogg" ).set( "fucks", "sound/vox_fem/fuel.ogg" ).set( "fucking", "sound/vox_fem/fucks.ogg" ).set( "fuck", "sound/vox_fem/fucking.ogg" ).set( "front", "sound/vox_fem/fuck.ogg" ).set( "from", "sound/vox_fem/front.ogg" ).set( "freezer", "sound/vox_fem/from.ogg" ).set( "freeman", "sound/vox_fem/freezer.ogg" ).set( "foxtrot", "sound/vox_fem/freeman.ogg" ).set( "fourty", "sound/vox_fem/foxtrot.ogg" ).set( "fourth", "sound/vox_fem/fourty.ogg" ).set( "fourteen", "sound/vox_fem/fourth.ogg" ).set( "four", "sound/vox_fem/fourteen.ogg" ).set( "found", "sound/vox_fem/four.ogg" ).set( "forms", "sound/vox_fem/found.ogg" ).set( "fore", "sound/vox_fem/forms.ogg" ).set( "force", "sound/vox_fem/fore.ogg" ).set( "forbidden", "sound/vox_fem/force.ogg" ).set( "for", "sound/vox_fem/forbidden.ogg" ).set( "fool", "sound/vox_fem/for.ogg" ).set( "floor", "sound/vox_fem/fool.ogg" ).set( "flooding", "sound/vox_fem/floor.ogg" ).set( "five", "sound/vox_fem/flooding.ogg" ).set( "first", "sound/vox_fem/five.ogg" ).set( "fire", "sound/vox_fem/first.ogg" ).set( "fine", "sound/vox_fem/fire.ogg" ).set( "final", "sound/vox_fem/fine.ogg" ).set( "fifty", "sound/vox_fem/final.ogg" ).set( "fifth", "sound/vox_fem/fifty.ogg" ).set( "fifteen", "sound/vox_fem/fifth.ogg" ).set( "field", "sound/vox_fem/fifteen.ogg" ).set( "feet", "sound/vox_fem/field.ogg" ).set( "fast", "sound/vox_fem/feet.ogg" ).set( "farthest", "sound/vox_fem/fast.ogg" ).set( "failure", "sound/vox_fem/farthest.ogg" ).set( "failed", "sound/vox_fem/failure.ogg" ).set( "fahrenheit", "sound/vox_fem/failed.ogg" ).set( "facility", "sound/vox_fem/fahrenheit.ogg" ).set( "f", "sound/vox_fem/facility.ogg" ).set( "extreme", "sound/vox_fem/f.ogg" ).set( "extinguisher", "sound/vox_fem/extreme.ogg" ).set( "extinguish", "sound/vox_fem/extinguisher.ogg" ).set( "exterminate", "sound/vox_fem/extinguish.ogg" ).set( "exposure", "sound/vox_fem/exterminate.ogg" ).set( "explosion", "sound/vox_fem/exposure.ogg" ).set( "explode", "sound/vox_fem/explosion.ogg" ).set( "experimental", "sound/vox_fem/explode.ogg" ).set( "experiment", "sound/vox_fem/experimental.ogg" ).set( "expect", "sound/vox_fem/experiment.ogg" ).set( "exit", "sound/vox_fem/expect.ogg" ).set( "exchange", "sound/vox_fem/exit.ogg" ).set( "evacuate", "sound/vox_fem/exchange.ogg" ).set( "escape", "sound/vox_fem/evacuate.ogg" ).set( "error", "sound/vox_fem/escape.ogg" ).set( "environment", "sound/vox_fem/error.ogg" ).set( "entry", "sound/vox_fem/environment.ogg" ).set( "enter", "sound/vox_fem/entry.ogg" ).set( "engine", "sound/vox_fem/enter.ogg" ).set( "engaged", "sound/vox_fem/engine.ogg" ).set( "engage", "sound/vox_fem/engaged.ogg" ).set( "energy", "sound/vox_fem/engage.ogg" ).set( "emergency", "sound/vox_fem/energy.ogg" ).set( "eliminate", "sound/vox_fem/emergency.ogg" ).set( "eleven", "sound/vox_fem/eliminate.ogg" ).set( "elevator", "sound/vox_fem/eleven.ogg" ).set( "electromagnetic", "sound/vox_fem/elevator.ogg" ).set( "electric", "sound/vox_fem/electromagnetic.ogg" ).set( "eighty", "sound/vox_fem/electric.ogg" ).set( "eighteen", "sound/vox_fem/eighty.ogg" ).set( "eight", "sound/vox_fem/eighteen.ogg" ).set( "egress", "sound/vox_fem/eight.ogg" ).set( "effect", "sound/vox_fem/egress.ogg" ).set( "ed", "sound/vox_fem/effect.ogg" ).set( "echo", "sound/vox_fem/ed.ogg" ).set( "east", "sound/vox_fem/echo.ogg" ).set( "e", "sound/vox_fem/east.ogg" ).set( "duct", "sound/vox_fem/e.ogg" ).set( "dual", "sound/vox_fem/duct.ogg" ).set( "down", "sound/vox_fem/dual.ogg" ).set( "door", "sound/vox_fem/down.ogg" ).set( "doctor", "sound/vox_fem/door.ogg" ).set( "do", "sound/vox_fem/doctor.ogg" ).set( "distortion", "sound/vox_fem/do.ogg" ).set( "distance", "sound/vox_fem/distortion.ogg" ).set( "disposal", "sound/vox_fem/distance.ogg" ).set( "dish", "sound/vox_fem/disposal.ogg" ).set( "disengaged", "sound/vox_fem/dish.ogg" ).set( "dirt", "sound/vox_fem/disengaged.ogg" ).set( "dimensional", "sound/vox_fem/dirt.ogg" ).set( "die", "sound/vox_fem/dimensional.ogg" ).set( "did", "sound/vox_fem/die.ogg" ).set( "device", "sound/vox_fem/did.ogg" ).set( "detonation", "sound/vox_fem/device.ogg" ).set( "detected", "sound/vox_fem/detonation.ogg" ).set( "detain", "sound/vox_fem/detected.ogg" ).set( "destroyed", "sound/vox_fem/detain.ogg" ).set( "destroy", "sound/vox_fem/destroyed.ogg" ).set( "deployed", "sound/vox_fem/destroy.ogg" ).set( "deploy", "sound/vox_fem/deployed.ogg" ).set( "denied", "sound/vox_fem/deploy.ogg" ).set( "delta", "sound/vox_fem/denied.ogg" ).set( "degrees", "sound/vox_fem/delta.ogg" ).set( "defense", "sound/vox_fem/degrees.ogg" ).set( "deeoo", "sound/vox_fem/defense.ogg" ).set( "decontamination", "sound/vox_fem/deeoo.ogg" ).set( "decompression", "sound/vox_fem/decontamination.ogg" ).set( "deactivated", "sound/vox_fem/decompression.ogg" ).set( "day", "sound/vox_fem/deactivated.ogg" ).set( "danger", "sound/vox_fem/day.ogg" ).set( "damaged", "sound/vox_fem/danger.ogg" ).set( "damage", "sound/vox_fem/damaged.ogg" ).set( "d", "sound/vox_fem/damage.ogg" ).set( "cyborgs", "sound/vox_fem/d.ogg" ).set( "cyborg", "sound/vox_fem/cyborgs.ogg" ).set( "cunt", "sound/vox_fem/cyborg.ogg" ).set( "cryogenic", "sound/vox_fem/cunt.ogg" ).set( "cross", "sound/vox_fem/cryogenic.ogg" ).set( "crew", "sound/vox_fem/cross.ogg" ).set( "cowards", "sound/vox_fem/crew.ogg" ).set( "coward", "sound/vox_fem/cowards.ogg" ).set( "corridor", "sound/vox_fem/coward.ogg" ).set( "correct", "sound/vox_fem/corridor.ogg" ).set( "core", "sound/vox_fem/correct.ogg" ).set( "coomer", "sound/vox_fem/core.ogg" ).set( "coolant", "sound/vox_fem/coomer.ogg" ).set( "control", "sound/vox_fem/coolant.ogg" ).set( "contraband", "sound/vox_fem/control.ogg" ).set( "contamination", "sound/vox_fem/contraband.ogg" ).set( "containment", "sound/vox_fem/contamination.ogg" ).set( "connor", "sound/vox_fem/containment.ogg" ).set( "condition", "sound/vox_fem/connor.ogg" ).set( "computer", "sound/vox_fem/condition.ogg" ).set( "complex", "sound/vox_fem/computer.ogg" ).set( "communication", "sound/vox_fem/complex.ogg" ).set( "command", "sound/vox_fem/communication.ogg" ).set( "come", "sound/vox_fem/command.ogg" ).set( "collider", "sound/vox_fem/come.ogg" ).set( "coded", "sound/vox_fem/collider.ogg" ).set( "code", "sound/vox_fem/coded.ogg" ).set( "clown", "sound/vox_fem/code.ogg" ).set( "close", "sound/vox_fem/clown.ogg" ).set( "clearance", "sound/vox_fem/close.ogg" ).set( "clear", "sound/vox_fem/clearance.ogg" ).set( "cleanup", "sound/vox_fem/clear.ogg" ).set( "chemical", "sound/vox_fem/cleanup.ogg" ).set( "checkpoint", "sound/vox_fem/chemical.ogg" ).set( "check", "sound/vox_fem/checkpoint.ogg" ).set( "charlie", "sound/vox_fem/check.ogg" ).set( "changed", "sound/vox_fem/charlie.ogg" ).set( "chamber", "sound/vox_fem/changed.ogg" ).set( "central", "sound/vox_fem/chamber.ogg" ).set( "centi", "sound/vox_fem/central.ogg" ).set( "center", "sound/vox_fem/centi.ogg" ).set( "centcom", "sound/vox_fem/center.ogg" ).set( "celsius", "sound/vox_fem/centcom.ogg" ).set( "ceiling", "sound/vox_fem/celsius.ogg" ).set( "cargo", "sound/vox_fem/ceiling.ogg" ).set( "capture", "sound/vox_fem/cargo.ogg" ).set( "captain", "sound/vox_fem/capture.ogg" ).set( "cap", "sound/vox_fem/captain.ogg" ).set( "canal", "sound/vox_fem/cap.ogg" ).set( "called", "sound/vox_fem/canal.ogg" ).set( "call", "sound/vox_fem/called.ogg" ).set( "cable", "sound/vox_fem/call.ogg" ).set( "c", "sound/vox_fem/cable.ogg" ).set( "bypass", "sound/vox_fem/c.ogg" ).set( "button", "sound/vox_fem/bypass.ogg" ).set( "but", "sound/vox_fem/button.ogg" ).set( "bust", "sound/vox_fem/but.ogg" ).set( "bridge", "sound/vox_fem/bust.ogg" ).set( "break", "sound/vox_fem/bridge.ogg" ).set( "breached", "sound/vox_fem/break.ogg" ).set( "breach", "sound/vox_fem/breached.ogg" ).set( "bravo", "sound/vox_fem/breach.ogg" ).set( "bottom", "sound/vox_fem/bravo.ogg" ).set( "blue", "sound/vox_fem/bottom.ogg" ).set( "blocked", "sound/vox_fem/blue.ogg" ).set( "blast", "sound/vox_fem/blocked.ogg" ).set( "black", "sound/vox_fem/blast.ogg" ).set( "bitches", "sound/vox_fem/black.ogg" ).set( "bitch", "sound/vox_fem/bitches.ogg" ).set( "birdwell", "sound/vox_fem/bitch.ogg" ).set( "biological", "sound/vox_fem/birdwell.ogg" ).set( "biohazard", "sound/vox_fem/biological.ogg" ).set( "beyond", "sound/vox_fem/biohazard.ogg" ).set( "before", "sound/vox_fem/beyond.ogg" ).set( "been", "sound/vox_fem/before.ogg" ).set( "be", "sound/vox_fem/been.ogg" ).set( "bay", "sound/vox_fem/be.ogg" ).set( "base", "sound/vox_fem/bay.ogg" ).set( "barracks", "sound/vox_fem/base.ogg" ).set( "bailey", "sound/vox_fem/barracks.ogg" ).set( "bag", "sound/vox_fem/bailey.ogg" ).set( "bad", "sound/vox_fem/bag.ogg" ).set( "backman", "sound/vox_fem/bad.ogg" ).set( "back", "sound/vox_fem/backman.ogg" ).set( "b", "sound/vox_fem/back.ogg" ).set( "away", "sound/vox_fem/b.ogg" ).set( "automatic", "sound/vox_fem/away.ogg" ).set( "authorized", "sound/vox_fem/automatic.ogg" ).set( "authorize", "sound/vox_fem/authorized.ogg" ).set( "attention", "sound/vox_fem/authorize.ogg" ).set( "atomic", "sound/vox_fem/attention.ogg" ).set( "at", "sound/vox_fem/atomic.ogg" ).set( "assholes", "sound/vox_fem/at.ogg" ).set( "asshole", "sound/vox_fem/assholes.ogg" ).set( "ass", "sound/vox_fem/asshole.ogg" ).set( "asimov", "sound/vox_fem/ass.ogg" ).set( "arrest", "sound/vox_fem/asimov.ogg" ).set( "array", "sound/vox_fem/arrest.ogg" ).set( "armory", "sound/vox_fem/array.ogg" ).set( "armor", "sound/vox_fem/armory.ogg" ).set( "armed", "sound/vox_fem/armor.ogg" ).set( "arm", "sound/vox_fem/armed.ogg" ).set( "area", "sound/vox_fem/arm.ogg" ).set( "are", "sound/vox_fem/area.ogg" ).set( "approach", "sound/vox_fem/are.ogg" ).set( "apprehend", "sound/vox_fem/approach.ogg" ).set( "any", "sound/vox_fem/apprehend.ogg" ).set( "antenna", "sound/vox_fem/any.ogg" ).set( "anomalous", "sound/vox_fem/antenna.ogg" ).set( "announcement", "sound/vox_fem/anomalous.ogg" ).set( "and", "sound/vox_fem/announcement.ogg" ).set( "an", "sound/vox_fem/and.ogg" ).set( "ammunition", "sound/vox_fem/an.ogg" ).set( "amigo", "sound/vox_fem/ammunition.ogg" ).set( "am", "sound/vox_fem/amigo.ogg" ).set( "alpha", "sound/vox_fem/am.ogg" ).set( "all", "sound/vox_fem/alpha.ogg" ).set( "aligned", "sound/vox_fem/all.ogg" ).set( "alien", "sound/vox_fem/aligned.ogg" ).set( "alert", "sound/vox_fem/alien.ogg" ).set( "alarm", "sound/vox_fem/alert.ogg" ).set( "ai", "sound/vox_fem/alarm.ogg" ).set( "agent", "sound/vox_fem/ai.ogg" ).set( "after", "sound/vox_fem/agent.ogg" ).set( "aft", "sound/vox_fem/after.ogg" ).set( "advanced", "sound/vox_fem/aft.ogg" ).set( "administration", "sound/vox_fem/advanced.ogg" ).set( "adios", "sound/vox_fem/administration.ogg" ).set( "activity", "sound/vox_fem/adios.ogg" ).set( "activated", "sound/vox_fem/activity.ogg" ).set( "activate", "sound/vox_fem/activated.ogg" ).set( "across", "sound/vox_fem/activate.ogg" ).set( "acquisition", "sound/vox_fem/across.ogg" ).set( "acquired", "sound/vox_fem/acquisition.ogg" ).set( "acknowledged", "sound/vox_fem/acquired.ogg" ).set( "acknowledge", "sound/vox_fem/acknowledged.ogg" ).set( "access", "sound/vox_fem/acknowledge.ogg" ).set( "accepted", "sound/vox_fem/access.ogg" ).set( "accelerator", "sound/vox_fem/accepted.ogg" ).set( "accelerating", "sound/vox_fem/accelerator.ogg" ).set( "abortions", "sound/vox_fem/accelerating.ogg" ).set( "a", "sound/vox_fem/abortions.ogg" ).set( ".", "sound/vox_fem/a.ogg" ).set( ",", "sound/vox_fem/..ogg" );
