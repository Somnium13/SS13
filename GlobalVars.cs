...
namespace Som13 {
	static class GlobalVars {
		...
		public const dynamic ai_names = GlobalFuncs.file2list( "config/names/ai.txt" );
		...
		public const dynamic clown_names = GlobalFuncs.file2list( "config/names/clown.txt" );
		...
		public const dynamic crematoriums = new List();
		...
		public const dynamic diseases = GlobalVars.undefined( Disease ) - Disease;
		...
		public const dynamic fire_overlay = GlobalVars.undefined.lcall( new ByTable().set( "icon_state", "fire" ).set( "icon", new ByRsc(292) ) );
		...
		public const dynamic html_interfaces = new List();
		...
		public const dynamic last_names = GlobalFuncs.file2list( "config/names/last.txt" );
		...
		public const dynamic list_symptoms = GlobalVars.undefined( Symptom ) - Symptom;
		public const ByTable living_mob_list = new ByTable();
		public const dynamic lizard_names_female = GlobalFuncs.file2list( "config/names/lizard_female.txt" );
		public const dynamic lizard_names_male = GlobalFuncs.file2list( "config/names/lizard_male.txt" );
		...
		public const dynamic mime_names = GlobalFuncs.file2list( "config/names/mime.txt" );
		...
		public const dynamic ninja_names = GlobalFuncs.file2list( "config/names/ninjaname.txt" );
		public const dynamic ninja_titles = GlobalFuncs.file2list( "config/names/ninjatitle.txt" );
		...
		public const dynamic non_revealed_runes = GlobalVars.undefined( Ent_Effect_Rune ) - Ent_Effect_Rune_Malformed - Ent_Effect_Rune;
		...
		public const dynamic plasmaman_on_fire = GlobalVars.undefined.lcall( new ByTable().set( "icon_state", "plasmaman" ).set( "icon", new ByRsc(234) ) );
		...
		public const dynamic spells = GlobalVars.undefined( Ent_Effect_ProcHolder_Spell );
		...
		public const dynamic verbs = GlobalFuncs.file2list( "config/names/verbs.txt" );
		...
		public const dynamic wizard_first = GlobalFuncs.file2list( "config/names/wizardfirst.txt" );
		public const dynamic wizard_second = GlobalFuncs.file2list( "config/names/wizardsecond.txt" );
		...
		public const dynamic year = GlobalVars.undefined( "YYYY", Game.realtime );
		public const dynamic year_integer = GlobalVars.undefined( GlobalVars.year );
