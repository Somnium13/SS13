...
namespace Game13 {
	static class GlobalVars {
		...
		public const ByTable clown_recipes = new ByTable(new object [] {new StackRecipe( "bananium tile", typeof(Ent_Item_Stack_Tile_Mineral_Bananium), 1, 4, 20 ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Statue_Bananium_Clown) ).set( 1, "Clown Statue" ) )});
		...
		public const ByTable corgi_recipes = new ByTable(new object [] {typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( 3, 3 ).set( 2, typeof(Ent_Item_Clothing_Suit_Hooded_IanCostume) ).set( 1, "corgi costume" ) )});
		...
		public const ByTable gold_recipes = new ByTable(new object [] {typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 10 ).set( 2, typeof(Ent_Structure_MineralDoor_Gold) ).set( 1, "golden door" ) ),new StackRecipe( "gold tile", typeof(Ent_Item_Stack_Tile_Mineral_Gold), 1, 4, 20 ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Statue_Gold_Hos) ).set( 1, "HoS Statue" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Statue_Gold_Hop) ).set( 1, "HoP Statue" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Statue_Gold_Ce) ).set( 1, "CE Statue" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Statue_Gold_Rd) ).set( 1, "RD Statue" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Statue_Gold_Cmo) ).set( 1, "CMO Statue" ) )});
		...
		public const ByTable metal_recipes = new ByTable(new object [] {typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 2, typeof(Ent_Structure_Bed_Stool) ).set( 1, "stool" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 2, typeof(Ent_Structure_Bed_Chair) ).set( 1, "chair" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Bed_Chair_Office_Dark) ).set( 1, "swivel chair" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 2 ).set( 2, typeof(Ent_Structure_Bed_Chair_Comfy_Beige) ).set( 1, "comfy chair" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 2 ).set( 2, typeof(Ent_Structure_Bed) ).set( 1, "bed" ) ),null,new StackRecipe( "rack parts", typeof(Ent_Item_Weapon_RackParts) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 15 ).set( 3, 2 ).set( 2, typeof(Ent_Structure_Closet) ).set( 1, "closet" ) ),null,typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 15 ).set( 3, 10 ).set( 2, typeof(Ent_Machinery_PortableAtmospherics_Canister) ).set( 1, "canister" ) ),null,new StackRecipe( "floor tile", typeof(Ent_Item_Stack_Tile_Plasteel), 1, 4, 20 ),new StackRecipe( "metal rod", typeof(Ent_Item_Stack_Rods), 1, 2, 60 ),null,typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 25 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Computerframe) ).set( 1, "computer frame" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 50 ).set( 3, 2 ).set( 2, typeof(Ent_Structure_Girder) ).set( 1, "wall girders" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 50 ).set( 3, 4 ).set( 2, typeof(Ent_Structure_DoorAssembly) ).set( 1, "airlock assembly" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 50 ).set( 3, 3 ).set( 2, typeof(Ent_Structure_FirelockFrame) ).set( 1, "firelock frame" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 25 ).set( 3, 5 ).set( 2, typeof(Ent_Machinery_ConstructableFrame_MachineFrame) ).set( 1, "machine frame" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 25 ).set( 3, 5 ).set( 2, typeof(Ent_Machinery_PortaTurretConstruct) ).set( 1, "turret frame" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 25 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_KitchenspikeFrame) ).set( 1, "meatspike frame" ) ),null,new StackRecipe( "grenade casing", typeof(Ent_Item_Weapon_Grenade_ChemGrenade) ),new StackRecipe( "light fixture frame", typeof(Ent_Item_Wallframe_LightFixture), 2 ),new StackRecipe( "small light fixture frame", typeof(Ent_Item_Wallframe_LightFixture_Small), 1 ),null,new StackRecipe( "apc frame", typeof(Ent_Item_Wallframe_Apc), 2 ),new StackRecipe( "air alarm frame", typeof(Ent_Item_Wallframe_Alarm), 2 ),new StackRecipe( "fire alarm frame", typeof(Ent_Item_Wallframe_Firealarm), 2 ),new StackRecipe( "button frame", typeof(Ent_Item_Wallframe_Button), 1 ),null,typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 20 ).set( 2, typeof(Ent_Structure_MineralDoor_Iron) ).set( 1, "iron door" ) )});
		...
		public const ByTable plasma_recipes = new ByTable(new object [] {typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 10 ).set( 2, typeof(Ent_Structure_MineralDoor_Transparent_Plasma) ).set( 1, "plasma door" ) ),new StackRecipe( "plasma tile", typeof(Ent_Item_Stack_Tile_Mineral_Plasma), 1, 4, 20 ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Statue_Plasma_Scientist) ).set( 1, "Scientist Statue" ) )});
		public const dynamic plasmaman_on_fire = typeof(Image).BTNew( new ByTable().set( "icon_state", "plasmaman" ).set( "icon", new ByRsc(234) ) );
		public const ByTable plasteel_recipes = new ByTable(new object [] {typeof(StackRecipe).BTNew( new ByTable().set( "one_per_turf", 1 ).set( "time", 50 ).set( 3, 4 ).set( 2, typeof(Ent_Structure_AIcore) ).set( 1, "AI core" ) )});
		...
		;
		public const ByTable runed_metal_recipes = new ByTable(new object [] {typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 40 ).set( 3, 4 ).set( 2, typeof(Ent_Structure_Cult_Pylon) ).set( 1, "pylon" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 40 ).set( 3, 6 ).set( 2, typeof(Ent_Structure_Cult_Forge) ).set( 1, "forge" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 40 ).set( 3, 4 ).set( 2, typeof(Ent_Structure_Cult_Tome) ).set( 1, "archives" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 40 ).set( 3, 10 ).set( 2, typeof(Ent_Structure_Cult_Talisman) ).set( 1, "altar" ) )});
		...
		public const ByTable sandstone_recipes = new ByTable(new object [] {typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 10 ).set( 3, 3 ).set( 2, typeof(Ent_Machinery_Hydroponics_Soil) ).set( 1, "pile of dirt" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 10 ).set( 2, typeof(Ent_Structure_MineralDoor_Sandstone) ).set( 1, "sandstone door" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Statue_Sandstone_Assistant) ).set( 1, "Assistant Statue" ) )});
		...
		public const ByTable silver_recipes = new ByTable(new object [] {typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 10 ).set( 2, typeof(Ent_Structure_MineralDoor_Silver) ).set( 1, "silver door" ) ),new StackRecipe( "silver tile", typeof(Ent_Item_Stack_Tile_Mineral_Silver), 1, 4, 20 ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Statue_Silver_Md) ).set( 1, "Med Officer Statue" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Statue_Silver_Janitor) ).set( 1, "Janitor Statue" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Statue_Silver_Sec) ).set( 1, "Sec Officer Statue" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Statue_Silver_Secborg) ).set( 1, "Sec Borg Statue" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Statue_Silver_Medborg) ).set( 1, "Med Borg Statue" ) )});
		...
		public const ByTable uranium_recipes = new ByTable(new object [] {typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 10 ).set( 2, typeof(Ent_Structure_MineralDoor_Uranium) ).set( 1, "uranium door" ) ),new StackRecipe( "uranium tile", typeof(Ent_Item_Stack_Tile_Mineral_Uranium), 1, 4, 20 ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Statue_Uranium_Nuke) ).set( 1, "Nuke Statue" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Statue_Uranium_Eng) ).set( 1, "Engineer Statue" ) )});
		...
		public const ByTable wood_recipes = new ByTable(new object [] {new StackRecipe( "wooden sandals", typeof(Ent_Item_Clothing_Shoes_Sandal), 1 ),new StackRecipe( "wood floor tile", typeof(Ent_Item_Stack_Tile_Wood), 1, 4, 20 ),typeof(StackRecipe).BTNew( new ByTable().set( "time", 10 ).set( 3, 2 ).set( 2, typeof(Ent_Structure_TableFrame_Wood) ).set( 1, "wood table frame" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "time", 40 ).set( 3, 10 ).set( 2, typeof(Ent_Item_Weaponcrafting_Stock) ).set( 1, "rifle stock" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 10 ).set( 3, 3 ).set( 2, typeof(Ent_Structure_Bed_Chair_Wood_Normal) ).set( 1, "wooden chair" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 50 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Barricade_Wooden) ).set( 1, "wooden barricade" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 20 ).set( 3, 10 ).set( 2, typeof(Ent_Structure_MineralDoor_Wood) ).set( 1, "wooden door" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 15 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_Closet_Coffin) ).set( 1, "coffin" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 15 ).set( 3, 4 ).set( 2, typeof(Ent_Structure_Bookcase) ).set( 1, "book case" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 15 ).set( 3, 10 ).set( 2, typeof(Ent_Machinery_Smartfridge_DryingRack) ).set( 1, "drying rack" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( "time", 10 ).set( 3, 10 ).set( 2, typeof(Ent_Structure_Bed_Dogbed) ).set( 1, "dog bed" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( "one_per_turf", 1 ).set( 3, 5 ).set( 2, typeof(Ent_Structure_DisplaycaseChassis) ).set( 1, "display case chassis" ) )});
		public static ByTable world_uplinks = new ByTable();
		public const ByTable xeno_recipes = new ByTable(new object [] {typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( 3, 1 ).set( 2, typeof(Ent_Item_Clothing_Head_Xenos) ).set( 1, "alien helmet" ) ),typeof(StackRecipe).BTNew( new ByTable().set( "on_floor", 1 ).set( 3, 2 ).set( 2, typeof(Ent_Item_Clothing_Suit_Xenos) ).set( 1, "alien suit" ) )});
