...
namespace SomGame {
	static class GlobalVars {
		...
		public static readonly ByTable allowed_items = new ByTable()
			.set( typeof(Ent_Item_Weapon_ReagentContainers_Food_Snacks_Grown_Blumpkin), "blumpkinjuice" )
			.set( typeof(Ent_Item_Weapon_ReagentContainers_Food_Snacks_Grown_Pumpkin), "pumpkinjuice" )
			.set( typeof(Ent_Item_Weapon_ReagentContainers_Food_Snacks_Grown_Berries_Poison), "poisonberryjuice" )
			.set( typeof(Ent_Item_Weapon_ReagentContainers_Food_Snacks_Watermelonslice), "watermelonjuice" )
			.set( typeof(Ent_Item_Weapon_ReagentContainers_Food_Snacks_Grown_Watermelon), "watermelonjuice" )
			.set( typeof(Ent_Item_Weapon_ReagentContainers_Food_Snacks_Grown_Citrus_Lime), "limejuice" )
			.set( typeof(Ent_Item_Weapon_ReagentContainers_Food_Snacks_Grown_Citrus_Orange), "orangejuice" )
			.set( typeof(Ent_Item_Weapon_ReagentContainers_Food_Snacks_Grown_Citrus_Lemon), "lemonjuice" )
			.set( typeof(Ent_Item_Weapon_ReagentContainers_Food_Snacks_Grown_Potato), "potato" )
			.set( typeof(Ent_Item_Weapon_ReagentContainers_Food_Snacks_Grown_Banana), "banana" )
			.set( typeof(Ent_Item_Weapon_ReagentContainers_Food_Snacks_Grown_Grapes_Green), "grapejuice" )
			.set( typeof(Ent_Item_Weapon_ReagentContainers_Food_Snacks_Grown_Grapes), "grapejuice" )
			.set( typeof(Ent_Item_Weapon_ReagentContainers_Food_Snacks_Grown_Berries), "berryjuice" )
			.set( typeof(Ent_Item_Weapon_ReagentContainers_Food_Snacks_Grown_Carrot), "carrotjuice" )
			.set( typeof(Ent_Item_Weapon_ReagentContainers_Food_Snacks_Grown_Tomato), "tomatojuice" )
		;
		...
		public static readonly ByTable clown_recipes = new ByTable(new object [] { new StackRecipe( "bananium tile", typeof(Ent_Item_Stack_Tile_Mineral_Bananium), true, 4 != 0, 20 != 0 ), ((dynamic)new ByTable()
				.set( "on_floor", 1 )
				.set( "one_per_turf", 1 )
				.set( 3, 5 )
		...
		public static readonly ByTable diamond_recipes = new ByTable(new object [] { ((dynamic)new ByTable()
				...
				.set( 1, "diamond door" )
			).applyCtor( typeof(StackRecipe) ), new StackRecipe( "diamond tile", typeof(Ent_Item_Stack_Tile_Mineral_Diamond), true, 4 != 0, 20 != 0 ), ((dynamic)new ByTable()
				.set( "on_floor", 1 )
				.set( "one_per_turf", 1 )
				.set( 3, 5 )
		...
		public static readonly ByTable gold_recipes = new ByTable(new object [] { ((dynamic)new ByTable()
				...
				.set( 1, "golden door" )
			).applyCtor( typeof(StackRecipe) ), new StackRecipe( "gold tile", typeof(Ent_Item_Stack_Tile_Mineral_Gold), true, 4 != 0, 20 != 0 ), ((dynamic)new ByTable()
				.set( "on_floor", 1 )
				.set( "one_per_turf", 1 )
				.set( 3, 5 )
		...
		public static readonly ByTable hrefs = new ByTable()
			...
			.set( 27, "Bots" )
			.set( "Spawn Water Tank", "hsbspawn&path=" + typeof(Ent_Structure_ReagentDispensers_Watertank) )
			.set( "Spawn Welding Fuel Tank", "hsbspawn&path=" + typeof(Ent_Structure_ReagentDispensers_Fueltank) )
			.set( "Spawn Air Scrubber", "hsbscrubber" )
			.set( 23, "Miscellaneous" )
			.set( "Spawn Airlock", "hsbairlock" )
			.set( "Spawn RCD Ammo", "hsb_safespawn&path=" + typeof(Ent_Item_Weapon_RcdAmmo) )
			.set( "Spawn Rapid Construction Device", "hsbrcd" )
			.set( "Spawn Inf. Capacity Power Cell", "hsbspawn&path=" + typeof(Ent_Item_Weapon_StockParts_Cell_Infinite) )
			.set( "Spawn Hyper Capacity Power Cell", "hsbspawn&path=" + typeof(Ent_Item_Weapon_StockParts_Cell_Hyper) )
			.set( "Spawn Full Cable Coil", "hsbspawn&path=" + typeof(Ent_Item_Stack_CableCoil) )
			...
			.set( "Spawn Medical Kit", "hsbspawn&path=" + typeof(Ent_Item_Weapon_Storage_Firstaid_Regular) )
			.set( "Spawn Light Replacer", "hsbspawn&path=" + typeof(Ent_Item_Device_Lightreplacer) )
			.set( "Spawn Toolbox", "hsbspawn&path=" + typeof(Ent_Item_Weapon_Storage_Toolbox_Mechanical) )
			.set( "Spawn Flashlight", "hsbspawn&path=" + typeof(Ent_Item_Device_Flashlight) )
			.set( 5, "Standard Tools" )
			.set( "Spawn Emergency Air Tank", "hsbspawn&path=" + typeof(Ent_Item_Weapon_Tank_Internals_EmergencyOxygen_Double) )
			.set( "Spawn Gas Mask", "hsbspawn&path=" + typeof(Ent_Item_Clothing_Mask_Gas) )
		...
		public static readonly ByTable metal_recipes = new ByTable(new object [] { ((dynamic)new ByTable()
				...
				.set( 1, "canister" )
			).applyCtor( typeof(StackRecipe) ), null, new StackRecipe( "floor tile", typeof(Ent_Item_Stack_Tile_Plasteel), true, 4 != 0, 20 != 0 ), new StackRecipe( "metal rod", typeof(Ent_Item_Stack_Rods), true, 2 != 0, 60 != 0 ), null, ((dynamic)new ByTable()
				.set( "on_floor", 1 )
				.set( "one_per_turf", 1 )
				.set( "time", 25 )
				.set( 3, 5 )
			...
			).applyCtor( typeof(StackRecipe) ), null, new StackRecipe( "grenade casing", typeof(Ent_Item_Weapon_Grenade_ChemGrenade) ), new StackRecipe( "light fixture frame", typeof(Ent_Item_Wallframe_LightFixture), 2 != 0 ), new StackRecipe( "small light fixture frame", typeof(Ent_Item_Wallframe_LightFixture_Small), true ), null, new StackRecipe( "apc frame", typeof(Ent_Item_Wallframe_Apc), 2 != 0 ), new StackRecipe( "air alarm frame", typeof(Ent_Item_Wallframe_Alarm), 2 != 0 ), new StackRecipe( "fire alarm frame", typeof(Ent_Item_Wallframe_Firealarm), 2 != 0 ), new StackRecipe( "button frame", typeof(Ent_Item_Wallframe_Button), true ), null, ((dynamic)new ByTable()
				.set( "on_floor", 1 )
				.set( "one_per_turf", 1 )
				.set( 3, 20 )
		...
		public static readonly ByTable meteors_catastrophic = new ByTable()
			...
			.set( typeof(Ent_Effect_Meteor_Flaming), 10 )
		...
		public static readonly ByTable meteors_normal = new ByTable()
			...
			.set( typeof(Ent_Effect_Meteor_Big), 3 )
			.set( typeof(Ent_Effect_Meteor_Medium), 8 )
			.set( typeof(Ent_Effect_Meteor_Dust), 3 )
		;
		...
		public static ByTable modules = new ByTable()
			.set( "/obj/machinery/power/apc", "card_reader,power_control,id_auth,cell_power,cell_charge" )
		;
		...
		public static readonly ByTable pipeID2State = new ByTable()
			.set( "" + typeof(Ent_Machinery_Atmospherics_Components_Trinary_Mixer), "mixer" )
			.set( "" + typeof(Ent_Machinery_Atmospherics_Components_Trinary_Filter), "filter" )
			.set( "" + typeof(Ent_Machinery_Atmospherics_Components_Binary_Valve_Digital), "dvalve" )
			.set( "" + typeof(Ent_Machinery_Atmospherics_Components_Binary_Valve), "mvalve" )
			.set( "" + typeof(Ent_Machinery_Atmospherics_Components_Binary_VolumePump), "volumepump" )
			.set( "" + typeof(Ent_Machinery_Atmospherics_Components_Binary_PassiveGate), "passivegate" )
			.set( "" + typeof(Ent_Machinery_Atmospherics_Components_Binary_Pump), "pump" )
			.set( "" + typeof(Ent_Machinery_Atmospherics_Components_Unary_HeatExchanger), "heunary" )
			.set( "" + typeof(Ent_Machinery_Atmospherics_Components_Unary_VentScrubber), "scrubber" )
			.set( "" + typeof(Ent_Machinery_Atmospherics_Components_Unary_VentPump), "uvent" )
			.set( "" + typeof(Ent_Machinery_Atmospherics_Components_Unary_PortablesConnector), "connector" )
			.set( "" + typeof(Ent_Machinery_Atmospherics_Pipe_HeatExchanging_Junction), "junction" )
			.set( "" + typeof(Ent_Machinery_Atmospherics_Pipe_HeatExchanging_Manifold4w), "he_manifold4w" )
			.set( "" + typeof(Ent_Machinery_Atmospherics_Pipe_HeatExchanging_Manifold), "he_manifold" )
			.set( "" + typeof(Ent_Machinery_Atmospherics_Pipe_HeatExchanging_Simple), "he" )
			.set( "" + typeof(Ent_Machinery_Atmospherics_Pipe_Manifold4w), "manifold4w" )
			.set( "" + typeof(Ent_Machinery_Atmospherics_Pipe_Manifold), "manifold" )
			.set( "" + typeof(Ent_Machinery_Atmospherics_Pipe_Simple), "simple" )
		;
		...
		public static readonly ByTable plasma_recipes = new ByTable(new object [] { ((dynamic)new ByTable()
				...
				.set( 1, "plasma door" )
			).applyCtor( typeof(StackRecipe) ), new StackRecipe( "plasma tile", typeof(Ent_Item_Stack_Tile_Mineral_Plasma), true, 4 != 0, 20 != 0 ), ((dynamic)new ByTable()
				.set( "on_floor", 1 )
				.set( "one_per_turf", 1 )
				.set( 3, 5 )
		...
		public static readonly ByTable RPD_recipes = new ByTable()
			...
			.set( "Heat Exchange", new ByTable()
				.set( "Heat Exchanger", new PipeInfo( typeof(Ent_Machinery_Atmospherics_Components_Unary_HeatExchanger), 1, 4 ) )
				.set( "Junction", new PipeInfo( typeof(Ent_Machinery_Atmospherics_Pipe_HeatExchanging_Junction), 1, 4 ) )
				.set( "4-Way Manifold", new PipeInfo( typeof(Ent_Machinery_Atmospherics_Pipe_HeatExchanging_Manifold4w), 1, 5 ) )
				.set( "Manifold", new PipeInfo( typeof(Ent_Machinery_Atmospherics_Pipe_HeatExchanging_Manifold), 1, 2 ) )
				.set( "Pipe", new PipeInfo( typeof(Ent_Machinery_Atmospherics_Pipe_HeatExchanging_Simple), 1, 1 ) )
			 )
			.set( "Devices", new ByTable()
				.set( "Gas Mixer", new PipeInfo( typeof(Ent_Machinery_Atmospherics_Components_Trinary_Mixer), 1, 3 ) )
				.set( "Gas Filter", new PipeInfo( typeof(Ent_Machinery_Atmospherics_Components_Trinary_Filter), 1, 3 ) )
				.set( "Meter", new PipeInfo_Meter() )
				.set( "Scrubber", new PipeInfo( typeof(Ent_Machinery_Atmospherics_Components_Unary_VentScrubber), 1, 4 ) )
				.set( "Volume Pump", new PipeInfo( typeof(Ent_Machinery_Atmospherics_Components_Binary_VolumePump), 1, 4 ) )
				.set( "Passive Gate", new PipeInfo( typeof(Ent_Machinery_Atmospherics_Components_Binary_PassiveGate), 1, 4 ) )
				.set( "Gas Pump", new PipeInfo( typeof(Ent_Machinery_Atmospherics_Components_Binary_Pump), 1, 4 ) )
				.set( "Unary Vent", new PipeInfo( typeof(Ent_Machinery_Atmospherics_Components_Unary_VentPump), 1, 4 ) )
				.set( "Connector", new PipeInfo( typeof(Ent_Machinery_Atmospherics_Components_Unary_PortablesConnector), 1, 4 ) )
			 )
			.set( "Regular Pipes", new ByTable()
				.set( "4-Way Manifold", new PipeInfo( typeof(Ent_Machinery_Atmospherics_Pipe_Manifold4w), 1, 5 ) )
				.set( "Digital Valve", new PipeInfo( typeof(Ent_Machinery_Atmospherics_Components_Binary_Valve_Digital), 1, 0 ) )
				.set( "Manual Valve", new PipeInfo( typeof(Ent_Machinery_Atmospherics_Components_Binary_Valve), 1, 0 ) )
				.set( "Manifold", new PipeInfo( typeof(Ent_Machinery_Atmospherics_Pipe_Manifold), 1, 2 ) )
				.set( "Pipe", new PipeInfo( typeof(Ent_Machinery_Atmospherics_Pipe_Simple), 1, 1 ) )
			 )
		;
		...
		public static readonly ByTable silver_recipes = new ByTable(new object [] { ((dynamic)new ByTable()
				...
				.set( 1, "silver door" )
			).applyCtor( typeof(StackRecipe) ), new StackRecipe( "silver tile", typeof(Ent_Item_Stack_Tile_Mineral_Silver), true, 4 != 0, 20 != 0 ), ((dynamic)new ByTable()
				.set( "on_floor", 1 )
				.set( "one_per_turf", 1 )
				.set( 3, 5 )
		...
		public static readonly ByTable slot2type = new ByTable()
			.set( "s_store", typeof(Ent_Item_Changeling) )
			.set( "wear_id", typeof(Ent_Item_Changeling) )
			.set( "ears", typeof(Ent_Item_Changeling) )
			.set( "glasses", typeof(Ent_Item_Clothing_Glasses_Changeling) )
			.set( "gloves", typeof(Ent_Item_Clothing_Gloves_Changeling) )
			.set( "belt", typeof(Ent_Item_Changeling) )
			.set( "shoes", typeof(Ent_Item_Clothing_Shoes_Changeling) )
			.set( "w_uniform", typeof(Ent_Item_Clothing_Under_Changeling) )
			.set( "wear_suit", typeof(Ent_Item_Clothing_Suit_Changeling) )
			.set( "back", typeof(Ent_Item_Changeling) )
			.set( "wear_mask", typeof(Ent_Item_Clothing_Mask_Changeling) )
			.set( "head", typeof(Ent_Item_Clothing_Head_Changeling) )
		;
		...
		public static readonly ByTable snow_recipes = new ByTable(new object [] { ((dynamic)new ByTable()
				...
				.set( 1, "Snowman" )
			).applyCtor( typeof(StackRecipe) ), new StackRecipe( "Snowball", typeof(Ent_Item_Toy_Snowball), true ) });
		...
		public static readonly ByTable TYPES_SHORTCUTS = new ByTable()
			.set( typeof(Ent_Item_Organ_Internal), "ORGAN_INT" )
			.set( typeof(Ent_Item_MechaParts_MechaEquipment), "MECHA_EQUIP" )
			.set( typeof(Ent_Item_MechaParts_MechaEquipment_Weapon_Ballistic_Launcher_MissileRack), "MECHA_MISSILE_RACK" )
			.set( typeof(Ent_Machinery_PortableAtmospherics), "PORT_ATMOS" )
			.set( typeof(Ent_Machinery_Atmospherics), "ATMOS" )
			.set( typeof(Ent_Item_Weapon_ReagentContainers), "REAGENT_CONTAINERS" )
			.set( typeof(Ent_Item_Weapon_ReagentContainers_Food), "FOOD" )
			.set( typeof(Ent_Item_Weapon_ReagentContainers_Food_Drinks), "DRINK" )
			.set( typeof(Ent_Item_Weapon_Book_Manual), "MANUAL" )
			.set( typeof(Ent_Item_Clothing_Head_Helmet_Space), "SPESSHELMET" )
			.set( typeof(Ent_Item_Device_Radio_Headset), "HEADSET" )
		...
		public static readonly ByTable uranium_recipes = new ByTable(new object [] { ((dynamic)new ByTable()
				...
				.set( 1, "uranium door" )
			).applyCtor( typeof(StackRecipe) ), new StackRecipe( "uranium tile", typeof(Ent_Item_Stack_Tile_Mineral_Uranium), true, 4 != 0, 20 != 0 ), ((dynamic)new ByTable()
				.set( "on_floor", 1 )
				.set( "one_per_turf", 1 )
				.set( 3, 5 )
		...
		public static readonly ByTable wood_recipes = new ByTable(new object [] { new StackRecipe( "wooden sandals", typeof(Ent_Item_Clothing_Shoes_Sandal), true ), new StackRecipe( "wood floor tile", typeof(Ent_Item_Stack_Tile_Wood), true, 4 != 0, 20 != 0 ), ((dynamic)new ByTable()
				.set( "time", 10 )
				.set( 3, 2 )
